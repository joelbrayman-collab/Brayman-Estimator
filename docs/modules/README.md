...
| Labour Engine | [labour-engine.md](labour-engine.md) | FG-008 Phase B foundation (`app/models/labour_engine.py`, `/labour-engine/`) — **CLOSED / OPERATIONAL FOR UAT**; revision `f2c3d4e5f6a7` in chain (**gate-at-close** live head `b4c5d6e7f8a9`; live head today `d2e3f4a5b6c7`) |
...
| MONITOR | [monitor.md](monitor.md) | **Partial** — Slice A `app/services/monitor.py` (ADR-021 **Accepted**; [monitor-v1-implementation-reconnaissance.md](../architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**; [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Hub UI **NOT IMPLEMENTED**) |
