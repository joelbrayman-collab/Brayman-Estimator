...
- `project_final_walkthrough_invitations`, `project_final_walkthrough_items`, `project_final_walkthrough_access_attempts` (FG-035 CORE CLOSE C2; additive **`e5f6a7b8c9d0` file created / not applied live**; no live C2 data)
