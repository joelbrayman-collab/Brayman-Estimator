...
| Attribute | Value |
|-----------|--------|
| Status | **COMPLETE.** Product **CLOSED** ([FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md); SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). Frozen recon remains law. Live current = head `d2e3f4a5b6c7`. |
| Date | 2026-09-02 |
...
This reconnaissance freezes implementation design for FG-021. Product code and revision `d2e3f4a5b6c7` have landed. Live `flask db upgrade` was applied (`c1d2e3f4a5b6` → `d2e3f4a5b6c7`). Gate **CLOSED** 2026-09-06 subject to the explicit SESSION-EXPIRY RECOVERY deferred exception.

Readiness: **CLOSED.** IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION.
...
FG-020 close text still says Item 12 “ELIGIBLE / NOT AUTHORIZED” in places — **historical**. Current indexes must say FG-021 **CLOSED** subject to the explicit SESSION-EXPIRY RECOVERY deferred exception.
