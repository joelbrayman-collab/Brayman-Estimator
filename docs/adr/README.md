...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-049](ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) | QuickBooks-Ready Output Ownership, Snapshot, and Human-Entry Boundary | **Proposed / FOR JOEL REVIEW** (2026-09-10; [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**; Option A selected; Option B POST-V1) |
