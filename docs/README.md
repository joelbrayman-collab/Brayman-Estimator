...
| [architecture/organization-brand-profile.md](architecture/organization-brand-profile.md) | Organization Brand Profile, logo, brand snapshot | **IMPLEMENTED / LIVE MIGRATION PENDING** — [ADR-040](adr/ADR-040-organization-brand-profile.md) **Accepted**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) |
...
| [feature-gates/FG-017-organization-brand-profile-v1.md](feature-gates/FG-017-organization-brand-profile-v1.md) | Organization Brand Profile V1 — Identity, Logo Custody, and Proposal Brand Snapshot | **IMPLEMENTED / LIVE MIGRATION PENDING** |
