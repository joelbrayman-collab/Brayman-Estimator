...
- Scheduling, Job Costing, Invoicing. Visual Dynamic Project / Crew Scheduling (paper month-calendar / five-second rule / desktop 4–6 week month / iPhone TODAY/WEEK/MONTH) is **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**: [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md).
