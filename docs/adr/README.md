...
### QuickBooks-ready output / human-entry (Proposed; architecture recording)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-049](ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) | QuickBooks-Ready Output Ownership, Snapshot, and Human-Entry Boundary | **Accepted** (2026-09-10; Joel Brayman; [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) Slices A+B **IMPLEMENTED / NOT LIVE-MIGRATED / NOT CLOSED**; Slice C **NOT AUTHORIZED**; Option B POST-V1) |
