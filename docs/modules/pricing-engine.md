...
- Later FG-027 CURRENT costing snapshot (Estimating-owned; **not implemented**; [ADR-044](../adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md))
...
- V1-02 / [FG-027](../feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) will later require governed Apply Pricing to consume a CURRENT Estimating-owned costing snapshot ([ADR-044](../adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md)). **Not implemented.** Today Apply Pricing has no costing-approval gate. `include_labour_snapshot_direct_cost=False` remains unchanged.
...
- [ADR-044](../adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted** (Estimating owns costing; Pricing consumes; **not implemented**)
