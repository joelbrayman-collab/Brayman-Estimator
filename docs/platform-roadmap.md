...
- Native Signing — [FG-033](feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md) **OPEN / PARTIAL**; SIGN-A **IMPLEMENTED**; SIGN-B **IMPLEMENTED**; SIGN-C/D/E **NOT STARTED**; recon [architecture/contract-esignature-and-signed-change-order.md](architecture/contract-esignature-and-signed-change-order.md); recommendation **NATIVE V1**; historical counsel spec **PREPARED** ([legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md)); **no external-review dependency**; production / real-customer Native Signing **NOT COMPLETE**; Change Orders first; Contract later behind Legal Content Gate
