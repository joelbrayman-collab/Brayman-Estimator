...
| [architecture/labour-engine-phase-b-architecture.md](architecture/labour-engine-phase-b-architecture.md) | Labour Engine Phase B architecture | **Approved; FG-008 IMPLEMENTED / VERIFIED** (live DB not migrated) |
