...
**Subsequent status (2026-09-20 FG-038 PA-B STAGE 1 LIVE MIGRATION):** PA-B **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / ZERO-SYS-ADMIN CHECKPOINT PASS / NO LIVE SYS ADMIN.** Product SHA **`2b25ec99b010c0c66d58d6aa08fdbab55b077e08`**. Additive **`f6a7b8c9d0e1` applied live**. Live Alembic **`f6a7b8c9d0e1 (head)`**. Live Sys Admin **0**. APPOINT **0**. REMOVE **0**. Owner **UNCHANGED**. People UI **NOT IMPLEMENTED**. Sensitive Financial **NOT IMPLEMENTED**. This record **does not rescore** V1.

**Subsequent status (2026-09-20 FG-038 PA-B PIN):** PA-B **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NO LIVE SYS ADMIN.** Product SHA **`2b25ec99b010c0c66d58d6aa08fdbab55b077e08`**. Additive **`f6a7b8c9d0e1`**. Graph head **`f6a7b8c9d0e1`**. Live Alembic remains **`e5f6a7b8c9d0`**. Live Sys Admin **0**. Owner **UNCHANGED**. People UI **NOT IMPLEMENTED**. Sensitive Financial **NOT IMPLEMENTED**. This record **does not rescore** V1.

**Subsequent status (2026-09-19 FG-038 PA-B working tree):** PA-B System Administrator **IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE CREATED / NOT LIVE-MIGRATED / NO LIVE SYS ADMIN / NOT COMMITTED / NOT PUSHED.** Additive **`f6a7b8c9d0e1`**. Graph head **`f6a7b8c9d0e1`**. Live Alembic remains **`e5f6a7b8c9d0`**. Live Sys Admin **0**. Owner **UNCHANGED**. People & Access UI **NOT IMPLEMENTED**. Sensitive Financial **NOT IMPLEMENTED**. This record **does not rescore** V1.

**Subsequent status (2026-09-19 D5 VOICE WITH HELP):** D5 **IMPLEMENTED / TESTED / COMMITTED / PUSHED / NO MIGRATION / NO DB MUTATION**. Product SHA **`021a893104260baa543e1f791b24d671562f40dd`**. Same Help authority as D1–D4 (`topic_for_context()` / `help_payload()` / `answer_help_question()`). Voice is an interface to Help. Voice actions **NOT IMPLEMENTED / NOT V1**. User Guide remains outstanding. This record **does not rescore** V1.

**Subsequent status (2026-09-19 D4 FIELD HELP):** D4 **IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE FIELD HELP SMOKE PASS / NO MIGRATION / NO DB MUTATION**. Product SHA **`e7c3fb35a1b1c4519c387a71eb8f7e81a6cc1169`**. Same Help authority as D1/D3. Native `<details>` Help on high-value Field screens. `help_payload()` remains the later Voice seam. Contextual Help coverage complete for Hub / Office / Field. Voice and User Guide remain outstanding. This record **does not rescore** V1.

**Subsequent status (2026-09-19 D3 OFFICE HELP):** D3 **IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE OFFICE SMOKE PASS.** Product SHA **`61f86789ae4e755fb39b3d65cbfee6a481ab15e8`**. Same Help authority as D1. Native `<details>` Help on high-value office screens. `help_payload()` is the later Voice seam. D1 Hub Help preserved. D2 terminology reused. No schema. No Voice. Help product overall **PARTIAL**. This record **does not rescore** V1.

**Subsequent status (2026-09-19 D2 BOUNDED CONTRACTOR-LANGUAGE RESIDUALS):** D2 **IMPLEMENTED**. Hub PRICE no longer shows `TRUE_GROSS_MARGIN`. Header Settings links to live Settings. Historical Evidence nav is **Previous estimates**. Cost Items nav is **Cost library**. Permit chrome no longer says AHJ. D1 Help preserved. No schema. No Voice. Help product overall **PARTIAL**. This record **does not rescore** V1.

**Subsequent status (2026-09-19 D1 PROJECT HUB CONTEXTUAL HELP):** D1 **IMPLEMENTED**. Static Help content authority `app/presentation/help_content.py`. Native `<details>` Help on Project Hub PLAN / PRICE / CONTRACT / BUILD / MONITOR. LEARN Help is Future-only. Informational GET-only. No schema. No Voice. Help product overall **PARTIAL**. This record **does not rescore** V1. Official V1 remains **65% / 4 of 11**. Secondary Functional V1 Build remains **79% / 22 of 28**. Completion Sign-Off remains **NOT IMPLEMENTED** and is blocked until whole-product UAT.

**Subsequent status (2026-09-19 CORE CLOSE C2 CLIENT FINAL WALKTHROUGH LIVE MIGRATION):** C2 Client Final Walkthrough **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / EMPTY LIVE BASELINE VERIFIED / NOT LIVE-UATed WITH CLIENT DATA.** Product SHA **`ec4ef9956025fd8e281c12c17d84493b121f8337`**. No live C2 data. Photo **DEFERRED**. Completion Sign-Off **NOT IMPLEMENTED**. This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL**. FG-035 remains **OPEN / PARTIAL**.

**Subsequent status (2026-09-19 CORE CLOSE C2 CLIENT FINAL WALKTHROUGH PIN):** C2 Client Final Walkthrough **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NOT LIVE-UATed.** Product SHA **`ec4ef9956025fd8e281c12c17d84493b121f8337`**. Additive **`e5f6a7b8c9d0`**. Graph head **`e5f6a7b8c9d0`**. Live Alembic remains **`d4e5f6a7b8c9`**. No live C2 data. Photo **DEFERRED**. Email **copyable link / pending configuration**. Completion Sign-Off **NOT IMPLEMENTED**. This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL**. FG-035 remains **OPEN / PARTIAL**.
...
**Subsequent status (2026-09-19 CORE CLOSE C1 CONTRACTOR PUNCH LIST LIVE MIGRATION):** C1 Contractor Punch List **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / EMPTY LIVE BASELINE VERIFIED / NOT LIVE-UATed WITH MUTATING DATA.** Product SHA **`81b6d802ccf15c10b01a1f63337ef4d0d5a26d6c`**. Punch List **LIVE / 0 ITEMS**. C2 Client Final Walkthrough **NOT IMPLEMENTED**. Completion Sign-Off **NOT IMPLEMENTED**. This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL**. FG-035 remains **OPEN / PARTIAL**.

**Subsequent status (2026-09-19 CORE CLOSE C1 CONTRACTOR PUNCH LIST PIN):** C1 Contractor Punch List **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED.** Product SHA **`81b6d802ccf15c10b01a1f63337ef4d0d5a26d6c`**. Punch List **IMPLEMENTED / NOT LIVE**. C2 Client Final Walkthrough **NOT IMPLEMENTED**. Completion Sign-Off **NOT IMPLEMENTED**. This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL**. FG-035 remains **OPEN / PARTIAL**.

**Subsequent status (2026-09-18 CORE CLOSE CLOSE/REOPEN OPTION A PIN):** Close/Reopen Option A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NO MIGRATION / NOT LIVE-UATed.** Product SHA **`172f0786aaa9e668f30be28c3cee30ac4fce5b1f`**. This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL / NOT YET SEALED**. Punch List **NOT IMPLEMENTED**. Completion Sign-Off **NOT IMPLEMENTED**.

**Subsequent status (2026-09-18 CORE CLOSE CLOSE/REOPEN OPTION A working tree):** Close/Reopen Option A **IMPLEMENTED IN WORKING TREE / TESTED / NO MIGRATION / NOT COMMITTED / NOT PUSHED / NOT LIVE-UATed.** This record **does not rescore** V1. CORE CLOSE overall remains **PARTIAL / NOT YET SEALED**.
...
**Subsequent status (2026-09-18 FG-038 PA-A PIN):** [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL / PA-A IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NO OWNER ASSIGNED.** Product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**. Additive **`c3d4e5f6a7b8`**. Live Alembic remains **`b2c3d4e5f6a7`**. All organizations remain ownerless. Close/Reopen **NOT IMPLEMENTED**. People & Access UI **NOT IMPLEMENTED**. Sys Admin **NOT IMPLEMENTED**. This record **does not rescore** V1.

**Subsequent status (2026-09-18 FG-038 PA-A working tree):** [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL / PA-A IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NO OWNER ASSIGNED.** Additive **`c3d4e5f6a7b8`**. Live Alembic remains **`b2c3d4e5f6a7`**. All organizations remain ownerless. Close/Reopen **NOT IMPLEMENTED**. People & Access UI **NOT IMPLEMENTED**. Sys Admin **DEFERRED**. This record **does not rescore** V1.
...
**Subsequent status (2026-09-18 CORE CLOSE Slice A PIN):** Slice A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED**. Product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. Official Governed V1 Readiness remains **65% / 4 of 11**. Secondary Functional V1 Build remains **79% / 22 of 28**. This pin **does not rescore** the register.

**Subsequent status (2026-09-18 CORE CLOSE Slice A):** Slice A **IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE `b2c3d4e5f6a7` CREATED / NOT LIVE-MIGRATED / NOT COMMITTED**. Official Governed V1 Readiness remains **65% / 4 of 11**. Secondary Functional V1 Build remains **79% / 22 of 28**. This slice **does not rescore** the register.

**Subsequent status (2026-09-18 CORE CLOSE / Project lifecycle owner freeze):** [architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Official Governed V1 Readiness remains **65% / 4 of 11**. Secondary Functional V1 Build remains **79% / 22 of 28**. This freeze **does not rescore** the register.
...
| Weight | **10%** |
| Status | **PARTIAL**. Subsequent **2026-09-15:** [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**. AUTH-D **IMPLEMENTED / PASS**. Live Postmark **DEFERRED**. **Do not rescore** (factor remains **0.35**). |
| Factor | 0.35 |
| Contribution | **3.5** |
...
| Governing | [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md); [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md); [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**; [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**; local `.env` `SECRET_KEY`; SQLite `instance/brayman_estimator.db` |
...
| 4. Native Signing | Separate process track. SIGN-A/B/C/D/E **IMPLEMENTED**. Real iPhone UAT **DEFERRED**. Production / real-customer use **NOT COMPLETE** until remaining product requirements. No external-review dependency. |
...
| 8. Update / monitoring | FG-024 Slice B update foundation **CLOSED / OPERATIONAL FOR UAT** (live). TECH-A HUMAN/COUNSEL activation + explicit supersession **IMPLEMENTED** (live). TECH-B generation-while-pending = **WARN** (current ACTIVE remains authority). Slice D live monitoring **not implemented**. Effective-date fields are specified (source publication ≠ counsel approval ≠ platform activation ≠ generation). |
...
| Native Signing production / real-customer use **NOT COMPLETE** | Remaining product requirements (transactional email; ACTIVE PRODUCTION package; real-device UAT); real iPhone UAT **DEFERRED**; Legal Content Gate remains separate for Ontario contract templates |
