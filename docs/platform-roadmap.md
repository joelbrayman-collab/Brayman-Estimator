...
| Layer | Position |
|-------|----------|
| **CURRENT** | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED** (2026-09-06). IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. Text **PASS**. Screenshot PNG **PASS**. **TAKE PHOTO PASS AS JPEG.** **HEIC REAL-DEVICE PASS** (Event **34** / Original **32**, Files/Browse `IMG_5351.HEIC`). **MIXED CAPTURE PASS** (Event **35**, Originals **33** text / **34** audio / **35** JPEG). **BACKGROUND / FOREGROUND PERSISTENCE PASS** (Event **36** / Original **36**, text). **CSRF RECOVERY PASS** (Event **39** / Original **39**, text). Portrait **PASS**. One-handed **PASS**. Outdoor readability **PASS**. **LANDSCAPE TOLERANCE PASS.** **ORIENTATION / PORTRAIT PASS.** **CURRENT-IPHONE FIELD-USABILITY PASS.** **REAL IPHONE VOICE SAVE PASS** (Event **30**, `audio/mp4`). **REAL IPHONE NETWORK RETAIN / RETRY PASS** (Event **31**, text). **REAL IPHONE BROWSER CLOSE → INDEXEDDB RECOVERY → RETRY PASS** (Event **32**, JPEG). Desktop continuity **PASS**. Primary UAT device iPhone 14 / iOS 26.6.1 / Safari. **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. Approved presentation source custody **CLOSED**. [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. Live current = head **`d2e3f4a5b6c7`**. Dedicated FG-021 **20**. Focused **148**. Full **558**. FG-008 through FG-021 **CLOSED** (FG-021 with deferred exception). Native Signing: **development may proceed under separate governance**; **production activation blocked pending counsel process approval**. |
| **NEXT AUTHORIZED ACTION** | FG-023 **SLICE C EXECUTION** live `flask db upgrade e3f4a5b6c7d8` + office UAT (separate authorization). Slice C **PREFLIGHT COMPLETE / NOT PERFORMED**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**. Slice A + Slice B **IMPLEMENTED / NOT LIVE-MIGRATED**. Hub `#hub-monitor` is in product code; **not** operational in live/UAT. Do **not** live-migrate from this preflight. Do **not** start office UAT. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** |
...
| **ROADMAP DIRECTION** | Item 11 is **COMPLETE**. Item 12 Field Web is **CLOSED** ([FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md); SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). Item 13 MONITOR V1 recon is **COMPLETE**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Slice A + Slice B **IMPLEMENTED / NOT LIVE-MIGRATED**; Item 13 **PARTIALLY IMPLEMENTED**. Hub `#hub-monitor` **in product code**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) North American Contract Intelligence (**FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**; Item 15 home; **not** the next authorized action). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) reusable presentation masters (**CLOSED / APPROVED REUSABLE MASTER FAMILY V1**; **not** item 12). Project Closeout / archive-and-purge; Native Signing production; Phase D; supplier integration; Change Order document family; Permit branding / national expansion; QuickBooks; Ontario Contract / Warranty (now under FG-024); LEARN; real external AI; other repository-recorded future work. Not reordered here. Not authorized by this increment. |
...
- **`main` / `origin/main`** — verify `git rev-parse HEAD` and `git rev-parse origin/main`. Live Alembic **current `d2e3f4a5b6c7`**. Repository head **`e3f4a5b6c7d8`**. Live current is **not** repository head. Last product-changing governed suite: dedicated FG-023 **23**, focused **126**, full **581**. Live Field Capture **39** Events / **39** Originals.
- **FG-008 through FG-021** **CLOSED** as applicable (FG-021 subject to SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**. [ADR-040](adr/ADR-040-organization-brand-profile.md) **Accepted**. [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. Roadmap items 10–12 **COMPLETE / CLOSED**. Item 13 [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Slice A + Slice B **IMPLEMENTED / NOT LIVE-MIGRATED**; MONITOR V1 **PARTIALLY IMPLEMENTED**; Hub `#hub-monitor` **in product code**.
...
13. MONITOR basic estimated-vs-actual — **PARTIALLY IMPLEMENTED** (Slice A model/services/tests + Slice B Hub/write; live migrate **NOT PERFORMED**; **not** office-UAT-verified) ([FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**; [ADR-021](adr/ADR-021-monitor-commercial-baseline.md) **Accepted**; [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**)
14. LEARN historical intelligence / review-gated learning (ADR-024)
15. Contract/warranty when Legal Content Gate is satisfied — [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. One linked gate (library / update engine / frozen snapshot / monitoring). Does **not** jump Item 13 / FG-023.
...
**Explicitly later / separately Feature-Gated:** voice AI, photo AI, advanced forecasting, native iOS, offline-first sync, QuickBooks API, North American contract/warranty intelligence ([FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **RECORDED / NOT IMPLEMENTATION-AUTHORIZED**), supplier integrations, POs, CAD-first, multi-tenant productization, ML recommendations, product/repository rename.
...
1. **[FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) APPROVED / OPEN / NOT CLOSED.** Slice A **IMPLEMENTED / NOT LIVE-MIGRATED**. Next: **SLICE B** office write routes/forms + Project Hub `#hub-monitor`. Do **not** live-migrate. Do **not** start office UAT. Observation Delete **queued** — do **not** implement yet. Do **not** implement Project Closeout. Do not implement Phase D, supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
2. **Roadmap direction:** Item 12 Field Web is **CLOSED**. Item 13 is **PARTIALLY IMPLEMENTED**. Native Signing **development** may proceed under separate governance; **production activation** remains blocked pending counsel. MONITOR V1 is **not operational** until later slices and UAT succeed.
...
1. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **APPROVED / OPEN / NOT CLOSED**. Slice A + Slice B **IMPLEMENTED / NOT LIVE-MIGRATED**. Slice C **PREFLIGHT COMPLETE / NOT PERFORMED**. Next: **SLICE C EXECUTION** live migrate + office UAT. Do **not** live-migrate from this preflight. Do **not** implement Closeout. Do not implement national permit expansion, Phase D, Change Order document work, supplier integration, bulk supplier onboarding, or a Winchester POC. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
