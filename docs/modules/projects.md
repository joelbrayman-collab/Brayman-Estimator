...
Platform-shared (not org-owned): `jurisdiction_definitions`, `jurisdiction_aliases`, `permit_rules`, `legal_content_jurisdiction_packages`, `legal_content_objects` (FG-024 Slice A; empty; not live-migrated).
