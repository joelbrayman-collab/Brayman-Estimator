...
| Contractor-facing UX language | [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED** — product-wide copy sweep after FG-023 close; internal terms may remain in code; no UI rewrite in this recording |
