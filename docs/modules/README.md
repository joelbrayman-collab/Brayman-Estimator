...
| Proposals | [proposals.md](proposals.md) | Templates, proposals, snapshot, PDF (customer-facing estimate; FG-012 consistency **CLOSED / OPERATIONAL FOR UAT**). First intended Brand Profile consumer ([FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) **APPROVED / IMPLEMENTATION NOT STARTED**; **not implemented**) |
