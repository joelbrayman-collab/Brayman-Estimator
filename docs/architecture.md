...
- **Historical upload onboarding (FG-013)** — [FG-013](feature-gates/FG-013-contractor-calibration-onboarding-historical-upload-ux.md) **IMPLEMENTED / VERIFIED · LIVE MIGRATION PENDING**; [ADR-032](adr/ADR-032-app-managed-historical-workbook-storage.md) **Accepted**. Live table not applied.
