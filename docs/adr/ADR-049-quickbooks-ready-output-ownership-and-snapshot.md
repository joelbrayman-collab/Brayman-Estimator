...
| Status | **Accepted** by Joel Brayman, 10 Sep 2026. [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**. Slices A+B and Slice C **LIVE-MIGRATED / BOUNDED OFFICE UAT PASS / OPERATIONAL FOR UAT**. Product SHA **`70e571140e12377aa5bd009b598530576401113b`**. Product parent **`010f6d641a756ceb2ab67475a284d3b8426c7b20`**. Atomic ENTERED repair **`00de0517b994635dec0be04a6e581167f690f7fe`**. Live current **`f1a2b3c4d5e6 (head)`**. Repository head **`f1a2b3c4d5e6`**. |
| Date | 2026-09-10 |
...
This ADR is the **ownership and freeze boundary** for V1-05 Option A: a governed QuickBooks-ready output and controlled human-entry workflow. Joel authorized FG-032 Slices A+B implementation on **10 Sep 2026**, Slice C implementation on **11 Sep 2026**, Slice C live migration plus bounded office UAT on **11 Sep 2026**, and documentation-only gate close plus V1-05 rescore on **11 Sep 2026**. It does **not** authorize CSV/IIF/Excel generation or a live QuickBooks API. It does **not** accept [ADR-008](ADR-008-supplier-price-snapshotting.md). [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. V1-05 is **COMPLETE**.
...
No QuickBooks client, OAuth, IIF, or CSV export exists in application code. Slice C append-only `estimate_quickbooks_entry_events` and occupancy lock are **applied live**.
...
**Accepted.** FG-032 Slices A+B implement Estimating-owned freeze tables, review/issue, and private HTML/PDF artifacts. Slice C (`estimate_quickbooks_entry_events`, ENTERED/REVERSED/CORRECTED, plus unique occupancy lock) is **LIVE-MIGRATED / BOUNDED OFFICE UAT PASS / OPERATIONAL FOR UAT**.
...
Additive revision **`e9f0a1b2c3d4`** revises **`d8e9f0a1b2c3`** (Slices A+B; **applied live** 2026-09-11). Additive revision **`f0a1b2c3d4e5`** revises **`e9f0a1b2c3d4`** (Slice C events; **applied live** 2026-09-11). Additive revision **`f1a2b3c4d5e6`** revises **`f0a1b2c3d4e5`** (active ENTERED occupancy; **applied live** 2026-09-11). One graph head **`f1a2b3c4d5e6`**. Live current **`f1a2b3c4d5e6 (head)`**.

## Testing Impact

Focused FG-032 tests plus FG-009 / FG-012 / FG-027 / FG-029 / FG-031 / Proposal / authorization regression. Live migration and bounded office UAT **PASS** 2026-09-11 for Slices A+B. Slice C live migrate and bounded office UAT **PASS** 2026-09-11. Concurrent ENTERED occupancy enforcement is tested with independent sessions. Evidence [testing/fg032-slice-c-live-migrate-bounded-uat-record.md](../testing/fg032-slice-c-live-migrate-bounded-uat-record.md).
...
| Cursor live-migrate / UAT note | **Accepted.** Live `flask db upgrade f1a2b3c4d5e6` **PASS**. Bounded DEMO office UAT **PASS** on project **id 26** package **1**. Evidence [testing/fg032-slice-c-live-migrate-bounded-uat-record.md](../testing/fg032-slice-c-live-migrate-bounded-uat-record.md). Gate **not closed**. | 2026-09-11 |
| Cursor close / V1-05 rescore note | **Accepted.** Documentation-only FG-032 close. V1-05 **COMPLETE**. Readiness **60% / 4 of 11**. V1-04 remains **PARTIAL**. BMR DEMO READY **NO**. BRAYMAN REAL-LIFE UAT READY **NO**. | 2026-09-11 |
