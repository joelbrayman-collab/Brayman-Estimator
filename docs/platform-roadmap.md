...
| Layer | Position |
|-------|----------|
| **CURRENT** | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED** (2026-09-06). IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED**. Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**. MONITOR V1 **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT YET CLOSED**. Live current = heads **`e3f4a5b6c7d8`**. Dedicated FG-023 **35**. Focused **149**. Full **593** (not rerun Slice C). FG-008 through FG-021 **CLOSED** (FG-021 with deferred exception). Native Signing: **development may proceed under separate governance**; **production activation blocked pending counsel process approval**. |
| **NEXT AUTHORIZED ACTION** | FG-023 **CLOSE AUTHORIZATION** (separate ChatGPT prompt). [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**. Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**. Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**. MONITOR V1 **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT YET CLOSED**. Do **not** close from this Slice C record. Do **not** begin FG-024. Do **not** implement [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md). Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED**. **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** |
...
| **ROADMAP DIRECTION** | Item 11 is **COMPLETE**. Item 12 Field Web is **CLOSED** ([FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md); SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). Item 13 MONITOR V1 recon is **COMPLETE**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**; Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**; Item 13 **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT CLOSED**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) contractor-facing UX language (**FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**; commercialization hygiene after FG-023 **close**, before broad external UAT; **not** the next authorized action). [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) North American Contract Intelligence (**FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**; Item 15 home; **not** the next authorized action). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) reusable presentation masters (**CLOSED / APPROVED REUSABLE MASTER FAMILY V1**; **not** item 12). Project Closeout / archive-and-purge; Native Signing production; Phase D; supplier integration; Change Order document family; Permit branding / national expansion; QuickBooks; Ontario Contract / Warranty (now under FG-024); LEARN; real external AI; other repository-recorded future work. Not reordered here. Not authorized by this increment. |
...
- **`main` / `origin/main`** — verify `git rev-parse HEAD` and `git rev-parse origin/main`. Live Alembic **current = heads `e3f4a5b6c7d8`**. Last product-changing governed suite: dedicated FG-023 **35**, focused **149**, full **593** (not rerun Slice C). Live Field Capture **39** Events / **39** Originals.
- **FG-008 through FG-021** **CLOSED** as applicable (FG-021 subject to SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**. [ADR-040](adr/ADR-040-organization-brand-profile.md) **Accepted**. [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. Roadmap items 10–12 **COMPLETE / CLOSED**. Item 13 [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**; Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**; MONITOR V1 **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT YET CLOSED**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**.
- **ADR-021** **Accepted**. Recon: [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**.
...
13. MONITOR basic estimated-vs-actual — **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT CLOSED** ([FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**; [ADR-021](adr/ADR-021-monitor-commercial-baseline.md) **Accepted**; [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**)
    - **Commercialization hygiene (not a numbered core-package item):** Contractor-facing UX language — [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Sequence: after Item 13 / FG-023 **close**, before broad external / U.S. commercialization. Does **not** jump FG-023 close. Does **not** displace Item 14 LEARN or Item 15 FG-024.
...
**Explicitly later / separately Feature-Gated:** voice AI, photo AI, advanced forecasting, native iOS, offline-first sync, QuickBooks API, contractor-facing UX language ([FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **RECORDED / NOT IMPLEMENTATION-AUTHORIZED**; after FG-023 close), North American contract/warranty intelligence ([FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **RECORDED / NOT IMPLEMENTATION-AUTHORIZED**), supplier integrations, POs, CAD-first, multi-tenant productization, ML recommendations, product/repository rename.
...
1. **[FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) APPROVED / OPEN / NOT CLOSED.** Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**. Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**. Next: **CLOSE AUTHORIZATION**. Do **not** close from this Slice C record. Observation Delete **queued** — do **not** implement yet. Do **not** implement Project Closeout. Do not implement Phase D, supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
2. **Roadmap direction:** Item 12 Field Web is **CLOSED**. Item 13 is **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / NOT CLOSED**. Native Signing **development** may proceed under separate governance; **production activation** remains blocked pending counsel.
...
1. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **APPROVED / OPEN / NOT CLOSED**. Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**. Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**. Next: **CLOSE AUTHORIZATION**. Do **not** close from this Slice C record. Do **not** implement Closeout. Do not implement national permit expansion, Phase D, Change Order document work, supplier integration, bulk supplier onboarding, or a Winchester POC. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
