...
| CalibAi V1 completion | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — readiness **45%**; **2 / 11** major packages COMPLETE; V1-01 and V1-02 COMPLETE factor 1.00; BMR DEMO READY **NO**; BRAYMAN REAL-LIFE UAT READY **NO**; does **not** authorize V1-03, FG-024, or another FG-025 slice |
