...
| Interactive Help / Voice / User Manual | [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **OPEN / PARTIAL.** D1 Hub Help **IMPLEMENTED**. D2 language residuals **IMPLEMENTED**. D3 office Help **IMPLEMENTED**. Voice, Field Help, User Guide remain **NOT IMPLEMENTED**. User Guide / Help Content **FRAMEWORK START NOW** ([architecture/calibraytai-v1-user-guide-framework.md](architecture/calibraytai-v1-user-guide-framework.md)). **Manual Audience Law** controlling. One User Help Content authority (`app/presentation/help_content.py`) with `help_payload()` for later Voice. PRE-UAT RELEASE GATE recorded. Manual Impact capture ([architecture/manual-impact-log.md](architecture/manual-impact-log.md)). Completed User Guide to Kevin/Ben **BEFORE** platform access. Do **not** invent FG-036. Do **not** implement Voice / Field Help / finished Manual from this row. Do **not** rescore V1. |
