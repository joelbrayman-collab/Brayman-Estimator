...
**Subsequent status (2026-09-15 ADR-052 / AUTH-B):** Production V1 now includes web Account Recovery and a shared transactional-email service ([ADR-052](ADR-052-account-recovery-and-transactional-email.md) **Accepted**; [FG-034](../feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**; AUTH-B **IMPLEMENTED / PASS**). This **supersedes Decision 7’s V1 CLI-only / no-mail boundary**. Decision 7 remains the historical FG-018 close record and is **not rewritten**. CLI reset is retained as break-glass. This ADR’s Decisions 1–6 and 8–13 for contractor office otherwise remain unchanged.
