...
- Scheduling, daily reports, timesheets. Visual Dynamic Project / Crew Scheduling is **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED** ([architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md)).
