...
- Scheduling, Job Costing, Invoicing. Visual Dynamic Project / Crew Scheduling SCH-A / SCH-B / SCH-C are **Current**. SCH-D Field presentation is **IMPLEMENTED / TESTED / SERVER-SIDE LIVE UAT PASS / PHYSICAL IPHONE UAT PASS / COMMITTED / SHA-PINNED / PUSHED**. PERF-A labour-hours Hub panel is **IMPLEMENTED / TESTED / BOUNDED SYNTHETIC LIVE UAT PASS**. Later PERF-B / MONITOR labour-hours in money assembler / LEARN slices remain **NOT AUTHORIZED** under [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS, SCOPE, and TIME are **Current**. Product-direction record: [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md).
