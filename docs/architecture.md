...
- People & Access — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** Subsequent [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) PA-A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / NO OWNER ASSIGNED**. Product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**. Subsequent Stage 1 [testing/fg038-pa-a-live-migration-ownerless-checkpoint.md](testing/fg038-pa-a-live-migration-ownerless-checkpoint.md) **PASS**. People & Access UI is **not** a Current Settings Members action. Does **not** reopen FG-037.
