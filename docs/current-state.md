...
- **Approved, next:** **STOP.** No next Feature Gate is authorized. Do not start shared API, BUILD, RBAC, or org-switcher.
- **Roadmap direction (not authorization):** item 10 is **PARTIALLY COMPLETE**. Office-auth is **CLOSED / OPERATIONAL FOR UAT**. Shared API remains a later slice of item 10 (**NOT STARTED / NOT AUTHORIZED**). Items 11–12 remain **BLOCKED**. If Joel continues the numbered sequence, the next candidate is Shared API architecture reconnaissance under ADR-022 / ADR-041. Do **not** create FG-019 from a documentation pass. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
...
1. **STOP.** [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Roadmap item 10 is **PARTIALLY COMPLETE**. Do not start shared API, BUILD, RBAC, or org-switcher. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008. No Feature Gate is authorized.
2. **Roadmap direction:** item 10 office-auth is **CLOSED / OPERATIONAL FOR UAT**. Shared API **NOT STARTED / NOT AUTHORIZED**. Items 11–12 remain **BLOCKED**. If Joel continues the numbered sequence, the next candidate is Shared API architecture reconnaissance under ADR-022 / ADR-041. Do **not** create FG-019 from a documentation pass.
