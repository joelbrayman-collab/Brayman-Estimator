...
| FG-006 | Historical Estimate Ingestion Engine — Phase B | **BLOCKED** pending M011 Organization Foundation |
| [FG-007](FG-007-m011-organization-foundation-and-project-commercial-context.md) | M011 Organization Foundation & Project Commercial Context | **Prepared / Recommended for Approval** (Milestone 011; implementation blocked) |
