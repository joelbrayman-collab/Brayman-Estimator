...
| [feature-gates/FG-019-shared-api-foundation-v1.md](feature-gates/FG-019-shared-api-foundation-v1.md) | Shared API Foundation V1 — Authenticated JSON Transport | **DRAFT FOR JOEL REVIEW / NOT APPROVED** — implementation **NOT STARTED** |
