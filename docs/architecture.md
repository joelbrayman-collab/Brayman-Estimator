...
- MONITOR implementation; LEARN / ML; Project Closeout (Item 11 Field Observation foundation is **COMPLETE**; Item 12 Field Web is **CLOSED** — [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md); Closeout **not implemented** — [build-media-storage-lifecycle.md](architecture/build-media-storage-lifecycle.md))
