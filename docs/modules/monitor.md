...
- Contractor-facing display copy: [FG-025](../feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1, SLICE 2, AND SLICE 3 IMPLEMENTED / NOT CLOSED** (Hub `#hub-monitor` plus Project Hub PLAN/commercial/history copy and office PRICE specialist mapping in `app/presentation/contractor_copy.py`; commercial identities stay frozen; remaining surfaces not authorized)
