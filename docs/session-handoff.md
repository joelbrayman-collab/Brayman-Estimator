...
**Next governed action:** **STOP.** Do **not** close FG-021. CSRF recovery is **PASS**. Do **not** start usability UAT from this pass. Do **not** resume session-expiry UAT from this pass. Remaining FG-021 UAT: orientation / portrait / one-handed / outdoor readability; older supported iPhone/Safari smoke where practical; SESSION-EXPIRY RECOVERY (**OPEN / DEFERRED / NOT YET EXERCISED**). Observation Delete remains **QUEUED / NOT AUTHORIZED**. Native Signing **development** may proceed only under **separate** governance; **production activation** remains blocked pending Ontario counsel process approval.
