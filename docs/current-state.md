...
- **Approved, next:** **STOP.** Do not start BUILD, Field Web, tokens, RBAC, or org-switcher. Item 11 is **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**.
- **Roadmap direction (not authorization):** item 10 is **COMPLETE**. Item 11 BUILD may later receive its own architecture / Feature Gate. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
...
1. **STOP.** [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Roadmap item 10 is **COMPLETE**. Do not start BUILD, Field Web, tokens, RBAC, or org-switcher. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008.
2. **Roadmap direction:** Item 11 BUILD is **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**. Wait for Joel to authorize BUILD architecture / a Feature Gate before any BUILD code.
