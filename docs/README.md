...
| [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) | FG-032 Option A schema, workflow, field matrix | **RECONCILED.** Slices A+B **`e9f0a1b2c3d4` applied live**. Slice C **`f0a1b2c3d4e5` in repository / not applied live**. |
