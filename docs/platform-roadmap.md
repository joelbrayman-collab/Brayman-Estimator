...
| **NEXT AUTHORIZED ACTION** | MONITOR V1 implementation reconnaissance is **COMPLETE**. Item 13 is **RECON COMPLETE / NOT IMPLEMENTED / NOT FEATURE-GATED / NOT AUTHORIZED FOR CODE**. Next: Joel/ChatGPT draft a bounded MONITOR V1 Feature Gate from [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md). Do **not** implement MONITOR. Do **not** create/approve the Feature Gate in the recon pass. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** |
...
13. MONITOR basic estimated-vs-actual — **RECON COMPLETE / NOT IMPLEMENTED / NOT FEATURE-GATED / NOT AUTHORIZED FOR CODE** ([ADR-021](adr/ADR-021-monitor-commercial-baseline.md) **Accepted**; [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md); composed frozen baseline; Project Gross Margin; Feature Gate **not authorized** by ADR-021 or by this recon)
...
1. **FG-021 CLOSED.** IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. Live current = head `d2e3f4a5b6c7`. Text-only **PASS**. **TAKE PHOTO PASS AS JPEG.** **HEIC REAL-DEVICE PASS.** **MIXED CAPTURE PASS.** **BACKGROUND / FOREGROUND PERSISTENCE PASS.** **CSRF RECOVERY PASS.** Portrait **PASS**. One-handed **PASS**. Outdoor readability **PASS**. **LANDSCAPE TOLERANCE PASS.** **ORIENTATION / PORTRAIT PASS.** **CURRENT-IPHONE FIELD-USABILITY PASS.** **REAL IPHONE VOICE SAVE PASS.** **REAL IPHONE NETWORK RETAIN / RETRY PASS.** **REAL IPHONE BROWSER CLOSE → INDEXEDDB RECOVERY → RETRY PASS.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). Observation Delete **queued** — do **not** implement yet. Do **not** start Item 13 / MONITOR. Do **not** implement Project Closeout. Do not implement Phase D, supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008. Do not accept ADR-010.
2. **Roadmap direction:** Item 12 Field Web is **CLOSED**. Native Signing **development** may proceed under separate governance; **production activation** remains blocked pending counsel. Do **not** start Item 13.
...
1. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) is **CLOSED**. IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. Live current = head `d2e3f4a5b6c7`. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** Do **not** start Item 13 / MONITOR. Do **not** implement Closeout. Do not implement national permit expansion, Phase D, Change Order document work, supplier integration, bulk supplier onboarding, or a Winchester POC. Do not accept ADR-008. Do not accept ADR-010.
