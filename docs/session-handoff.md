...
| Attribute | Value |
|-----------|--------|
| Status | **2026-09-23 PKG-F08 / R08 SCOPE_ORIGIN IMMUTABILITY AFTER OPERATIONAL USE IMPLEMENTED IN WORKING TREE / NOT COMMITTED.** Operational use = any `LabourTimeEntry` on the activity. `reclassify_extra_work_to_original` and `reclassify_original_to_extra_work` fail closed after Time. Historical Time snapshots are not rewritten. Draft-linked Extra remains **EXTRA_WORK**. Authorizing-linked Extra remains **CHANGE_ORDER**. T03C Extra→CO one-transaction law preserved. Birth assignment of EXTRA_WORK / ORIGINAL / CHANGE_ORDER unchanged. HEAD remains Review Turnover pin **`b76224dc469963ba92721a90fc264324798936da`**. T03C product SHA **`95659c8432761815cbd9825969cc5b6cc683042d`**. T03C pin SHA **`c57cf5f4e1cfa55edb654af4b8599e53176300c8`**. F06 product **`aedc8ae2058842c3def709a333d407c47c1af089`** / pin **`ceb40bc391aa24d0f2bc06666802fddd190e2984`**. L05 product **`4682fc544ccdd3811be9f73488ad6f5a8c0777e6`** / pin **`065649e75f741097064f1de5df5d24200c3fe370`**. R01, R04, R05, R03A, R03B, R02, R10, R13, L05, F06, T03C remain **CLOSED**. Whole-system Rule 16 **OPEN**. Dedicated F08 **11 passed**, 35 warnings, **3.77s**. Focused Extra/CO/Time/Walkthrough/Close/tenancy + F08 **173 passed**, 672 warnings, **95.87s**. Existing work_scope + Time + T03C + sealed roots **114 passed**, 512 warnings, **74.83s**. Full suite **1668 passed**, 5661 warnings, **813.45s**, exit **0**. No schema. No migration. No live DB mutation (`3457024` / `1790020245.9238403`). Alembic **`g7b8c9d0e1f2 (head)`**. Recovery stash **`840dba8320b59ff9464410fec390d755a31a56aa`**. Flask 5460 **STOPPED**. Official V1 **65% / 4 of 11.** Secondary Functional V1 Build **79% / 22 of 28** (not rescored). HostPapa app deploy **does not exist**. Next **STOP for ChatGPT Architect ACCEPT COMMIT PKG-F08.** Do **not** start F09, S16, F14, or F07. |
| Updated | 2026-09-23 |
...
- **Current work:** Rule 16 final correction programme. **PKG-F08 / R08** is **IMPLEMENTED IN WORKING TREE / NOT COMMITTED**. Sealed HEAD remains Review Turnover pin **`b76224dc469963ba92721a90fc264324798936da`**. T03C remains **CLOSED**. Next **STOP for ChatGPT Architect ACCEPT COMMIT PKG-F08.** Do **not** start F09, S16, F14, or F07. HostPapa / production app deploy **does not exist**. People & Access remains separately governed. VISUAL-2 Projects V2 register is a **historical** presentation ancestor, not current resume authority.

## 2. VERIFIED BASELINE

**CURRENT SEALED CHECKPOINT (committed HEAD, 2026-09-23):** Branch `main`. HEAD / `origin/main` **`b76224dc469963ba92721a90fc264324798936da`**. Turnover docs SHA **`5b00172e10615f9c0d8d95d10bb636dd310b422d`**. T03C product SHA **`95659c8432761815cbd9825969cc5b6cc683042d`**. T03C pin SHA **`c57cf5f4e1cfa55edb654af4b8599e53176300c8`**. F06 product **`aedc8ae2058842c3def709a333d407c47c1af089`** / pin **`ceb40bc391aa24d0f2bc06666802fddd190e2984`**. L05 product **`4682fc544ccdd3811be9f73488ad6f5a8c0777e6`** / pin **`065649e75f741097064f1de5df5d24200c3fe370`**. Working tree is **DIRTY** with authorized PKG-F08 (not committed). Alembic live current = graph head **`g7b8c9d0e1f2 (head)`**. Live DB UNCHANGED size `3457024` / mtime `1790020245.9238403`. Flask 5460 **STOPPED**. Recovery stash `stash@{0}` **`840dba8320b59ff9464410fec390d755a31a56aa` PRESERVED**. Latest governed full suite (F08 working-tree close): **1668 passed**, 5661 warnings, **813.45s**, exit **0**. Official V1 **65% / 4 of 11**. Secondary Functional V1 Build **79% / 22 of 28**. Whole-system Rule 16 **OPEN**. HostPapa app deploy **does not exist**.
...
**CURRENT (2026-09-23):** Rule 16 final correction programme is **OPEN**. **PKG-F08 / R08** is **IMPLEMENTED IN WORKING TREE / NOT COMMITTED**. Operational use for live origin rewrite is any `LabourTimeEntry` on the activity. Extra→ORIGINAL and ORIGINAL→Extra fail closed after Time. Historical Time snapshots are not rewritten. Draft-linked Extra remains EXTRA_WORK. Sealed packages remain: R01, R04, R05, R03A, R03B, R02, R10, R13, PKG-L05, PKG-F06, PKG-T03C. HEAD remains Review Turnover pin **`b76224dc469963ba92721a90fc264324798936da`**. Alembic authority **`g7b8c9d0e1f2 (head)`**. V1 scores **unchanged**. Next **STOP for ChatGPT Architect ACCEPT COMMIT PKG-F08.**
...
**Last authorized delta:** **2026-09-23 PKG-F08 / R08 SCOPE_ORIGIN IMMUTABILITY AFTER OPERATIONAL USE (working tree / NOT COMMITTED).** Live Extra→ORIGINAL and ORIGINAL→Extra rewrites are blocked once any Time row exists on the activity. Historical Time `scope_origin` is not rewritten. Pre-use Extra may still be recorded as original. New Time after a still-allowed origin change copies the live origin. Draft-linked Extra remains EXTRA_WORK. Authorizing-linked Extra remains CHANGE_ORDER and cannot create another CO. Extra→CO one-transaction law preserved. Extra-only create still assigns EXTRA_WORK. Seeded original remains ORIGINAL. Dedicated F08 **11 passed**, 35 warnings, **3.77s**. Focused **173 passed**, 672 warnings, **95.87s**. Existing work_scope + Time + T03C + sealed roots **114 passed**, 512 warnings, **74.83s** (work_scope **10**, Time **8**, T03C **14**, R03B **9**, R03A **9**, R04 **15**, R05 **12**, R01 **11**, F06 **11**, L05 **15**). Full suite **1668 passed**, 5661 warnings, **813.45s**, exit **0**. No schema. No migration. Live DB unchanged (`3457024` / `1790020245.9238403`). No live Time / Extra / Change Order / Project Close. V1 scores unchanged (**65% / 4 of 11**, **79% / 22 of 28**). R01, R04, R05, R03A, R03B, R02, R10, R13, L05, F06, T03C remain **CLOSED**. Whole-system Rule 16 remains **OPEN**. Next **STOP for ChatGPT Architect ACCEPT COMMIT PKG-F08.** Do **not** commit, push, deploy, or start F09/S16/F14/F07 from this working tree.
...
- **CURRENT (F08 working-tree close, 2026-09-23):** full suite **1668 passed**, 5661 warnings, **813.45s**, exit **0**. Dedicated F08 **11 passed**, 35 warnings, **3.77s**. Focused Extra/CO/Time/Walkthrough/Close/tenancy + F08 **173 passed**, 672 warnings, **95.87s**. Existing work_scope + Time + T03C + sealed roots **114 passed**, 512 warnings, **74.83s**. Alembic **`g7b8c9d0e1f2 (head)`**. No F08 schema or migration. Live DB UNCHANGED (`3457024` / `1790020245.9238403`). Not committed.
