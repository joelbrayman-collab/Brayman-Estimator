...
- **Approved, next:** **STOP** product implementation of signing. FG-020 close remains a separate live-migration / office UAT prompt (`b0c1d2e3f4a5` → `c1d2e3f4a5b6`). Commercial-execution track: Ontario counsel review of the native signing **PROCESS** before any Feature Gate. Do **not** mark FG-020 closed. Do **not** implement Native Signing, Project Closeout, or Field Web.
