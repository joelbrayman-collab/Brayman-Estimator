...
| [field-web-today-and-capture.md](field-web-today-and-capture.md) | **IMPLEMENTED / LIVE-MIGRATED / IPHONE UAT PENDING** — Item 12 Field Web / Today + Capture; [FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) gate **NOT CLOSED** |
