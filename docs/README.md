...
| [adr/ADR-042-build-field-evidence-and-iphone-first-capture.md](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) | BUILD field evidence, original custody, desktop review, iPhone-first capture | **Accepted** — implementation **not started**; [FG-020](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **APPROVED / IMPLEMENTATION NOT STARTED** |
| [feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) | BUILD Field Capture V1 — Project Field Observation Foundation | **APPROVED / IMPLEMENTATION NOT STARTED** |
