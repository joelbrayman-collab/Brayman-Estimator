...
- **Ontario / Ottawa Permit Intelligence POC (FG-016)** — **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED / LIVE MIGRATION PENDING.** Not CLOSED. Bounded 10 APPROVED Ottawa coach-house rules; project facts; deterministic evaluation; immutable `permit_analyses`; office HTML report; neutral CalibAi PDF. Graph head `f8a9b0c1d2e3`. Live current remains `e7f8a9b0c1d2`. Pratt not in live UAT data. No runtime web. No external AI. Dedicated tests **37 passed**. Full suite **401 passed**.
...
- Live development/UAT `flask db current`: `e7f8a9b0c1d2` (**not** live-migrated)

## Current milestone status

M005–M011, **FG-006**, **FG-008**, **FG-009**, and **M012 / FG-010** remain **implemented, verified, committed, and pushed** on `main`.

- **Current coded work:** [FG-016](feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED / LIVE MIGRATION PENDING**. [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-013](feature-gates/FG-013-contractor-calibration-onboarding-historical-upload-ux.md) **CLOSED / OPERATIONAL FOR UAT**.
- **Approved, next:** **FG-016 live migration + office Pratt UAT** (separate prompt). Do not mark FG-016 CLOSED until that pass.
...
- **Permit Intelligence architecture** (ADR-037/038/039 **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **CLOSED / OPERATIONAL FOR UAT**; [FG-016](feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) **IMPLEMENTED / LIVE MIGRATION PENDING**; Mike Pratt Coach House as FG-016 UAT reference, not live-seeded) — [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/permit-rules-library.md](architecture/permit-rules-library.md) · [architecture/permit-rules-ontario-ottawa-sources.md](architecture/permit-rules-ontario-ottawa-sources.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)
...
1. **[FG-016](feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) live migration + office Pratt UAT** under a later Cursor prompt. This implementation pass **STOPS**. Do not live-migrate here. Do not implement MONITOR, Phase D, supplier integration, bulk supplier onboarding, Winchester POC, Organization Brand Profile, or the Change Order document family. Do not accept ADR-008. Do not start a national permit library.
