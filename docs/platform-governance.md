...
Current Feature Gates: [feature-gates/README.md](feature-gates/README.md) (FG-004 through FG-011 approved and implemented where noted; **FG-008 / FG-009 / FG-010 / FG-011 CLOSED / OPERATIONAL FOR UAT**; **FG-012 APPROVED FOR IMPLEMENTATION / IMPLEMENTATION NOT STARTED**; real external AI provider **not authorized**; Phase D **not started**).
