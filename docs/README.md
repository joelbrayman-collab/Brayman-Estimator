...
| [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) | Permit Intelligence + Permit & Approvals Report | **Future / NOT IMPLEMENTED** (Pass 2) — ADR-037/038/039 **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **APPROVED FOR IMPLEMENTATION** / **NOT STARTED** |
| [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md) | Project location and reusable jurisdiction resolver | **Future / NOT IMPLEMENTED** pending FG-015 — [ADR-037](adr/ADR-037-project-location-and-jurisdiction-resolution.md) **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **APPROVED FOR IMPLEMENTATION** / **NOT STARTED** |
| [adr/ADR-037-project-location-and-jurisdiction-resolution.md](adr/ADR-037-project-location-and-jurisdiction-resolution.md) | Project location and jurisdiction resolution ownership | **Accepted** (architecture only; not implemented) |
| [adr/ADR-038-permit-intelligence-authority-and-rules-library.md](adr/ADR-038-permit-intelligence-authority-and-rules-library.md) | Permit Intelligence authority and Permit Rules Library provenance | **Accepted** (architecture only; not implemented) |
| [adr/ADR-039-permit-report-snapshot-immutability-and-workflow.md](adr/ADR-039-permit-report-snapshot-immutability-and-workflow.md) | Permit report snapshot immutability and workflow effect | **Accepted** (architecture only; not implemented) |
| [modules/permit-intelligence.md](modules/permit-intelligence.md) | Permit Intelligence capability ownership stub | **Proposed / not implemented** |
...
| [feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) | Permit Foundation V1 — Project Location, Jurisdiction & Preliminary Permit Profile | **APPROVED FOR IMPLEMENTATION** / **IMPLEMENTATION NOT STARTED** |
