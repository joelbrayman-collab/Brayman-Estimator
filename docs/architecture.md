...
- **BUILD / MONITOR / LEARN** — [CAR-001](architecture/CAR-001-calibai-product-architecture-reconciliation.md); BUILD boundary [ADR-020](adr/ADR-020-build-module-boundary.md) (**Accepted**, not implemented); field evidence / dual-surface architecture [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) (**Proposed / FOR JOEL REVIEW**, not accepted, not implemented); MONITOR baseline [ADR-021](adr/ADR-021-monitor-commercial-baseline.md) (**Accepted**, not implemented; Project Gross Margin)
...
- BUILD field capture; field web (Item 11 **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**; [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Proposed / FOR JOEL REVIEW**; FG-020 **not created**); MONITOR implementation; LEARN / ML
