...
| [adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) | QuickBooks-ready output ownership, freeze, human-entry | **Accepted** 10 Sep 2026 ([FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) Slices A+B **LIVE-MIGRATED / BOUNDED OFFICE UAT PASS / OPERATIONAL FOR UAT**; Slice C **IMPLEMENTED / NOT LIVE-MIGRATED / OFFICE UAT NOT RUN / NOT CLOSED**) |
| [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) | FG-032 Option A schema, workflow, field matrix | **RECONCILED.** Slices A+B **`e9f0a1b2c3d4` applied live**. Slice C **`f0a1b2c3d4e5` / occupancy `f1a2b3c4d5e6` in repository / not applied live**. |
| [feature-gates/FG-032-quickbooks-ready-output-entry-v1.md](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) | QuickBooks-Ready Output / Controlled Human-Entry V1 | **SLICES A+B LIVE-MIGRATED / BOUNDED OFFICE UAT PASS / OPERATIONAL FOR UAT / SLICE C IMPLEMENTED / NOT LIVE-MIGRATED / OFFICE UAT NOT RUN / OVERALL NOT CLOSED** |
| [testing/fg032-slices-ab-live-migrate-bounded-uat-record.md](testing/fg032-slices-ab-live-migrate-bounded-uat-record.md) | FG-032 Slices A+B live migrate + bounded office UAT | **UAT PASS** (2026-09-11). Canonical project **id 26**. Gate overall **NOT CLOSED**. |
