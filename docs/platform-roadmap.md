...
| Layer | Position |
|-------|----------|
| **CURRENT** | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED** (2026-09-06). IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED**. Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. MONITOR V1 **IMPLEMENTED / LIVE-MIGRATED / OFFICE-UAT-VERIFIED / CLOSED**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1, SLICE 2, SLICE 3, SLICE 4, AND SLICE 5 IMPLEMENTED / NOT CLOSED**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **FUTURE / RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Live current = heads **`e3f4a5b6c7d8`**. Slice 5 dedicated FG-025 **19**. Field-focused **83**. Prompt governed list **190**. Full **612**. Slice 4 dedicated **16** / Slice-4 focused **114** / governed **226** / full **609** remain historical. Close-time FG-023 dedicated **35** / focused **149** / full **593** remain historical. FG-008 through FG-021 **CLOSED** (FG-021 with deferred exception). Native Signing: **development may proceed under separate governance**; **production activation blocked pending counsel process approval**. |
| **NEXT AUTHORIZED ACTION** | **STOP.** [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) is **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED**. Do **not** implement FG-026 from this recording. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) is **IMPLEMENTATION PREFLIGHT COMPLETE / SLICE 1 IMPLEMENTED / SLICE 2 IMPLEMENTED / SLICE 3 IMPLEMENTED / SLICE 4 IMPLEMENTED / SLICE 5 IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT CLOSED**. Remaining surfaces **NOT AUTHORIZED**. Do **not** start another FG-025 slice. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. Do **not** begin FG-024. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED**. **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
...
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) PLAN → PRICE Phase D takeoff-to-estimate mapping (**FUTURE / RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**; not the next authorized action). [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) contractor-facing UX language (**FUTURE / RECORDED / IMPLEMENTATION PREFLIGHT COMPLETE / SLICE 1 IMPLEMENTED / SLICE 2 IMPLEMENTED / SLICE 3 IMPLEMENTED / SLICE 4 IMPLEMENTED / SLICE 5 IMPLEMENTED / NOT CLOSED**; remaining surfaces **NOT AUTHORIZED**; not a product-wide sweep). [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) North American Contract Intelligence (**FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**; Item 15 home; **not** the next authorized action). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) reusable presentation masters (**CLOSED / APPROVED REUSABLE MASTER FAMILY V1**; **not** item 12). Project Closeout / archive-and-purge; Native Signing production; supplier integration; Change Order document family; Permit branding / national expansion; QuickBooks; Ontario Contract / Warranty (now under FG-024); LEARN; real external AI; other repository-recorded future work. Not reordered here. Not authorized by this increment. |

[FG-016](feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) **CLOSED / OPERATIONAL FOR UAT**. [ADR-033](adr/ADR-033-supplier-neutrality-and-launch-partner-channel.md) **Accepted**. [ADR-008](adr/ADR-008-supplier-price-snapshotting.md) **Proposed**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) Phase D is **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. **Change Order document family** remains **FUTURE / NOT IMPLEMENTED**.
...
- **`main` / `origin/main`** — verify `git rev-parse HEAD` and `git rev-parse origin/main`. Live Alembic **current = heads `e3f4a5b6c7d8`**. Close-time governed suite: dedicated FG-023 **35**, focused **149**, full **593**. Live Field Capture **39** Events / **39** Originals.
...
- Estimate mapping (Phase D) — [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**
...
| **D** | Reviewed quantities → estimate assemblies | Explicit map + human approve into `EstimateVersion` | Phase C; ADR-006, ADR-007. **[FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED** |
...
**Historical note:** Phase A (M005) and Phase B (M010) are **implemented**. FG-010 / Phase C foundation is **CLOSED / OPERATIONAL FOR UAT** (mock extractor only). Real external AI provider is **not authorized**. COUNT is dimensionless (must not require scale); dimensional measurements remain fail-closed. Phase D mapping is [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**.

---

## Next recommended milestones

1. **STOP.** [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) is **SLICE 1, SLICE 2, SLICE 3, SLICE 4, AND SLICE 5 IMPLEMENTED / NOT CLOSED**. Remaining surfaces **NOT AUTHORIZED**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) is **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED**. Do **not** implement FG-026 from this recording. Do **not** start another FG-025 slice. Do **not** begin FG-024. Observation Delete **queued** — do **not** implement yet. Do **not** implement Project Closeout. Do not implement supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
...
3. Phase D reviewed quantity → estimate mapping is [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**.
...
1. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) Slice 1 through Slice 5 are **IMPLEMENTED**. Remaining surfaces **NOT AUTHORIZED**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) is **RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. Do **not** implement FG-026 from this recording. Do **not** start another FG-025 slice. Do **not** implement FG-024. Do **not** implement Closeout. Do not implement national permit expansion, Change Order document work, supplier integration, bulk supplier onboarding, or a Winchester POC. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
