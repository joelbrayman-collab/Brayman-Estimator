...
| Layer | Position |
|-------|----------|
| **CURRENT** | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — CalibAi V1 readiness **39%**; **1 / 11** packages COMPLETE (V1-01); BMR DEMO READY **NO**; BRAYMAN REAL-LIFE UAT READY **NO**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1–5 IMPLEMENTED / NOT CLOSED**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. Live current = heads **`f4a5b6c7d8e9`**. Dedicated FG-026 **20**. Full **632**. |
| **NEXT AUTHORIZED ACTION** | **STOP.** Do **not** begin V1-02. Do **not** implement FG-024. Do **not** start another FG-025 slice. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
...
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | V1-02 costing (**NOT AUTHORIZED**). [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) remaining surfaces **NOT AUTHORIZED**. [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) North American Contract Intelligence (**FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**). Native Signing production; supplier integration; LEARN; real external AI. |
...
3. Phase D reviewed quantity → estimate mapping is [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. V1-02 costing requires a separate prompt.
...
1. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) Slice 1 through Slice 5 are **IMPLEMENTED**. Remaining surfaces **NOT AUTHORIZED**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Do **not** begin V1-02 from this recording. Do **not** start another FG-025 slice. Do **not** implement FG-024. Do **not** implement Closeout. Do not implement national permit expansion, Change Order document work, supplier integration, bulk supplier onboarding, or a Winchester POC. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
