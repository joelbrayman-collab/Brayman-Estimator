...
| Current branch | `main` |
| Current commit / `origin/main` | Verify `git rev-parse HEAD` and `git rev-parse origin/main` after this FG-023 approval docs commit. |
...
| Current milestone | [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. MONITOR V1 recon **COMPLETE**. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED**. Roadmap item 12 **CLOSED** subject to the explicit SESSION-EXPIRY deferred exception. Parallel: [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. Item 11 **COMPLETE**. Item 10 **COMPLETE**. |
...
| Documentation status | [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. MONITOR V1 recon **COMPLETE**. [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. Legal Content Gate **empty**. ADR-008 / ADR-010 **Proposed**. |
| Decisions made (this governance pass) | FG-023 **APPROVED as written** 2026-09-06. Correction semantics including `amount >= 0` / `0.00` superseding successor **accepted**. Implementation **not** authorized. No new ADR. No product code. Current ChatGPT development chat title recorded as **BRAYMAN - CalibAi 5 Sep 2026**. |
...
| Uncommitted work | None after this FG-023 approval docs commit. |
| Next approved milestone | IMPLEMENTATION READINESS / PREFLIGHT for approved FG-023. Do **not** implement MONITOR from this approval. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. Native Signing **production** remains blocked pending counsel. Do **not** implement Closeout. |
| Next candidate milestone | Separate FG-023 implementation prompt — **not this pass**. Native Signing — **development may proceed under separate governance**; production blocked pending counsel. Observation Delete — **QUEUED / NOT AUTHORIZED**. Project Closeout — **FUTURE / NOT AUTHORIZED**. |
...
| Approved next Cursor prompt location or summary | **IMPLEMENTATION READINESS / PREFLIGHT for approved FG-023.** Do **not** implement MONITOR. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. |
| Commit status | Verify `git rev-parse HEAD` after this FG-023 approval docs commit. Live current = head `d2e3f4a5b6c7`. FG-023 **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. FG-021 **CLOSED**. FG-022 **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. |
| Governance baseline | FG-023 APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED; office actuals in approved gate (not created); no migration; MONITOR V1 recon COMPLETE; FG-021 CLOSED; SESSION-EXPIRY RECOVERY DEFERRED / NOT YET EXERCISED; OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL; Observation Delete QUEUED / NON-BLOCKING; FG-022 CLOSED / APPROVED REUSABLE MASTER FAMILY V1; live current = head d2e3f4a5b6c7; full suite 558; dedicated FG-021 20; focused 148 |
