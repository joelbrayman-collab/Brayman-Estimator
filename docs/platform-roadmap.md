...
1. **STOP.** [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **LIVE-MIGRATED / UAT DEFECT — CLOSURE BLOCKED**. Next: **catalogue-link flash repair + re-UAT**. Do **not** `flask db upgrade` again. Do not implement MONITOR. Do not start Phase D. Do not start supplier/Winchester POC or bulk supplier onboarding. Do not accept ADR-008.
