...
| Incomplete work | FG-014 **catalogue-link flash defect repair + re-UAT**; Phase D estimate mapping; four-output outputs 3–4; QuickBooks; Ontario contract/warranty; BUILD field capture; MONITOR implementation; office authentication; industry benchmarking; supplier/Winchester POC; bulk supplier onboarding. |
...
| Decisions pending | FG-014 **defect repair + re-UAT**. Real AI provider; Phase D mapping gate. FG-009 carry-forward unchanged. Darcy commercial terms unset. Supplier Feature Gate **not authorized**. Bulk supplier onboarding remains future. |
| Uncommitted work | None expected after this docs commit/push. |
| Next approved milestone | **FG-014 catalogue-link flash repair + re-UAT**. Do not `flask db upgrade` again. Do not implement MONITOR. Do not start Phase D. Do not start supplier/Winchester POC or bulk supplier onboarding. Do not accept ADR-008. |
...
| Approved next Cursor prompt location or summary | **FG-014 UAT defect repair** (`link_cost_item` exception order). Re-UAT fail-closed flashes. Do not accept ADR-008. Do not start Phase D, supplier POC, or bulk supplier onboarding. |
