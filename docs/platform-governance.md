...
| Instance Owner / People & Access PA-A / PA-B | [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL.** PA-A **LIVE / OPERATIONAL** (product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**). PA-B **IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE CREATED / NOT LIVE-MIGRATED / NO LIVE SYS ADMIN / NOT COMMITTED / NOT PUSHED**. Additive **`f6a7b8c9d0e1`**. Graph head **`f6a7b8c9d0e1`**. Live Alembic **`e5f6a7b8c9d0`**. ORG-001 Owner = Membership **1** / User **1** / Joel Brayman. Live Sys Admin **0**. People & Access UI **NOT IMPLEMENTED**. Does **not** rescore V1. |
