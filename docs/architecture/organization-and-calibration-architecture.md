...
| Related future pin | [organization-brand-profile.md](organization-brand-profile.md) **FUTURE / NOT IMPLEMENTED**. [ADR-040](../adr/ADR-040-organization-brand-profile.md) **Proposed**. [FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED**. Do not implement this document's `branding_config` JSON. |
