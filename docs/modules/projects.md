...
- Change Orders lifecycle (draft → approval statuses) via `project_controls` package. **R01 (PKG-T01):** mutating Change Order / Punch / Walkthrough / Close services reload the Project (and related CO/estimate records) against the acting organization. Caller-loaded ORM identity is not tenant authority.
