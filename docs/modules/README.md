...
| BUILD | [build.md](build.md) | **Partial** — [FG-020](../feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **IMPLEMENTED / LIVE MIGRATION PENDING** (`app/models/build.py`, office Field Observations, bounded `/api/v1`). Change Orders remain Project Controls. Item 12 **BLOCKED**. |
