...
- Organization Brand Profile — **FUTURE / NOT IMPLEMENTED** ([organization-brand-profile.md](architecture/organization-brand-profile.md)); [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED**; does not authorize product work.
...
1. **STOP.** [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) is **DRAFT / NOT APPROVED**. [ADR-040](adr/ADR-040-organization-brand-profile.md) is **Proposed**. Do **not** implement Organization Branding, MONITOR, Phase D, supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008.
...
- Organization Brand Profile / org-owned logo / brand snapshot — **FUTURE / NOT IMPLEMENTED**; [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED** ([organization-brand-profile.md](architecture/organization-brand-profile.md))
