...
- **Approved, next:** **STOP.** Do not begin national permit expansion, Phase D, Change Order documents, supplier integration, Authentication, or external AI / runtime web. Do not start the next Feature Gate. No product implementation authorized.
- **Roadmap direction (not authorization):** first unfinished numbered sequence item is **item 10 Authentication / actor identity + shared API foundation** — **NOT STARTED / NOT AUTHORIZED**; no Feature Gate. Items 11–12 require item 10. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
- **Blocked / Not Started (product):** Authentication; Phase D estimate mapping; four-output package outputs 3–4; QuickBooks; contracts; BUILD field capture; MONITOR implementation; LEARN; industry benchmarking; historical evidence repair; real external AI provider; supplier/Winchester POC; bulk supplier onboarding; national Permit Rules expansion; Change Order document family; Permit branding.
...
1. **STOP.** [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Do not start the next Feature Gate. Do not start Authentication. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008. No product implementation authorized.
2. **Roadmap direction (not authorization):** first unfinished numbered sequence item is Authentication (item 10) — **NOT STARTED / NOT AUTHORIZED**; no Feature Gate. Items 11–12 require item 10.
