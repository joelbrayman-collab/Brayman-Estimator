...
- Latest product-changing governed full suite: **661 passed** (FG-028 Slices 1–2). Dedicated FG-028 **9**. Focused Field/Hub/Permit/Brand/Labour **117**. Historical full **652** remains the pre-rename FG-027 baseline. Dedicated FG-027 **20**. Estimating focused **29**. Pricing focused **52**. FG-026 **20**. Governed A–D bundle **121**. Historical dedicated **15** / full **647** remain the FG-027 implementation baseline. Historical full **632** remains the pre-FG-027 baseline.
...
**[FG-029](feature-gates/FG-029-bmr-supplier-workflow-v1.md) RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED.** [ADR-046](adr/ADR-046-supplier-neutral-material-requirement-and-supplier-mapping-boundary.md) **Accepted**. V1 remains **45% / 2 of 11**. **[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) CLOSED / OPERATIONAL FOR UAT.** Live current = heads **`a5b6c7d8e9f0`**. [FG-028](feature-gates/FG-028-calibai-to-calibraytai-product-identity-transition.md) **SLICES 1–2 IMPLEMENTED / SLICE 3 HELD / NOT CLOSED.** [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-021 CLOSED.]

## 8. LAST AUTHORIZED DELTA

**Last authorized delta:** **2026-09-09 V1-03 / FG-029 ADR-046 + architecture preflight recording** (docs only). [ADR-046](adr/ADR-046-supplier-neutral-material-requirement-and-supplier-mapping-boundary.md) **Accepted**. FG-029 **RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Architecture SHA **`07039c8dabfeba7b6ef4714d2cee50abf648bc4f`**. No schema. No product code. **PRODUCT TESTS NOT RERUN — V1-03 ADR / FG / PREFLIGHT ONLY.** V1 remains **45% / 2 of 11**.
