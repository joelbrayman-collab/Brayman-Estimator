...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-032](ADR-032-app-managed-historical-workbook-storage.md) | App-Managed Immutable Historical Workbook Storage / Source Custody | **Accepted** (2026-08-30; FG-013 **IMPLEMENTED / VERIFIED · LIVE MIGRATION PENDING**; revision `c5d6e7f8a9b0`; legacy Desktop corpus not moved) |
