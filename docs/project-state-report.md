...
| Latest completed **coded** milestone on `main` | **FG-021 IMPLEMENTED / LIVE MIGRATION PENDING** (not closed; graph head `d2e3f4a5b6c7`; live current `c1d2e3f4a5b6`; dedicated FG-021 **13**; focused **141**; full suite **551**). **FG-020 CLOSED / OPERATIONAL FOR UAT**. **FG-019 CLOSED / OPERATIONAL FOR UAT**. **FG-018 CLOSED / OPERATIONAL FOR UAT**. FG-008 through FG-017 remain **CLOSED / OPERATIONAL FOR UAT**. |
| Current milestone | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE MIGRATION PENDING** (gate **NOT CLOSED**). [FG-020](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **CLOSED / OPERATIONAL FOR UAT**. Item 11 **COMPLETE**. Item 12 Field Web **IMPLEMENTED / LIVE MIGRATION PENDING**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**. |
| Product status | Operational on `main`: FG-021 Field Web V1 **IMPLEMENTED / LIVE MIGRATION PENDING**. FG-020 BUILD Field Observation foundation **CLOSED / OPERATIONAL FOR UAT**. FG-019 Shared API Foundation V1 **CLOSED / OPERATIONAL FOR UAT**. FG-018 office authentication **CLOSED / OPERATIONAL FOR UAT**. Real iPhone UAT **not complete**. Four-output outputs 3–4 / QuickBooks API / Ontario contract **not implemented**. |
| Architecture status | CAR-001 approved. FG-008 through FG-020 **CLOSED / OPERATIONAL FOR UAT**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE MIGRATION PENDING**. ADR-008 / ADR-010 **Proposed**. Real external AI provider **not authorized**. Phase D **not started**. Change Order document family **FUTURE / NOT IMPLEMENTED**. |
...
| Documentation status | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE MIGRATION PENDING**. Native Signing recon **COMPLETE**; counsel spec **PREPARED** — **NOT LEGAL APPROVAL**. Development may proceed under separate governance; production activation blocked pending counsel. Legal Content Gate **unchanged**. ADR-008 / ADR-010 **Proposed**. |
| Decisions made (this governance pass) | FG-021 implementation landed. Revision `d2e3f4a5b6c7` created. Live upgrade **not** run. Gate **NOT CLOSED**. Native Signing **development may proceed under separate governance**; **production activation blocked pending counsel**. FG-020 remains **CLOSED / OPERATIONAL FOR UAT**. |
| Decisions pending | Whether Joel/ChatGPT issues a live-migration + iPhone UAT prompt to close FG-021. Whether to authorize a separate Native Signing development gate (production still blocked pending counsel). Ontario counsel answers to [legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md). Archive package format. Project Closeout Feature Gate not created. |
| Uncommitted work | None after this FG-021 implementation commit. |
| Next approved milestone | Live `flask db upgrade` to `d2e3f4a5b6c7` only under an explicit prompt, then real iPhone Safari UAT. Do **not** close FG-021 until UAT. Native Signing **production** remains blocked pending counsel. Do **not** implement Closeout or Contract templates. |
| Next candidate milestone | FG-021 close after live upgrade + iPhone UAT. Native Signing — **development may proceed under separate governance**; production blocked pending counsel. Project Closeout — **FUTURE / NOT AUTHORIZED**. |
...
| Approved next Cursor prompt location or summary | Live-migration + iPhone UAT close prompt for FG-021, **or** a Native Signing development gate (production still counsel-blocked). Do **not** implement Closeout or Contract templates. |
| Commit status | Verify `git rev-parse HEAD` after this implementation commit. Live current `c1d2e3f4a5b6`. Graph head `d2e3f4a5b6c7`. FG-021 **IMPLEMENTED / LIVE MIGRATION PENDING**. FG-020 **CLOSED / OPERATIONAL FOR UAT**. |
| Governance baseline | FG-021 IMPLEMENTED / LIVE MIGRATION PENDING; gate NOT CLOSED; revision d2e3f4a5b6c7 created; live current c1d2e3f4a5b6; full suite 551; dedicated FG-021 13; focused 141; Native Signing development may proceed separately / production blocked pending counsel; ADR-043 Accepted; Closeout FUTURE |
