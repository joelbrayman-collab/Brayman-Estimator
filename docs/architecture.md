...
- Scheduling, Job Costing, Invoicing. Visual Dynamic Project / Crew Scheduling and later Time / Performance / MONITOR labour-hours / LEARN slices remain **NOT AUTHORIZED** under [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS is **Current**. Product-direction record: [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md).
...
- Project work structure (TAX/WBS) — [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. [ADR-053](adr/ADR-053-project-work-structure-and-closed-operational-learning-loop.md) **Accepted**. TAX/WBS **IMPLEMENTED**. Later slices **NOT AUTHORIZED**.
- Interactive Help / Voice / professional User Manual — [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **FUTURE / RECORDED / COMPLETE FOR PRODUCT-DIRECTION RECORDING / MANDATORY PRE-UAT V1 / NOT IMPLEMENTATION-AUTHORIZED**. Does **not** interrupt FG-035.
