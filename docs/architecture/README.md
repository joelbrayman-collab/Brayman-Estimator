...
| [fg-031-scope-delivery-make-buy-procurement-routing-preflight.md](fg-031-scope-delivery-make-buy-procurement-routing-preflight.md) | **COMPLETE (architecture recording).** [FG-031](../feature-gates/FG-031-scope-delivery-make-buy-procurement-routing-v1.md) **RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED** |
