...
| [feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) | Automated Costing and Human Cost Approval V1 | **IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT AUTHORIZED**. V1-02. Approve All = costing approval only. |
| [architecture/fg-027-costing-approval-preflight.md](architecture/fg-027-costing-approval-preflight.md) | FG-027 costing snapshot schema, exceptions, Pricing consume | Product **implemented** in repository. Live migrate **not** run. |
