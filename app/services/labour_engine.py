        ...
        if approved:
            ...
            if baseline:
                result = LabourResolutionResult(
                    ...
                    reason_selected="CalibraytAI BASELINE production standard (flagged generic; not ORG-APPROVED)",
                    override_reason=None,
        ...
        if approved:
            ...
            if baseline:
                result = LabourResolutionResult(
                    ...
                    standard_version=baseline.version_number,
                    effective_from=baseline.effective_from,
                    reason_selected="CalibraytAI BASELINE direct labour cost rate (flagged generic)",
                    override_reason=None,
