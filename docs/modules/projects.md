...
- Project work taxonomy / Time / Schedule / LEARN consumers — TAX/WBS + SCOPE + TIME **Current** ([FG-035](../feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**). SCH / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**.
