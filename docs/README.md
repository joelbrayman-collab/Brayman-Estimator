...
| [architecture/ai-takeoff-quantity-extraction-foundation.md](architecture/ai-takeoff-quantity-extraction-foundation.md) | AI Take-off / Quantity Extraction Foundation architecture | **Approved** — FG-010 **APPROVED FOR IMPLEMENTATION** — **NOT IMPLEMENTED** |
| [feature-gates/FG-010-ai-takeoff-quantity-extraction-foundation.md](feature-gates/FG-010-ai-takeoff-quantity-extraction-foundation.md) | AI Take-off / Quantity Extraction Foundation Feature Gate (M012) | **APPROVED FOR IMPLEMENTATION** — **NOT IMPLEMENTED** |
