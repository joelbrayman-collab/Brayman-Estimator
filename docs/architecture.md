...
- **CORE CLOSE / Project operating lifecycle** — [architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. V1 operating lifecycle **ACTIVE / CLOSED**. Punch List → Project Completion Sign-Off → Close Project. Distinct from LEARN Closeout. Do **not** reuse `Project.status`. Do **not** add ARCHIVED as a third operating state. Does **not** implement Close, Punch List, Completion Sign-Off, Native Signing changes, Home Office, LEARN, or QB-T.
