...
### BUILD field evidence (architecture accepted; FG-020 implemented / live migration pending)
...
### Field Web capture reliability (Proposed; FG-021 draft)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-043](ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) | Field Web Capture Reliability, Local Pending Capture, and Idempotent Replay Architecture | **Proposed** (2026-09-01; for Joel review). [FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) **DRAFT FOR JOEL REVIEW / NOT APPROVED**. Implementation **NOT AUTHORIZED**. |
