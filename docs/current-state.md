...
| **Working tree at last verified inspect** | **FG-018 CLOSED / OPERATIONAL FOR UAT.** [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **DRAFT FOR JOEL REVIEW / NOT APPROVED**. Shared API product code **NOT STARTED**. Live current = head `b0c1d2e3f4a5`. Full suite **460 passed**. Dedicated FG-018 **37 passed**. Office UAT port **5011**. [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**. FG-008–FG-018 **CLOSED / OPERATIONAL FOR UAT**. Pratt UAT project **id 9** port **5009**. |
...
- **Authentication / actor identity** ([ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**; [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**) — office User + membership + login **operational for UAT**. Roadmap item 10 is **PARTIALLY COMPLETE**. [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) is **DRAFT FOR JOEL REVIEW / NOT APPROVED**. Shared API product code **NOT STARTED**. BUILD remains **BLOCKED** until FG-019 is later closed ([ADR-022](adr/ADR-022-field-client-and-shared-api.md)).
...
- **Approved, next:** **STOP.** [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) is **DRAFT FOR JOEL REVIEW / NOT APPROVED**. Do not implement `/api/`. Do not start BUILD, RBAC, or org-switcher.
- **Roadmap direction (not authorization):** item 10 is **PARTIALLY COMPLETE**. Office-auth is **CLOSED / OPERATIONAL FOR UAT**. Shared API product code remains **NOT STARTED**. FG-019 draft exists; it is **not** approved and does **not** authorize implementation. Items 11–12 remain **BLOCKED**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
