...
- Contractor-facing Hub / office / Field copy — [FG-025](../feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED** (after FG-023 close; no UI rewrite in this recording)
