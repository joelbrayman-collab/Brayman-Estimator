...
- **FG-027:** **IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE-MIGRATED / OFFICE UAT STOPPED / NOT PASS / NOT CLOSED**. V1-02. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Approve All = costing approval only. Additive `a5b6c7d8e9f0` **applied live**. Does **not** accept ADR-008.
...
- Phase D reviewed quantity → estimate mapping — [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. V1-02 / [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT CLOSED**.
...
- **[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md)** is **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT CLOSED**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Do **not** silently repair from this handoff. Do **not** accept ADR-008.
