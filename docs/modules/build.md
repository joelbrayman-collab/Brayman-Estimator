...
| Attribute | Value |
|-----------|--------|
| Status | **Partial Current** — Field Capture V1 **CLOSED / OPERATIONAL FOR UAT**. Field Web V1 **CLOSED** (SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). TIME **IMPLEMENTED** (duration-based labour hours). Change Orders remain Project Controls. |
| Updated | 2026-09-15 |
