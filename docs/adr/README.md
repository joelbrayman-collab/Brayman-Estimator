...
### BUILD field evidence (Proposed — not accepted; not implemented)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-042](ADR-042-build-field-evidence-and-iphone-first-capture.md) | BUILD Field Evidence, Original Observation Custody, Desktop Review, and iPhone-First Capture Architecture | **Proposed / FOR JOEL REVIEW** (2026-08-31). Does **not** authorize FG-020, BUILD code, Field Web, transcription, or external AI. |
