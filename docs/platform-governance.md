...
| Account Recovery + transactional email | [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**. MAIL-A **IMPLEMENTED**. AUTH-A **IMPLEMENTED**. AUTH-B **IMPLEMENTED / PASS**. AUTH-C **IMPLEMENTED / PASS**. MAIL-B **IMPLEMENTED / PASS**. AUTH-D **NOT STARTED**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake mail only. No live Postmark HTTP. Does **not** reopen FG-018, FG-021, or FG-033. Does **not** rescore V1. |
| Future Time / Schedule / Performance / LEARN loop + language audit | [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. One closed operational / learning loop. §§40–71 Change Order / Extra Work / Closeout / LEARN data quality recorded. §72 checklist truncated after Closeout performance review. Contractor Language + UX E2E Audit is mandatory **before** Brayman/Ben real-world UAT. Does **not** authorize implementation. Does **not** invent FG-035. Does **not** reopen FG-023 or FG-025. |
