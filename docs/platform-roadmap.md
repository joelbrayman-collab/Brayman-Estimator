...
| QuickBooks estimate export | **Intended V1 Option A Slices A+B live-migrated / bounded office UAT PASS; Slice C implemented in repository / not live-migrated** (no API; [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **OVERALL NOT CLOSED**). Option B live API **POST-V1**. | [architecture/quickbooks-integration.md](architecture/quickbooks-integration.md) · [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) · [ADR-049](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted** |
