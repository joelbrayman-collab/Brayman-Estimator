...
| Current branch | `main` |
| Current commit / `origin/main` | Product code `0569f25e7ff496ab637d52437d48cf815522afa1`. Docs-only live-migration verification commit on `main` after that SHA. Confirm with `git rev-parse HEAD`. |
...
| Current milestone | FG-008 **LIVE-MIGRATED / UAT-SMOKE-VERIFIED**; next coded work not authorized |
