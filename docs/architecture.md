...
- Flask-Login is used for office authentication ([FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**; [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**; [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**). [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**: MAIL-A / AUTH-A / AUTH-B / AUTH-C / MAIL-B **IMPLEMENTED** (local/fake mail; `credentials_epoch`; hash-at-rest reset tokens; responsive Forgot Password / Reset UX; complete local E2E; Native Signing invitation/resend/complete). AUTH-D **NOT STARTED**. Live Postmark HTTP **not** implemented. Shared API Foundation V1 is **operational for UAT** ([FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **CLOSED / OPERATIONAL FOR UAT**) with a **narrow** FG-020 BUILD POST allow-list. RBAC and multi-org switching are **not implemented**.
...
- Scheduling, Job Costing, Invoicing. Visual Dynamic Project / Crew Scheduling and the complete Time / Performance / MONITOR / LEARN loop, including §§40–71 Change Order / Extra Work / Closeout / LEARN data quality, are **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**: [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md). §72 preflight checklist is recorded as received (truncated after Closeout performance review).
...
- Account Recovery + transactional email — [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**. MAIL-A / AUTH-A / AUTH-B / AUTH-C / MAIL-B **IMPLEMENTED**. AUTH-D **NOT STARTED**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake capture only. No live Postmark HTTP. Physical iPhone Account Recovery UAT **DEFERRED**.
