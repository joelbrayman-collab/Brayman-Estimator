...
| QuickBooks pipeline (Option A Slices A+B live-migrated / bounded office UAT PASS; Slice C implemented in repository / not live-migrated; no API) | [architecture/quickbooks-integration.md](architecture/quickbooks-integration.md) · [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **LIVE-MIGRATED / BOUNDED OFFICE UAT PASS / OPERATIONAL FOR UAT / SLICE C IMPLEMENTED / NOT LIVE-MIGRATED / OFFICE UAT NOT RUN / NOT CLOSED**; [ADR-049](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted** |
