...
**Not implemented:** Project Closeout / archive-and-purge; Observation Delete; HEIC real-device UAT; mixed capture; transcription; audio conversion; MONITOR; auto-Change Order. Field Web `/field` Today + Capture **is implemented** ([FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) **OPEN**).
