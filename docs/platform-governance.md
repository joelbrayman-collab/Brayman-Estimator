...
| Interactive Help / Voice / User Manual | [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **OPEN / PARTIAL.** D1 Hub Help **IMPLEMENTED**. D2 language residuals **IMPLEMENTED**. Voice, office/Field Help, User Guide remain **NOT IMPLEMENTED**. User Guide / Help Content **FRAMEWORK START NOW** ([architecture/calibraytai-v1-user-guide-framework.md](architecture/calibraytai-v1-user-guide-framework.md)). **Manual Audience Law** controlling. One User Help Content authority started (`app/presentation/help_content.py`). PRE-UAT RELEASE GATE recorded. Manual Impact capture ([architecture/manual-impact-log.md](architecture/manual-impact-log.md)). Completed User Guide to Kevin/Ben **BEFORE** platform access. Do **not** invent FG-036. Do **not** implement Voice / office/Field Help / finished Manual from this row. Do **not** rescore V1. |
