...
| Attribute | Value |
|-----------|--------|
| Status | **GOVERNING PRODUCT-COMPLETION INSTRUMENT** (2026-09-08). Does **not** authorize implementation. |
| Product | CalibAi / The Estimator |
| Date | 2026-09-08 |
| Parent SHA | `95b396602eb578f0399e7785d7e066b6dd0056f8` (`docs: record FG-026 takeoff-to-estimate mapping preflight`) |
...
CURRENT V1 PACKAGE:
NONE AUTHORIZED
CRITICAL PATH STARTS AT V1-01 (FG-026) WHEN JOEL AUTHORIZES IMPLEMENTATION
V1-06 RUNS IN PARALLEL WHEN JOEL AUTHORIZES FG-024
...
THIS REGISTER DOES NOT AUTHORIZE FG-026, FG-024, OR ANOTHER FG-025 SLICE
```
...
| ARCHITECTURE COMPLETE / NOT IMPLEMENTED | **4** (V1-01, V1-03, V1-05, V1-07) |
| NOT STARTED | **1** (V1-11) |
| **CURRENT V1 PACKAGE** | **NONE AUTHORIZED** |
...
| Contribution | **1.5** |
| V1 REQUIRED? | **YES** |
| BLOCKER? | **NO** (implementation not authorized; not a counsel block) |
| Dependencies | FG-010 **CLOSED**; existing Draft EstimateVersion + Assembly/CostItem on the same Project |
| Governing | [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**; [fg-026-takeoff-to-estimate-mapping-preflight.md](architecture/fg-026-takeoff-to-estimate-mapping-preflight.md); ADR-005/006/007/011/031 |
| Next governed action | **STOP** until a separate FG-026 **implementation** prompt. This register does **not** authorize it. |
...
| Governing | [FG-008](feature-gates/FG-008-labour-engine-phase-b.md) **CLOSED**; [FG-009](feature-gates/FG-009-organization-calibrated-pricing-engine.md) **CLOSED**; [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED**; ADR-025/030/034/035/036 |
| Next governed action | Separate Feature Gate when Joel authorizes costing-application work. Do **not** invent costing-state machines in this register. |

**Exists today:** org CostItem / Assembly libraries; Labour Engine standards + snapshots (labour snapshot **not** in selling-price basis by default); Pricing Engine apply as a **separate human action**; historical workbook evidence.

**Does not exist:** CalibAi-developed costs with exception flags; an “Approve all costing” workflow; MaterialRequirement; supplier-priced costing.
...
**Joel decision:** confirm V1 ships with **human costing + explicit confirmation before Pricing Engine**, with exception-based CalibAi costing maturing during real UAT — versus requiring exception-based costing before BMR demo. Register recommendation: **human costing is V1-required; exception-based is V1-maturation.**
...
| Map approved quantities → estimate | V1-01 | **NOT IMPLEMENTED** |
...
**BMR DEMO READY = NO** until at least V1-01, a credible V1-03 Winchester slice, V1-02 human costing path, and a **fail-closed or Ontario** contract story that does not pretend Family 05 is legally approved.
...
| 2 | Exception-based CalibAi costing required before BMR? | **No.** Human costing + explicit approval is V1; exception-based matures in real UAT |
