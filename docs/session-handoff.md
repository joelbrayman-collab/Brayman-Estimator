...
- Alembic graph head (this working tree): **`a0b1c2d3e4f5`** (FG-037 Slice A file; **not applied live**). Live `flask db current`: **`f9b0c1d2e3f4`**. SCH-C **`f9b0c1d2e3f4` applied live** 2026-09-16. SCH-B **`f7f8a9b0c1d2`** is superseded as live current. SCH-A **`f6e7f8a9b0c1`** is superseded as live current. FG-035 TIME **`f5d6e7f8a9b0` applied live** 2026-09-15 (superseded as live current). FG-035 SCOPE **`f4c5d6e7f8a9` applied live** 2026-09-15. FG-035 TAX/WBS **`f3b4c5d6e7f8` applied live** 2026-09-15. FG-034 MAIL-A/AUTH-A **`f2a3b4c5d6e7` applied live** 2026-09-15. Remaining applied-live chain through FG-033 / FG-024 / FG-032 is unchanged.
- HEAD / `origin/main`: **`a15adb66fa80227075666e032c08d11eaf1c2aeb`** (`docs: rescore V1 readiness to 65 percent`). Working tree holds FG-037 Slice A (**not committed**). Recovery stash `stash@{0}` **`840dba8320b59ff9464410fec390d755a31a56aa`** remains available and was **not dropped**. Product PERF-B **`dcde4adfe4a475932b7f144b0220b2b60e4bd75c`**.
- Latest governed full suite (this 17 Sep 2026 FG-037 Slice A working tree, not committed): **1213 passed**, 4287 warnings, **638.51s**, exit **0**. Dedicated FG-037 **23 passed**, 75 warnings, **18.72s**. Focused auth/org/Project/Schedule/Time/Field **154 passed**, 418 warnings, **106.05s**. HISTORICAL FG-035 PERF-B post-live-UAT full suite **1190 passed**, 4212 warnings, **746.12s**, exit **0**. Dedicated PERF-B **36 passed**, 339 warnings, **18.78s**. PERF-A+B **50 passed**, 463 warnings, **26.40s**. Focused TAX/WBS+SCOPE+TIME+SCH-A+SCH-B+SCH-C+SCH-D+PERF-A+PERF-B+Hub/Field/MONITOR **206 passed**, 1047 warnings, **116.29s**. HISTORICAL PERF-A post-live-UAT full suite **1154 passed**, 3873 warnings, **633.10s**. HISTORICAL PERF-B engineering full suite **1190 passed**, 4212 warnings, **619.11s**. HISTORICAL SCH-D post-physical full suite **1140 passed**, 3749 warnings, **665.58s**.
...
**Last authorized delta:** **2026-09-17 FG-037 Slice A restore / complete (working tree / not committed).** Stash `stash@{0}` **`840dba8320b59ff9464410fec390d755a31a56aa`** applied without drop. Model, service, CLI, additive file **`a0b1c2d3e4f5`**, dedicated tests, FG-037 record. Live current remains **`f9b0c1d2e3f4`**. No live migrate. No live grant. Official V1 remains **65% / 4 of 11**. Secondary Functional V1 Build remains **79% / 22 of 28**. PERF-C **DEFINED / NOT IMPLEMENTATION-AUTHORIZED**. Next action **STOP.** Return to ChatGPT Architect. Do **not** commit. Do **not** push. Do **not** implement PERF-C.
