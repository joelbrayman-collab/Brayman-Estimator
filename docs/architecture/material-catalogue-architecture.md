...
[FG-014](../feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**.
...
3. Material Catalogue Feature Gate **FG-014 CLOSED / OPERATIONAL FOR UAT** (identity-only lumber/sheets)
