...
| Decisions pending | Live-migration / office UAT of FG-020. Ontario counsel review of Native Signing process before any Feature Gate. Archive package format. Project Closeout Feature Gate not created. Multi-membership selection remains fail-closed. Native/token auth remains deferred. |
