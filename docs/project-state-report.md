...
| Current branch | `main` |
| Current commit / `origin/main` | Committed HEAD **`d3352509b708482ac9bbacce8cea0860b2d8cfcf`**. Product SCH-A **`fd8a66990df8286e54151b80b6f3cd5be5dd3ad1`** (`feat: implement FG-035 SCH-A schedule core`). Working tree **DIRTY** with uncommitted SCH-B product + live UAT + docs. Live current = repository Alembic head **`f7f8a9b0c1d2 (head)`**. Product TIME **`03c074fb1eb2bbca77ba86e495726c0e042c1979`**. Prior product SCOPE **`21bf0eba47acdb19eb292c2319d675a1748c1dff`**. |
| Latest completed **coded** milestone on `main` | **FG-035 SCH-A** (**IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS / COMMITTED**). Working-tree SCH-B **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS / NOT COMMITTED**. Gate **OPEN / PARTIAL**. Prior coded: **FG-035 TIME**. Prior coded: **FG-035 SCOPE**. Prior coded: **FG-035 TAX/WBS**. Prior close: **FG-034 AUTH-D**. |
| Current milestone | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — V1 readiness **60%**; **4 / 11** COMPLETE. [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS **IMPLEMENTED**. SCOPE **IMPLEMENTED**. TIME **IMPLEMENTED**. SCH-A **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH-B **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH overall **OPEN / PARTIAL**. [ADR-053](adr/ADR-053-project-work-structure-and-closed-operational-learning-loop.md) **Accepted**. [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-033](feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md) **CLOSED / OPERATIONAL FOR UAT**. |
...
| Incomplete work | Help / Voice / User Manual **RECORDED / NOT IMPLEMENTED**. SCH-C / SCH-D / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**. Live Postmark **DEFERRED**. Physical iPhone Account Recovery UAT **DEFERRED**. FG-024 Slice D **not authorized**. |
...
| Documentation status | **2026-09-16 FG-035 SCH-B implemented / tested / live-migrated / bounded synthetic UAT pass / not committed.** FG-035 remains **OPEN / PARTIAL**. SCH-A **LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH-B **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH overall **OPEN / PARTIAL**. SCH-C / SCH-D / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**. V1 **unchanged** (**60% / 4 of 11**). Evidence [testing/fg035-sch-b-live-bounded-uat-record.md](testing/fg035-sch-b-live-bounded-uat-record.md). |
| Decisions made (this implementation) | 2026-09-16 applied SCH-B live migration `f6e7f8a9b0c1` → **`f7f8a9b0c1d2`**. Bounded synthetic UAT on Project **46**. USER / Crew / Unassigned / overlap / historical membership / unassign / retire transaction / Company+Hub / CSRF proven. Project **45** and EST-2026-0019 unchanged. History `assignment_id` remains Integer with no FK. |
| Decisions pending | SCH-C authorization. PERF authorization. Help/Voice/Manual preflight. Live Postmark. Physical iPhone UAT. Slice D. FG-030. V1-04. SCH-B commit/push. |
| Uncommitted work | SCH-B product, migration file, tests, live UAT record, and required implementation/continuity docs. **Not committed. Not pushed.** |
| Next approved milestone | **STOP.** Return to ChatGPT Architect. Do **not** commit. Do **not** push. Do **not** begin SCH-C / PERF / CLOSE / LEARN / QB-T. Do **not** rescore V1. |
...
| Approved next Cursor prompt location or summary | **STOP.** Return to ChatGPT Architect. No SCH-C authorization. No commit/push from this note. |
| Commit status | Committed HEAD **`d3352509b708482ac9bbacce8cea0860b2d8cfcf`**. Product SCH-A **`fd8a66990df8286e54151b80b6f3cd5be5dd3ad1`**. Live current = repo Alembic head **`f7f8a9b0c1d2 (head)`**. SCH-B **not committed**. |
