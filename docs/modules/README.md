...
| MONITOR | [monitor.md](monitor.md) | **None** — Proposed (ADR-021 **Accepted** baseline; [monitor-v1-implementation-reconnaissance.md](../architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**; **NOT IMPLEMENTED / NOT FEATURE-GATED / NOT AUTHORIZED FOR CODE**) |
