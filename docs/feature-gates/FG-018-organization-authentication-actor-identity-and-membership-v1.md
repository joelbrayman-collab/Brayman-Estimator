...
**Subsequent status (2026-09-15, FG-034 MAIL-A / AUTH-A / AUTH-B / AUTH-C / MAIL-B / AUTH-D):** [ADR-052](../adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. [FG-034](FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**. MAIL-A / AUTH-A add `credentials_epoch`, hash-at-rest reset tokens, and a shared transactional engine. AUTH-B adds responsive Forgot Password / Reset UX. AUTH-C proves complete local E2E recovery. MAIL-B connects Native Signing invitation/resend/complete to that engine. AUTH-D activates the Postmark HTTP adapter and closes the gate as operational for UAT. Live Postmark delivery remains **DEFERRED**. This gate is **not reopened**. SESSION-EXPIRY recovery remains a separate FG-021 deferred exception.
...
**Subsequent status (2026-09-17 FG-037 Slice A):** [FG-037](FG-037-company-management-access-domain-authorization.md) **OPEN / SLICE A IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / NO LIVE GRANT / NOT CLOSED**. Product SHA **`1649b6fab6d362c19088290a6f3cb52f2a0b3d92`**. This gate is **not reopened**. Do **not** implement Settings Members, Sensitive Financial, or PERF-C from this gate.
