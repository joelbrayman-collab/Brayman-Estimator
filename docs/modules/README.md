...
| MONITOR | [monitor.md](monitor.md) | **Partial** — Slice A `app/services/monitor.py` (ADR-021 **Accepted**; [monitor-v1-implementation-reconnaissance.md](../architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**; Slice B **PREFLIGHT COMPLETE**; [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN**; Hub UI **NOT IMPLEMENTED**) |
