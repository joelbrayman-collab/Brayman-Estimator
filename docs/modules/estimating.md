...
- [ADR-049](../adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Proposed**: Estimating owns the future QuickBooks-ready package; QuickBooks is destination not SoR. [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **NOT IMPLEMENTATION-AUTHORIZED**.
