...
- **Permit Intelligence** ([architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)) is **FUTURE / NOT IMPLEMENTED**. Architecture **Accepted** (ADR-037/038/039). Advisory preflight. AHJ remains final. No Feature Gate. No live lookup / external AI. Organization Brand Profile is **not** a prerequisite for analysis.
...
- **Permit Intelligence architecture** (FUTURE / NOT IMPLEMENTED; ADR-037/038/039 **Accepted**; Mike Pratt Coach House at 2562 Church Street, North Gower, Ontario as future UAT reference) — [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)
...
1. **STOP.** [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**. Permit Intelligence architecture **governed** (ADR-037/038/039 **Accepted**) and **not implemented**. Recommended first future gate **Permit Foundation V1** is **not created**. Do **not** run `flask db upgrade` again. Do not implement Permit Intelligence, MONITOR, Phase D, supplier integration, bulk supplier onboarding, Winchester POC, Organization Brand Profile, or the Change Order document family. Do not accept ADR-008.
