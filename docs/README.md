...
| [architecture/project-document-package.md](architecture/project-document-package.md) | Authoritative record + four core outputs | Outputs 1–2: [FG-012](feature-gates/FG-012-estimate-output-consistency.md) **CLOSED / OPERATIONAL FOR UAT**. Outputs 3–4 **Future**. Permit & Approvals Report is a **core project document**, **FUTURE / NOT IMPLEMENTED** (ADR-039). Change Order document family pin **FUTURE / NOT IMPLEMENTED**. |
| [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) | Permit Intelligence + Permit & Approvals Report | **Pass 2 FUTURE / NOT IMPLEMENTED** — ADR-037/038/039 **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING** |
| [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md) | Project location and reusable jurisdiction resolver | **Current (FG-015 civic foundation)** — **LIVE MIGRATION PENDING** — [ADR-037](adr/ADR-037-project-location-and-jurisdiction-resolution.md) **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) |
| [adr/ADR-037-project-location-and-jurisdiction-resolution.md](adr/ADR-037-project-location-and-jurisdiction-resolution.md) | Project location and jurisdiction resolution ownership | **Accepted** (FG-015 civic location + resolver implemented; live migration pending) |
| [adr/ADR-038-permit-intelligence-authority-and-rules-library.md](adr/ADR-038-permit-intelligence-authority-and-rules-library.md) | Permit Intelligence authority and Permit Rules Library provenance | **Accepted** (FG-015 Pass 1 foundation implemented; rules library not populated; live migration pending) |
| [adr/ADR-039-permit-report-snapshot-immutability-and-workflow.md](adr/ADR-039-permit-report-snapshot-immutability-and-workflow.md) | Permit report snapshot immutability and workflow effect | **Accepted** (FG-015 preliminary snapshot implemented; substantive report not implemented; live migration pending) |
| [modules/permit-intelligence.md](modules/permit-intelligence.md) | Permit Intelligence capability ownership | Pass 1 foundation **Current (FG-015)** — **LIVE MIGRATION PENDING**; Pass 2 not implemented |
| [architecture/organization-brand-profile.md](architecture/organization-brand-profile.md) | Organization Brand Profile, logo, brand snapshot | **Future / NOT IMPLEMENTED** — requirement pin only; not a Feature Gate; not logo storage implementation |
...
| [feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) | Permit Foundation V1 — Project Location, Jurisdiction & Preliminary Permit Profile | **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING** |
| [adr/ADR-032-app-managed-historical-workbook-storage.md](adr/ADR-032-app-managed-historical-workbook-storage.md) | App-managed immutable historical workbook storage / source custody | **Accepted** (FG-013 **CLOSED / OPERATIONAL FOR UAT**; revision `c5d6e7f8a9b0` live current=head) |
