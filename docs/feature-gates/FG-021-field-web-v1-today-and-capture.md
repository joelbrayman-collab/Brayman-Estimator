...
**Current remaining real-iPhone UAT (2026-09-05 after background/foreground PASS):** session-expiry recovery; CSRF recovery; older supported iPhone/Safari smoke where practical; orientation / portrait / one-handed / outdoor readability. Observation Delete remains **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED**. Background/foreground persistence is **PASS**. Do **not** close FG-021 from this PASS alone.
