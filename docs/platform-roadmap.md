...
| Layer | Position |
|-------|----------|
| **CURRENT** | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE-MIGRATED / IPHONE UAT OPEN**. Gate **NOT CLOSED**. Text **PASS**. Screenshot PNG **PASS**. **TAKE PHOTO PASS AS JPEG.** **HEIC REAL-DEVICE NOT YET TESTED.** **REAL IPHONE VOICE SAVE PASS** (Event **30**, `audio/mp4`). **REAL IPHONE NETWORK RETAIN / RETRY PASS** (Event **31**, text). Desktop continuity **PASS**. Observation Delete **QUEUED**. Approved presentation source custody **CLOSED**. [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING** (parallel document-template track; seven masters extracted). Live current = head **`d2e3f4a5b6c7`**. Dedicated FG-021 **19**. Focused **147**. Full **557**. FG-008 through FG-020 **CLOSED / OPERATIONAL FOR UAT**. Native Signing: **development may proceed under separate governance**; **production activation blocked pending counsel process approval**. |
| **NEXT AUTHORIZED ACTION** | **STOP** for Joel/ChatGPT review of FG-022 masters before JOEL APPROVED. Do **not** close FG-022. Do **not** implement HEIC, mixed capture, Observation Delete, or FG-021 closure from this pass. |
...
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) reusable presentation masters (**IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING**; **not** item 12). Project Closeout / archive-and-purge; Native Signing production; Phase D; supplier integration; Change Order document family; Permit branding / national expansion; QuickBooks; Ontario Contract / Warranty; MONITOR; LEARN; real external AI; other repository-recorded future work. Not reordered here. Not authorized by this increment. |
