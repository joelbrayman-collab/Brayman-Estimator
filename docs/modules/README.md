...
| BUILD | [build.md](build.md) | **None** — Proposed (ADR-020); not implemented. Blocked behind Item 10 ([ADR-041](../adr/ADR-041-user-membership-and-office-authentication.md) **Proposed**; [FG-018](../feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **DRAFT / NOT APPROVED**) |
