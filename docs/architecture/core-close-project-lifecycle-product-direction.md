...
**Subsequent status (2026-09-18 FG-038 PA-A working tree):** [FG-038](../feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL / PA-A IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE CREATED / NOT LIVE-MIGRATED / NO OWNER ASSIGNED.** `require_instance_owner_or_system_administrator()` exists. Close/Reopen **NOT IMPLEMENTED**. Live Alembic remains **`b2c3d4e5f6a7`**. Graph head **`c3d4e5f6a7b8`**. CORE CLOSE overall remains **PARTIAL / NOT OPERATIONAL**.
