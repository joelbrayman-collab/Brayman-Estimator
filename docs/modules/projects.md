...
- Project work taxonomy / Time / Schedule / LEARN consumers — TAX/WBS + SCOPE **Current** ([FG-035](../feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**). TIME / SCH / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**.
