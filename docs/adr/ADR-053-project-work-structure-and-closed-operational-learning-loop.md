...
**Subsequent status (2026-09-18 CORE CLOSE Slice A):** Slice A **IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE `b2c3d4e5f6a7` CREATED / NOT LIVE-MIGRATED / NOT COMMITTED**. Close/Reopen remain **NOT IMPLEMENTED**. This ADR is **not rewritten**. No new ADR. LEARN remains unauthorized.

**Subsequent status (2026-09-18 CORE CLOSE Slice A):** Slice A **IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE `b2c3d4e5f6a7` CREATED / NOT LIVE-MIGRATED / NOT COMMITTED**. CORE CLOSE (operating `ACTIVE` / `CLOSED`) remains **distinct** from Decisions O–P LEARN Closeout below. This ADR is **not rewritten**. No new ADR. Close/Reopen / Punch List / Completion Sign-Off remain unimplemented. LEARN remains unauthorized.
