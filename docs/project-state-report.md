...
| Current branch | `main` |
| Current commit / `origin/main` | Product SHA **`70e571140e12377aa5bd009b598530576401113b`** (`feat: implement FG-032 QuickBooks-ready artifacts`). Prior architecture recording `docs: define V1-05 QuickBooks Option A` / errata `docs: correct FG-032 Issued vs Accepted freeze`. Product parent **`5e1082af68e0eb145d9da01c0fa26585f6b8b9d1`**. Live current **`d8e9f0a1b2c3`**. Repository Alembic head **`e9f0a1b2c3d4`**. |
