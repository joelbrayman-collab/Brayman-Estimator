...
- FG-035 CORE CLOSE Slice A: `Project.operating_state` / `operating_state_changed_at` / `operating_state_changed_by_user_id`; `ProjectOperatingStateEvent`; `list_current_operating_projects` in `app/services/shared_api.py`; additive file **`b2c3d4e5f6a7`** not applied live. Product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. No `close_project` / `reopen_project`. Live consumers still call `list_organization_projects`.

## 10. TEST / UAT / MIGRATION STATUS

- Latest CORE CLOSE Slice A: live current remains **`a0b1c2d3e4f5`**. Repository graph head **`b2c3d4e5f6a7`**. Product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. Migration file created, not applied live. Dedicated **18 passed**. Focused **176 passed**, 670 warnings, **110.43s**, exit **0**. Full suite **1244 passed**, 4390 warnings, **640.57s**, exit **0**.
...
**Next governed action:** **STOP.** CORE CLOSE Slice A is **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED**. Product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. Canonical [architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md). Return to ChatGPT Architect. Do **not** live-migrate. Do **not** implement Close, Reopen, Punch List, or Completion Sign-Off. PERF-C remains **SEALED**. FG-035 remains **OPEN / PARTIAL**. FG-037 remains **CLOSED**. Official V1 readiness **65% / 4 of 11**. Secondary Functional V1 Build **79% / 22 of 28**. Do **not** implement People & Access, Home Office, LEARN, or QB-T. Do **not** drop the recovery stash.
