...
| [adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) | QuickBooks-ready output ownership, freeze, human-entry | **Accepted** 10 Sep 2026 ([FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) Slices A+B **IMPLEMENTED / NOT LIVE-MIGRATED / NOT CLOSED**) |
| [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) | FG-032 Option A schema, workflow, field matrix | **RECONCILED** with Slices A+B. Migration file **`e9f0a1b2c3d4`** not applied live. |
| [feature-gates/FG-032-quickbooks-ready-output-entry-v1.md](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) | QuickBooks-Ready Output / Controlled Human-Entry V1 | **SLICES A+B IMPLEMENTED / TESTED / NOT LIVE-MIGRATED / OVERALL NOT CLOSED** |
