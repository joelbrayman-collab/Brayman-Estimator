...
### BUILD field evidence (architecture accepted; implementation not authorized)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-042](ADR-042-build-field-evidence-and-iphone-first-capture.md) | BUILD Field Evidence, Original Observation Custody, Desktop Review, and iPhone-First Capture Architecture | **Accepted** (2026-08-31). Implementation **not started**. [FG-020](../feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **APPROVED / IMPLEMENTATION NOT STARTED**. |
