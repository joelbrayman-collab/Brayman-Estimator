...
| [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) | Construction contract + warranty template governance; Legal Content Gate (Ontario first; North American library future under FG-024) | **Governing** — templates remain empty; Slice A engine **CLOSED / OPERATIONAL FOR UAT** (live / empty); Slice B architecture **PREFLIGHT COMPLETE**; [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **NOT CLOSED** |
