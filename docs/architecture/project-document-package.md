...
| Updated | 2026-09-13 |
| Implementation | **FG-012** authorizes outputs **1 and 2**. **CLOSED / OPERATIONAL FOR UAT** (2026-08-30). Output 3 is **CLOSED / OPERATIONAL FOR UAT** under [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) (Joel Option A 2026-09-10). Output 4 remains Future / not complete. Contract/warranty generation is the CONTRACT home of [FG-024](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) (**RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B CLOSED / OPERATIONAL FOR UAT / SLICE C CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL**). Slice A preflight: [fg-024-slice-a-legal-content-library-preflight.md](fg-024-slice-a-legal-content-library-preflight.md). Slice B preflight: [fg-024-slice-b-legal-content-source-lifecycle-preflight.md](fg-024-slice-b-legal-content-source-lifecycle-preflight.md). Slice C preflight: [fg-024-slice-c-contract-generation-snapshot-preflight.md](fg-024-slice-c-contract-generation-snapshot-preflight.md). [ADR-050](../adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**. [ADR-051](../adr/ADR-051-legal-content-source-and-update-lifecycle.md) **Accepted**. |
...
**Current implementation note:** Estimate versions, proposal snapshots, and PDF output exist today. [FG-012](../feature-gates/FG-012-estimate-output-consistency.md) (**CLOSED / OPERATIONAL FOR UAT**) governs consistency of outputs **1 and 2**. Internal breakdown: `GET /estimates/<id>/versions/<version_id>/internal-breakdown`. The existing **Proposal** preview/PDF **is** the customer-facing estimate. Contract / execution package generation and warranty attachment remain **Future / not implemented**. Ontario is the first expected Canadian package, not the product scope of CONTRACT. QuickBooks-ready output 3 is **CLOSED / OPERATIONAL FOR UAT** ([FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) Hub PRICE `/projects/<id>/quickbooks-entry`). [FG-024](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) Slice A empty-library engine is **CLOSED / OPERATIONAL FOR UAT** (live / empty). Slice B update foundation is **CLOSED / OPERATIONAL FOR UAT** (live). Slice C generation is **CLOSED / OPERATIONAL FOR UAT** (engine live / synthetic-UAT proven / no real jurisdictional content). Output 4 remains **not** complete.

**Source-contract principle:** every governed output must identify and derive from the authoritative `EstimateVersion` and, when present, its `EstimatePricingSnapshot`. Historical customer documents must not silently float with later estimate edits. Later MONITOR / Project Gross Margin uses that same frozen pin plus the Accepted Proposal and approved Change Order deltas ([ADR-021](../adr/ADR-021-monitor-commercial-baseline.md) **Accepted**; [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**).
...
**Status:** **CLOSED / OPERATIONAL FOR UAT** ([FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md); [ADR-049](../adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted**). Joel selected **Option A** on 2026-09-10. Live QuickBooks API is **POST-V1**.

V1 output 3 is a **controlled pair**:

1. **Sales-estimate entry sheet** (Family 04 **INTERNAL ENTRY REFERENCE**) for manual QuickBooks Estimate entry.
2. **Planned cost-classification companion** (not in Family 04) using FG-027 costing amounts and frozen FG-031 routing.

See [quickbooks-integration.md](quickbooks-integration.md) and [fg-032-quickbooks-option-a-preflight.md](fg-032-quickbooks-option-a-preflight.md). Do **not** claim import files or QuickBooks API.

### 4. Contract / execution package

**Audience:** Customer signature package.

Generated **only from an APPROVED estimate**, and **only** from an ACTIVE counsel-approved jurisdiction package ([FG-024](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md); [legal-content-and-templates.md](../governance/legal-content-and-templates.md)). If no such package exists: **FAIL CLOSED**. No generic North American fallback.

Ontario is the **first expected Canadian package** under the North American library because ORG-001 / Brayman Construction operates in Ontario. Ontario is **not** the architectural scope of CONTRACT. Family 05 remains **COMMERCIAL_DRAFT / NOT LEGALLY APPROVED** presentation only.
...
- Jurisdiction package identity / legal-content versions / effective-date authority (when generation exists)

**Warranty:** The applicable construction contract must be accompanied by the governed **warranty document** as an attachment or schedule when the jurisdiction package requires it. See [legal-content-and-templates.md](../governance/legal-content-and-templates.md), [FG-024](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md), and [fg-024-slice-a-legal-content-library-preflight.md](fg-024-slice-a-legal-content-library-preflight.md).
...
| QuickBooks-ready package (output 3) | **Estimating / output layer** — [FG-032](../feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**; [quickbooks-integration.md](quickbooks-integration.md). Not a live API. Not Proposal-owned. |
| Contract / execution package | Governed templates — [legal-content-and-templates.md](../governance/legal-content-and-templates.md). North American library / update engine / frozen snapshot: [FG-024](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B CLOSED / OPERATIONAL FOR UAT / SLICE C CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL**. Preflight: [fg-024-slice-a-legal-content-library-preflight.md](fg-024-slice-a-legal-content-library-preflight.md). Slice B preflight: [fg-024-slice-b-legal-content-source-lifecycle-preflight.md](fg-024-slice-b-legal-content-source-lifecycle-preflight.md). Slice C preflight: [fg-024-slice-c-contract-generation-snapshot-preflight.md](fg-024-slice-c-contract-generation-snapshot-preflight.md). [ADR-050](../adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**. [ADR-051](../adr/ADR-051-legal-content-source-and-update-lifecycle.md) **Accepted**. Ontario is the first expected Canadian package. |
...
- [feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md](../feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) — **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B CLOSED / OPERATIONAL FOR UAT / SLICE C CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL** North American contract intelligence
- [fg-024-slice-a-legal-content-library-preflight.md](fg-024-slice-a-legal-content-library-preflight.md) — Slice A engine freeze; **CLOSED / OPERATIONAL FOR UAT**
- [fg-024-slice-b-legal-content-source-lifecycle-preflight.md](fg-024-slice-b-legal-content-source-lifecycle-preflight.md) — Slice B source/update freeze; **CLOSED / OPERATIONAL FOR UAT**
- [fg-024-slice-c-contract-generation-snapshot-preflight.md](fg-024-slice-c-contract-generation-snapshot-preflight.md) — Slice C generation / snapshot freeze; **PREFLIGHT COMPLETE**; subsequent product **IMPLEMENTED IN REPOSITORY / NOT LIVE-MIGRATED**
- [ADR-050](../adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted** (Slice A **CLOSED / OPERATIONAL FOR UAT**; live / empty)
- [ADR-051](../adr/ADR-051-legal-content-source-and-update-lifecycle.md) **Accepted** (Slice B **CLOSED / OPERATIONAL FOR UAT**; §6 deferred)
...
- [contract-esignature-and-signed-change-order.md](contract-esignature-and-signed-change-order.md) — **ARCHITECTURE RECONNAISSANCE COMPLETE / NOT IMPLEMENTED**; recommendation **NATIVE V1**; counsel spec **PREPARED**; implementation **NOT AUTHORIZED**
