...
| [organization-brand-profile.md](organization-brand-profile.md) | **IMPLEMENTED / LIVE MIGRATION PENDING** — [ADR-040](../adr/ADR-040-organization-brand-profile.md) **Accepted**; [FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) |
