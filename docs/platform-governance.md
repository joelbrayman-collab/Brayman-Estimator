...
| QuickBooks pipeline (Option A **CLOSED / OPERATIONAL FOR UAT**; no API) | [architecture/quickbooks-integration.md](architecture/quickbooks-integration.md) · [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**; [ADR-049](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted** |
| Ontario contract + warranty / Legal Content Gate | [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) — registers **empty**; [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B CLOSED / OPERATIONAL FOR UAT / SLICE C CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL** (Slice D **NOT AUTHORIZED**; Ontario first expected package; no population) |
| Account Recovery + transactional email | [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**. MAIL-A / AUTH-A / AUTH-B / AUTH-C / MAIL-B / AUTH-D **IMPLEMENTED / PASS**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake mail UAT. Live Postmark **DEFERRED — PROVIDER CONFIGURATION REQUIRED / NOT CLAIMED AS PASS**. Does **not** reopen FG-018, FG-021, or FG-033. Does **not** rescore V1. |
| Project work structure / operational learning loop | [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS **IMPLEMENTED**. [ADR-053](adr/ADR-053-project-work-structure-and-closed-operational-learning-loop.md) **Accepted**. Product direction [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md). CORE CLOSE Slice A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED**. CORE CLOSE Slice B **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NO MIGRATION** (product SHA **`9360b706ab66f2588306b201ca0c4c45645fcb9a`**) ([architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md)). Live Alembic **`e5f6a7b8c9d0 (head)`**. Close/Reopen Option A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NO MIGRATION / NOT LIVE-UATed** (product SHA **`172f0786aaa9e668f30be28c3cee30ac4fce5b1f`**). C1 Contractor Punch List **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / EMPTY LIVE BASELINE VERIFIED / NOT LIVE-UATed WITH MUTATING DATA** (product SHA **`81b6d802ccf15c10b01a1f63337ef4d0d5a26d6c`**). Punch List **LIVE / 0 ITEMS**. C2 Client Final Walkthrough **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / EMPTY LIVE BASELINE VERIFIED / NOT LIVE-UATed WITH CLIENT DATA** (product SHA **`ec4ef9956025fd8e281c12c17d84493b121f8337`**). LEARN Closeout / LEARN / QB-T **NOT AUTHORIZED**. Does **not** reopen FG-023. Does **not** rewrite FG-032. Does **not** rescore V1. |
| Instance Owner / People & Access PA-A / PA-B / PA-C | [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL.** PA-A **LIVE / OPERATIONAL** (product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**). PA-B **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / LIVE APPOINT UAT PASS / LIVE REMOVE UAT PASS / ZERO CURRENT SYS ADMINS.** Product SHA **`2b25ec99b010c0c66d58d6aa08fdbab55b077e08`**. PA-C **LIVE / OPERATIONAL / LIVE PERSON UAT PASS.** Product SHA **`0698f9d2a4ccabcef53ebcef9cb1415bfcd470f7`**. Pin SHA **`bc0ce7f541728262df0573a6096b5948d7abe6ed`**. Additive **`g7b8c9d0e1f2` applied live**. Live Alembic **`g7b8c9d0e1f2 (head)`**. Live Person rows **1** (INACTIVE synthetic UAT Person retained). ORG-001 Owner = Membership **1** / User **1** / Joel Brayman. Current Sys Admin **0**. APPOINT **1**. REMOVE **1**. People & Access UI **NOT IMPLEMENTED**. PA-D **NOT IMPLEMENTED**. Does **not** rescore V1. |
| Interactive Help / Voice / User Manual | [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **OPEN / PARTIAL.** D1 Hub Help **IMPLEMENTED**. D2 language residuals **IMPLEMENTED**. D3 office Help **IMPLEMENTED**. D4 Field Help **IMPLEMENTED**. D5 Voice-with-Help **IMPLEMENTED / TESTED / COMMITTED / PUSHED** as an interface to `help_payload()` / `answer_help_question()`. Voice actions **NOT IMPLEMENTED / NOT V1**. User Guide remains **NOT IMPLEMENTED**. User Guide / Help Content **FRAMEWORK START NOW** ([architecture/calibraytai-v1-user-guide-framework.md](architecture/calibraytai-v1-user-guide-framework.md)). **Manual Audience Law** controlling. One User Help Content authority (`app/presentation/help_content.py`). PRE-UAT RELEASE GATE recorded. Manual Impact capture ([architecture/manual-impact-log.md](architecture/manual-impact-log.md)). Completed User Guide to Kevin/Ben **BEFORE** platform access. Do **not** invent FG-036. Do **not** implement finished Manual from this row. Do **not** rescore V1. |
| Employment vs Entrepreneurship Decision Tool | [FG-039](feature-gates/FG-039-employment-vs-entrepreneurship-decision-tool.md) **OPEN / AUTHORIZED / IMPLEMENTED IN WORKING TREE / NOT COMMITTED.** Neutral PLAN calculator. No schema. No migration. No live DB. Does **not** invent FG-036. Does **not** start F07 or F15. Does **not** rescore V1. |
| Native Signing | [FG-033](feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md) **CLOSED / OPERATIONAL FOR UAT**. SIGN-A **IMPLEMENTED**. SIGN-B **IMPLEMENTED**. SIGN-C **IMPLEMENTED**. SIGN-D **IMPLEMENTED** (automated). SIGN-E **IMPLEMENTED**. Desktop + iPhone / mobile on one responsive ceremony. Real iPhone UAT **DEFERRED TO BRAYMAN / BEN REAL-WORLD UAT** — **NOT CLAIMED AS PASS**. Recon [architecture/contract-esignature-and-signed-change-order.md](architecture/contract-esignature-and-signed-change-order.md). Recommendation **NATIVE V1**. Production / real-customer Native Signing **NOT COMPLETE**. No external-review dependency. Does **not** rescore V1. |
| Field Web / Today + Capture | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **CLOSED**; [architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md); live current = head `d2e3f4a5b6c7`; SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED** |
| MONITOR V1 (Item 13) | [architecture/monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**; [architecture/fg-023-monitor-v1-implementation-preflight.md](architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE**; [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**; Slice A + Slice B **IMPLEMENTED / LIVE-MIGRATED**; Slice C **MIGRATION COMPLETE / OFFICE UAT COMPLETE / PASS**; Hub `#hub-monitor` **live / office-UAT-verified**; [ADR-021](adr/ADR-021-monitor-commercial-baseline.md) **Accepted** |
| Contractor-facing UX language | [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / IMPLEMENTATION PREFLIGHT COMPLETE / SLICE 1 IMPLEMENTED / SLICE 2 IMPLEMENTED / SLICE 3 IMPLEMENTED / SLICE 4 IMPLEMENTED / SLICE 5 IMPLEMENTED / SLICE 6 IMPLEMENTED / NOT CLOSED** — Project Hub, office PRICE specialist, shared office shell, Field Web, and customer Proposal preview/PDF display mapping implemented; remaining surfaces not authorized; not a product-wide sweep |
| PLAN → PRICE Phase D takeoff-to-estimate mapping | [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT** — PLAN proposes / Estimating commits; package approval does **not** insert; additive `f4a5b6c7d8e9` applied live |
| CalibraytAI V1 completion | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — readiness **60%**; **4 / 11** major packages COMPLETE (V1-01, V1-02, V1-03, V1-05); BMR DEMO READY **NO**; BRAYMAN REAL-LIFE UAT READY **NO**; does **not** authorize FG-024 Slice D, FG-030 implementation, V1-04 product work, or another FG-025 slice. Product identity: [governance/product-identity.md](governance/product-identity.md). |
| Reusable approved document template family | [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**; Legal Content Gate **empty**; Family 05 **COMMERCIAL_DRAFT / NOT LEGALLY APPROVED**; does **not** alter FG-021 |
