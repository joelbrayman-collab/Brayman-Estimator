...
This ADR is the **ownership and freeze boundary** for V1-05 Option A: a governed QuickBooks-ready output and controlled human-entry workflow. Joel authorized FG-032 Slices A+B implementation on **10 Sep 2026**, Slice C implementation on **11 Sep 2026**, and Slice C live migration plus bounded office UAT on **11 Sep 2026**. It does **not** authorize CSV/IIF/Excel generation or a live QuickBooks API. It does **not** accept [ADR-008](ADR-008-supplier-price-snapshotting.md). Slice C is **live-migrated / bounded office UAT PASS**. This ADR / FG-032 is **not closed**.
