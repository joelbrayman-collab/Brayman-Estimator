...
|-------|--------|
| Branch | `main` |
| HEAD / `origin/main` | FG-020 live-migration / office UAT close: verify `git rev-parse HEAD` and `git rev-parse origin/main` after this commit. Parent `473b04eff8766f917e46abf793cc699b179a4fb6`. Live Alembic current = head **`c1d2e3f4a5b6`**. |
...
| **Working tree at last verified inspect** | **FG-020 CLOSED / OPERATIONAL FOR UAT.** Image-only Compatible Renditions (HEIC/HEIF → JPEG) **implemented**. Project Closeout **FUTURE**. Live current = head `c1d2e3f4a5b6`. Office UAT port **5013**. Full suite **538 passed**. Dedicated FG-020 **44 passed**. Focused **128 passed**. [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. FG-008–FG-020 **CLOSED / OPERATIONAL FOR UAT**. Item 11 **COMPLETE**. Item 12 architecture reconnaissance **COMPLETE / NOT IMPLEMENTED**. Native Signing **DEVELOPMENT MAY PROCEED UNDER SEPARATE GOVERNANCE**; **PRODUCTION ACTIVATION BLOCKED PENDING COUNSEL PROCESS APPROVAL**. |
...
- CalibAi V1 Field Web / four-output **outputs 3–4** / QuickBooks API / Ontario contract
...
- **BUILD Field Capture V1** ([feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md)) — **CLOSED / OPERATIONAL FOR UAT.** Live current = head `c1d2e3f4a5b6`. Office UAT port **5013**. Item 11 **COMPLETE**. Item 12 architecture reconnaissance **COMPLETE / NOT IMPLEMENTED** ([architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md)). Implementation **NOT AUTHORIZED**. No Field Web Feature Gate.
...
- Alembic **graph** head (repository): `c1d2e3f4a5b6` (FG-020)
- Live development/UAT `flask db current`: `c1d2e3f4a5b6`. Live current = head. One graph head.

## Current milestone status

M005–M011, **FG-006**, **FG-008**, **FG-009**, and **M012 / FG-010** remain **implemented, verified, committed, and pushed** on `main`.

- **Current coded work:** [FG-020](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-016](feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) **CLOSED / OPERATIONAL FOR UAT**.
- **Approved, next:** **STOP Field Web implementation.** Item 12 recon is **COMPLETE / NOT IMPLEMENTED**. Do **not** create FG-021 or ADR-043 without a separate authorization. Native Signing **development** may proceed only under **separate** governance; **production activation** remains blocked pending counsel process approval. Do **not** implement Project Closeout or Contract templates. Do **not** weaken the Legal Content Gate.
- **Roadmap direction (not authorization):** item 10 is **COMPLETE**. Item 11 is **COMPLETE**. Item 12 recon is **COMPLETE / NOT IMPLEMENTED**. Project Closeout **FUTURE**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
- **Blocked / Not Started (product):** Field Web implementation; Native Signing **production activation**; Project Closeout / archive-and-purge; Phase D estimate mapping; four-output package outputs 3–4; QuickBooks; Ontario contract/warranty templates; MONITOR implementation; LEARN; industry benchmarking; historical evidence repair; real external AI provider; supplier/Winchester POC; bulk supplier onboarding; national Permit Rules expansion; Change Order document family; Permit branding; RBAC; org-switcher.
...
1. **STOP Field Web implementation.** [FG-020](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) is **CLOSED / OPERATIONAL FOR UAT**. Item 11 **COMPLETE**. Item 12 recon is **COMPLETE / NOT IMPLEMENTED** ([architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md)). Do **not** implement Field Web. Do **not** create FG-021 or ADR-043 without Joel’s next authorization. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008. Do not accept ADR-010.
