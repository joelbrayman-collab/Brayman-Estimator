...
| [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) | FG-032 Option A schema, workflow, field matrix | **RECONCILED.** [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**. Gate-at-close live current **`f1a2b3c4d5e6 (head)`**. Live current today **`b7c8d9e0f1a2 (head)`**. |
...
| [testing/fg033-sign-a-live-bounded-uat-record.md](testing/fg033-sign-a-live-bounded-uat-record.md) | FG-033 SIGN-A live migrate + office synthetic UAT | **UAT PASS** (2026-09-14). Live current **`b7c8d9e0f1a2 (head)`**. PRODUCTION packages **0**. Gate overall **OPEN / PARTIAL**. |
