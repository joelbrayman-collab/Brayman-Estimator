...
| Status | **Accepted** (2026-09-15; Joel Brayman / ChatGPT Architect). MAIL-A / AUTH-A product implementation is separately authorized under [FG-034](../feature-gates/FG-034-account-recovery-and-transactional-email.md). AUTH-B / AUTH-C / MAIL-B / AUTH-D remain unauthorized until later bounded prompts. |
| Date | 2026-09-15 |
...
**Negative:** Live Postmark, sender domain, and AUTH-B UX are still required before the gate closes. MAIL-A without UX is not the complete product.
