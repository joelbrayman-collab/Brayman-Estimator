...
### Organization Brand Profile (draft only; not implemented)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-040](ADR-040-organization-brand-profile.md) | Organization Brand Profile, Logo Custody, and Issued-Document Brand Snapshots | **Proposed / for Joel review** (2026-08-30; [FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT FOR JOEL REVIEW / NOT APPROVED**; **not implemented**; does **not** authorize product work) |
