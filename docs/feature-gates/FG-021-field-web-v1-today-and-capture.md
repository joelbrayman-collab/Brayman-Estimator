...
**Current remaining real-iPhone UAT (2026-09-06 after CSRF recovery PASS):** session-expiry recovery (**OPEN / DEFERRED / NOT YET EXERCISED**); older supported iPhone/Safari smoke where practical; orientation / portrait / one-handed / outdoor readability. Observation Delete remains **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED**. CSRF recovery is **PASS**. Do **not** close FG-021 from this PASS alone.
