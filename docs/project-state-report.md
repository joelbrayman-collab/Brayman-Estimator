...
| Current branch | `main` |
| Current commit / `origin/main` | FG-032 Slices A+B implementation (this commit). Prior architecture recording `docs: define V1-05 QuickBooks Option A` / errata `docs: correct FG-032 Issued vs Accepted freeze`. Product parent **`5e1082af68e0eb145d9da01c0fa26585f6b8b9d1`**. Live current **`d8e9f0a1b2c3`**. Repository Alembic head **`e9f0a1b2c3d4`**. |
...
| Test status | Dedicated FG-032 **23 passed**, 306 warnings, 9.50s. Focused regression **209 passed**, 1279 warnings, 89.55s. Full **`./venv/bin/python -m pytest -q` → 751 passed**, 2479 warnings, 350.35s. Live migration **NOT RUN**. |
...
| Commit status | FG-032 Slices A+B implementation (`feat: implement FG-032 QuickBooks-ready artifacts`). Live current `d8e9f0a1b2c3`. Repo head `e9f0a1b2c3d4`. |
