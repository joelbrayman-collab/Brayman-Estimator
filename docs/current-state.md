...
| **Working tree at last verified inspect** | **FG-020 CLOSED / OPERATIONAL FOR UAT.** Image-only Compatible Renditions (HEIC/HEIF → JPEG) **implemented**. Project Closeout **FUTURE**. Live current = head `c1d2e3f4a5b6`. Office UAT port **5013**. Full suite **538 passed**. Dedicated FG-020 **44 passed**. Focused **128 passed**. [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. FG-008–FG-020 **CLOSED / OPERATIONAL FOR UAT**. Item 11 **COMPLETE**. Item 12 **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**. Native Signing **WAITING FOR COUNSEL / IMPLEMENTATION NOT AUTHORIZED**. |
...
- **Contract / e-signature / signed Change Order** ([architecture/contract-esignature-and-signed-change-order.md](architecture/contract-esignature-and-signed-change-order.md)) — **ARCHITECTURE RECONNAISSANCE COMPLETE / NOT IMPLEMENTED.** Recommendation **NATIVE V1**. Counsel process-review specification **PREPARED** ([legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md)) — **DRAFT FOR ONTARIO COUNSEL REVIEW / NOT LEGAL APPROVAL**. Implementation **NOT AUTHORIZED**. No signing Feature Gate. **WAITING FOR COUNSEL.** FG-020 close does not start signing work.
- **BUILD Field Capture V1** ([feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md)) — **CLOSED / OPERATIONAL FOR UAT.** Live current = head `c1d2e3f4a5b6`. Office UAT port **5013**. Item 11 **COMPLETE**. Item 12 **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**.
...
- **Approved, next:** **STOP.** Give Ontario counsel [legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md). Do **not** implement Native Signing. Do **not** create a signing Feature Gate. Do **not** start Field Web. Do **not** implement Project Closeout or Contract.
- **Roadmap direction (not authorization):** item 10 is **COMPLETE**. Item 11 is **COMPLETE**. Item 12 is **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**. Project Closeout **FUTURE**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
- **Blocked / Not Started (product):** Field Web; Project Closeout / archive-and-purge; Phase D estimate mapping; four-output package outputs 3–4; QuickBooks; contracts; Native Signing implementation; MONITOR implementation; LEARN; industry benchmarking; historical evidence repair; real external AI provider; supplier/Winchester POC; bulk supplier onboarding; national Permit Rules expansion; Change Order document family; Permit branding; RBAC; org-switcher.
...
1. **STOP.** [FG-020](feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) is **CLOSED / OPERATIONAL FOR UAT**. Live current = head `c1d2e3f4a5b6`. Item 11 **COMPLETE**. Item 12 is **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**. Do **not** start Field Web. Do **not** implement Native Signing, Project Closeout, or Contract. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008. Do not accept ADR-010.
2. **Commercial Execution:** give Ontario counsel [legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md). Native Signing remains **WAITING FOR COUNSEL / IMPLEMENTATION NOT AUTHORIZED**.
...
5. Do not enable a real external AI provider. Do not start Phase D estimate mapping. Do not start Field Web, MONITOR, LEARN, QuickBooks, or contract/warranty work. Accepting ADR-021 does **not** authorize a MONITOR Feature Gate. Accepting ADR-033 does **not** authorize a supplier Feature Gate, Winchester POC, or Darcy commercial terms.
