...
| Current branch | `main` |
| Current commit / `origin/main` | FG-027 close docs SHA **this commit** (pin follows). Parent pin **`cf282bc6ea5cb8c917b9bae052c84a31cae65445`**. Product repair SHA **`72949f99da2b56ec06e95e16e29fa194a6730bbd`**. Implementation SHA **`c751d72b32f1ed415375719df2fd69936ace64d7`**. Live current = heads **`a5b6c7d8e9f0`**. |
...
| Uncommitted work | This close-docs working tree (SHA pending commit). |
...
| Commit status | Close SHA **this commit**. Live current = heads `a5b6c7d8e9f0`. FG-027 **CLOSED / OPERATIONAL FOR UAT**. FG-026 **CLOSED**. FG-025 **SLICE 1–5 IMPLEMENTED / NOT CLOSED**. FG-024 **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. |
