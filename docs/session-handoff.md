...
| Attribute | Value |
|-----------|--------|
| Status | **FG-035 SCOPE IMPLEMENTED / LIVE-MIGRATED / SYNTHETIC UAT PASS.** [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS **IMPLEMENTED**. SCOPE **IMPLEMENTED**. TIME / SCH / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**. [ADR-053](adr/ADR-053-project-work-structure-and-closed-operational-learning-loop.md) **Accepted**. Additive **`f4c5d6e7f8a9`**. Live current **`f4c5d6e7f8a9 (head)`**. Help / Voice / User Manual remain **FUTURE / RECORDED / NOT IMPLEMENTED**. [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **CLOSED / OPERATIONAL FOR UAT**. Live Postmark **DEFERRED**. **FG-033 CLOSED / OPERATIONAL FOR UAT**. EST-2026-0019 untouched. PRODUCTION packages **0**. CalibraytAI V1 readiness **60%**. **4 / 11** COMPLETE. BRAYMAN REAL-LIFE UAT READY **NO**. |
| Updated | 2026-09-15 |
