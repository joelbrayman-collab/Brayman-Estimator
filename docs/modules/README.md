...
| Labour Engine | [labour-engine.md](labour-engine.md) | FG-008 Phase B foundation (`app/models/labour_engine.py`, `/labour-engine/`) — **CLOSED / OPERATIONAL FOR UAT**; revision `f2c3d4e5f6a7` in chain (**gate-at-close** live head `b4c5d6e7f8a9`; live head today `a9b0c1d2e3f4`) |
...
| BUILD | [build.md](build.md) | **None** — [ADR-020](../adr/ADR-020-build-module-boundary.md) **Accepted** (boundary). [ADR-042](../adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. [FG-020](../feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **DRAFT / NOT APPROVED**. Not implemented. Item 11 **governance in progress / NOT AUTHORIZED**. Item 12 **BLOCKED**. |
