...
- Scheduling, daily reports, timesheets. Visual Dynamic Project / Crew Scheduling and the complete Time / Performance / MONITOR / LEARN loop are **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED** ([architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md)).
