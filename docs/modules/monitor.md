...
**Not implemented (out of V1):** MONITOR snapshot table; forecast-final GM; NET PROFIT; Field Event conversion; QuickBooks; Field Web MONITOR. LEARN remains Future on the Hub. Preflight: [fg-023-monitor-v1-implementation-preflight.md](../architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE**. Feature Gate: [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. PKG-S16 adds `change_orders.approved_internal_direct_cost` persistence. **PKG-F07 CLOSED** at product SHA **`79026762decf45082f73325f7056285fe8948eff`**. Extra Work Approve capture + MONITOR consume: complete-set Extra internal cost added to `current_authorized_estimated_cost`; otherwise original DC + **Not captured**. Sell/revenue identities preserved. No new cost-variance card.
