...
- Later FG-027 CURRENT costing snapshot (Estimating-owned; [ADR-044](../adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md)). **CLOSED / OPERATIONAL FOR UAT.** Office consume / STALE / re-apply **PASS**. `include_labour_snapshot_direct_cost=False` remains unchanged.
...
- V1-02 / [FG-027](../feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) requires governed Apply Pricing to consume a CURRENT Estimating-owned costing snapshot ([ADR-044](../adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md)). **CLOSED / OPERATIONAL FOR UAT.** Office UAT consume / STALE / re-apply **PASS**. `include_labour_snapshot_direct_cost=False` remains unchanged.
