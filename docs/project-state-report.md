...
| Current branch | `main` |
| Current commit / `origin/main` | Product SCH-D **`59d36b8f0b3a86eb41aee03890cb432d0fc58e52`** (`feat: implement FG-035 SCH-D field schedule`). Product SCH-C **`c57e23c55260b44fc88cadfe2fc40924aa58dde7`**. Product SCH-B **`374798d7338a4c00d90a9c7a2b2efa310bc7e355`**. Product SCH-A **`fd8a66990df8286e54151b80b6f3cd5be5dd3ad1`**. Repository Alembic head **`f9b0c1d2e3f4`**. Live current **`f9b0c1d2e3f4 (head)`**. Product TIME **`03c074fb1eb2bbca77ba86e495726c0e042c1979`**. Prior product SCOPE **`21bf0eba47acdb19eb292c2319d675a1748c1dff`**. |
...
| Documentation status | **2026-09-17 SCH-D committed / SHA-pin pending push.** SCH-D **IMPLEMENTED / TESTED / SERVER-SIDE LIVE UAT PASS / PHYSICAL IPHONE UAT PASS / COMMITTED / NOT PUSHED**. Product SHA **`59d36b8f0b3a86eb41aee03890cb432d0fc58e52`**. No migration. Manual **FRAMEWORK ACTIVE / SCH-D MANUAL IMPACT CURRENT**. Help / Voice / Manual **NOT IMPLEMENTED**. FG-035 remains **OPEN / PARTIAL**. Warning law **INFORMATIONAL ONLY / NON-BLOCKING**. Print **RECORDED / IMPLEMENTATION SEQUENCED LATER**. V1 **unchanged** (**60% / 4 of 11**). |
| Decisions made (this implementation) | 2026-09-17 Joel physical iPhone UAT **PASS** (G1–G6, Directions, native iOS return). Native return is accepted; no CalibraytAI return-navigation feature. Worker Today / Week / Month = My work + Crew work only. Company Today is secondary read-only. No iPhone Schedule editing. No migration. |
| Decisions pending | Print implementation. PERF authorization. Help/Voice/Manual implementation (after functional V1 + language audit). Live Postmark. Physical iPhone Account Recovery UAT. Slice D. FG-030. V1-04. |
| Uncommitted work | None at pin. SCH-D product SHA **`59d36b8f0b3a86eb41aee03890cb432d0fc58e52`**. Future-direction docs **`78ca4f7934495538e2c6c6c256547369577f6258`**. Darcy docs **`61a92d0ae1541e1fb70bed1867b0c0a12c6e0a0a`**. |
| Next approved milestone | **STOP.** Do **not** begin PERF. Do **not** rescore V1. Return to ChatGPT Architect. |
| Next candidate milestone | FG-035 PERF — **NOT AUTHORIZED FROM THIS RECORD**. |
...
| Approved next Cursor prompt location or summary | **STOP.** Return to ChatGPT Architect. PERF **NOT AUTHORIZED**. |
| Commit status | Product SCH-D **`59d36b8f0b3a86eb41aee03890cb432d0fc58e52`**. Product SCH-C **`c57e23c55260b44fc88cadfe2fc40924aa58dde7`**. Product SCH-B **`374798d7338a4c00d90a9c7a2b2efa310bc7e355`**. Product SCH-A **`fd8a66990df8286e54151b80b6f3cd5be5dd3ad1`**. Repository Alembic head **`f9b0c1d2e3f4`**. Live current **`f9b0c1d2e3f4 (head)`**. |
| Governance baseline | V1 register GOVERNING / 60% / 4 of 11 COMPLETE; FG-035 OPEN / PARTIAL; TAX/WBS IMPLEMENTED; SCOPE IMPLEMENTED; TIME IMPLEMENTED; SCH-A IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS; SCH-B IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS; SCH-C IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS; SCH-D IMPLEMENTED / TESTED / SERVER-SIDE LIVE UAT PASS / PHYSICAL IPHONE UAT PASS / COMMITTED / NOT PUSHED; ADR-053 Accepted; FG-034 CLOSED / OPERATIONAL FOR UAT; FG-033 CLOSED / OPERATIONAL FOR UAT; live current = repository head f9b0c1d2e3f4 |
