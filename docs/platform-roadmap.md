...
- Document package output 3 Slices A+B **live-migrated / bounded office UAT PASS** ([FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **OVERALL NOT CLOSED**). Output 4, live QuickBooks API, and contract/warranty generation remain **not started**. Outputs 1–2: [FG-012](feature-gates/FG-012-estimate-output-consistency.md) **CLOSED / OPERATIONAL FOR UAT**.
