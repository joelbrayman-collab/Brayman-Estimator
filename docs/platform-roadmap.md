...
**Next candidate milestone:** [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**. Permit Intelligence architecture **Accepted** (ADR-037/038/039) and **NOT IMPLEMENTED**. Recommended first future gate **Permit Foundation V1** is **NOT CREATED / NOT AUTHORIZED**. Do **not** implement Permit Intelligence. Live current=head `d6e7f8a9b0c1`. [ADR-033](adr/ADR-033-supplier-neutrality-and-launch-partner-channel.md) **Accepted**. [ADR-008](adr/ADR-008-supplier-price-snapshotting.md) **Proposed**. FG-010 Phase D is **NOT STARTED**. **Organization Brand Profile** and **Change Order document family** remain **FUTURE / NOT IMPLEMENTED**.
...
- Permit Intelligence — architecture **Accepted** (ADR-037/038/039); **NOT IMPLEMENTED**; no Feature Gate ([permit-and-approvals-report.md](architecture/permit-and-approvals-report.md)).
...
1. **STOP.** [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**. Permit Intelligence architecture **governed** (ADR-037/038/039 **Accepted**) and **not implemented**. Recommended first future gate **Permit Foundation V1** is **not created**. Do **not** implement Permit Intelligence, MONITOR, Phase D, supplier/Winchester POC, or bulk supplier onboarding. Do not accept ADR-008.
...
- **Permit Foundation V1** (recommended first Permit Feature Gate — **NOT CREATED / NOT AUTHORIZED**) then later **Ontario / Ottawa Permit Rules + Mike Pratt POC** — [permit-and-approvals-report.md](architecture/permit-and-approvals-report.md)
