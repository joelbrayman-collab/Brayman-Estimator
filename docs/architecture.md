...
| `company_attention_bp` | `app/routes/company_attention.py` — FG-035 PERF-C Company Attention office surface (**IMPLEMENTED IN WORKING TREE / TESTED / NOT COMMITTED / NOT PUSHED / NOT LIVE-UATed**) |
