...
| Documentation status | **2026-09-16 FG-035 SCH-B committed / SHA pinned.** FG-035 remains **OPEN / PARTIAL**. SCH-A **LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH-B **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH overall **OPEN / PARTIAL**. SCH-C / SCH-D / PERF / CLOSE / LEARN / QB-T **NOT AUTHORIZED**. V1 **unchanged** (**60% / 4 of 11**). Evidence [testing/fg035-sch-b-live-bounded-uat-record.md](testing/fg035-sch-b-live-bounded-uat-record.md). |
...
| Decisions pending | SCH-C authorization. PERF authorization. Help/Voice/Manual preflight. Live Postmark. Physical iPhone UAT. Slice D. FG-030. V1-04. |
| Uncommitted work | None after SCH-B implementation commit. |
| Next approved milestone | **STOP.** Return to ChatGPT Architect. Do **not** begin SCH-C / PERF / CLOSE / LEARN / QB-T. Do **not** rescore V1. |
