...
| Contractor-facing UX language | [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / IMPLEMENTATION PREFLIGHT COMPLETE / SLICE 1 IMPLEMENTED / SLICE 2 IMPLEMENTED / NOT CLOSED** — Project Hub contractor-facing display mapping authorized and implemented; remaining slices not authorized; not a product-wide sweep |
