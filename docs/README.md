...
| [architecture/fg-032-quickbooks-option-a-preflight.md](architecture/fg-032-quickbooks-option-a-preflight.md) | FG-032 Option A schema, workflow, field matrix | **RECONCILED.** [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**. Gate-at-close live current **`f1a2b3c4d5e6 (head)`**. Live current today **`d9e0f1a2b3c4 (head)`**. |
...
| [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md) | Future Project Element / Time / LEARN authority | **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT A PREFLIGHT.** One CalibraytAI platform; organization configuration, not tenant-specific code. Time Entry is mobile-first / iPhone-primary. |
...
| [feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md](feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md) | Native Signing — Document Approval, Customer Signature, Countersignature, Executed Artifact, and Audit | **OPEN / PARTIAL**. SIGN-A **IMPLEMENTED**. SIGN-B **IMPLEMENTED**. SIGN-C **IMPLEMENTED**. SIGN-D **IMPLEMENTED** (automated). SIGN-E **NOT STARTED**. Real iPhone UAT **DEFERRED**. |
...
| [testing/fg033-sign-d-live-bounded-uat-record.md](testing/fg033-sign-d-live-bounded-uat-record.md) | FG-033 SIGN-D automated Change Order E2E + mobile UX | **SIGN-D PASS** (2026-09-15) automated only. Real iPhone UAT **DEFERRED**. Live current **`d9e0f1a2b3c4 (head)`**. PRODUCTION packages **0**. Gate overall **OPEN / PARTIAL**. |
| [modules/signing.md](modules/signing.md) | Signing Service overlay ownership | **Partial Current.** SIGN-A **IMPLEMENTED**. |
