...
| Current branch | `main` |
| Current commit / `origin/main` | Verify `git rev-parse HEAD` and `git rev-parse origin/main` after this FG-021 HEIC NOT-EXERCISED docs commit. |
...
| Product status | Operational on `main`: FG-021 Field Web V1 **OPEN**. Text / screenshot PNG / Take Photo JPEG / voice Save / network retain-retry / browser-close IndexedDB recovery / desktop continuity **PASS**. HEIC real-device remains **OPEN** (2026-09-05 library Choose Photo **NOT EXERCISED** — Safari delivered JPEG Event **33**). Mixed capture and Observation Delete remain **OPEN**. Four-output outputs 3–4 / QuickBooks API / Ontario contract **not implemented**. |
...
| Documentation status | [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE-MIGRATED / IPHONE UAT OPEN**. Browser-close IndexedDB recovery **PASS** (Event **32** / Original **30**). Approved presentation source custody **CLOSED**. Native Signing recon **COMPLETE**; counsel spec **PREPARED** — **NOT LEGAL APPROVAL**. Development may proceed under separate governance; production activation blocked pending counsel. Legal Content Gate **empty**. ADR-008 / ADR-010 **Proposed**. |
| Decisions made (this governance pass) | FG-021 library Choose Photo HEIC UAT **NOT EXERCISED**. Event **33** / Original **31** actual bytes JPEG JFIF. Save and Field/desktop JPEG display succeeded. HEIC Original + Compatible Rendition path not exercised. Gate **NOT CLOSED**. No product/test/schema/migration/ADR/FG-022 change. |
| Decisions pending | Remaining FG-021 real-iPhone UAT (HEIC first). Observation Delete remains **QUEUED / NOT AUTHORIZED**. Ontario counsel answers to [legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md). Archive package format. Project Closeout Feature Gate not created. |
| Uncommitted work | None after this FG-021 HEIC NOT-EXERCISED docs commit. |
| Next approved milestone | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC remains OPEN / NOT EXERCISED. Native Signing **production** remains blocked pending counsel. Do **not** implement Closeout or Observation Delete. |
| Next candidate milestone | Remaining FG-021 real-iPhone UAT (HEIC real-device capture/display). Native Signing — **development may proceed under separate governance**; production blocked pending counsel. Project Closeout — **FUTURE / NOT AUTHORIZED**. Item 13 MONITOR — **FUTURE / NOT AUTHORIZED**. |
...
| Approved next Cursor prompt location or summary | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC remains OPEN / NOT EXERCISED. Do **not** implement Closeout or Observation Delete. |
| Commit status | Verify `git rev-parse HEAD` after this FG-021 HEIC NOT-EXERCISED docs commit. Live current = head `d2e3f4a5b6c7`. FG-021 **OPEN**. FG-022 **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. Approved presentation source custody **CLOSED**. |
| Governance baseline | FG-021 IMPLEMENTED / LIVE-MIGRATED / IPHONE UAT OPEN; browser-close IndexedDB recovery PASS (Event 32 / Original 30); HEIC / mixed / Observation Delete remain OPEN; FG-022 CLOSED / APPROVED REUSABLE MASTER FAMILY V1; Family 05 COMMERCIAL_DRAFT / NOT LEGALLY APPROVED; Legal Content Gate empty; live current = head d2e3f4a5b6c7; full suite 557; dedicated FG-021 19; focused 147; presentation source custody CLOSED; Native Signing development may proceed separately / production blocked pending counsel; ADR-043 Accepted; Closeout FUTURE |
