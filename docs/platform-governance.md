...
| Field Web / Today + Capture | [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) **IMPLEMENTED / LIVE MIGRATION PENDING**; [architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md); revision `d2e3f4a5b6c7` created; live current `c1d2e3f4a5b6`; gate **NOT CLOSED** |
