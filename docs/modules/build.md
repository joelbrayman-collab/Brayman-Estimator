...
**Not implemented:** Project Closeout / archive-and-purge; Observation Delete; remaining FG-021 durability/UX UAT (session-expiry **deferred**, older iPhone/Safari smoke, orientation/readability); transcription; audio conversion; MONITOR; auto-Change Order. Field Web `/field` Today + Capture **is implemented** ([FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) **OPEN**). HEIC real-device Files/Browse UAT is **PASS** (Event **34** / Original **32**). Mixed capture UAT is **PASS** (Event **35**). Background/foreground persistence UAT is **PASS** (Event **36** / Original **36**). CSRF recovery UAT is **PASS** (Event **39** / Original **39**).
