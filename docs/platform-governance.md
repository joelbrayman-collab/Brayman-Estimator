...
| PLAN → PRICE Phase D takeoff-to-estimate mapping | [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT RUN / NOT CLOSED** — PLAN proposes / Estimating commits; package approval does **not** insert; additive `f4a5b6c7d8e9` in Git only |
| CalibAi V1 completion | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — readiness **34%**; **0 / 11** major packages COMPLETE; V1-01 PARTIAL factor 0.55; BMR DEMO READY **NO**; BRAYMAN REAL-LIFE UAT READY **NO**; does **not** authorize live migrate, UAT, FG-024, or another FG-025 slice |
