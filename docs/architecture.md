...
- Flask-Login is used for office authentication ([FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**; [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**; [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**). [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**: MAIL-A / AUTH-A / AUTH-B / AUTH-C **IMPLEMENTED** (local/fake mail; `credentials_epoch`; hash-at-rest reset tokens; responsive Forgot Password / Reset UX; complete local E2E). MAIL-B, AUTH-D **NOT STARTED**. Live Postmark HTTP **not** implemented. Shared API Foundation V1 is **operational for UAT** ([FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **CLOSED / OPERATIONAL FOR UAT**) with a **narrow** FG-020 BUILD POST allow-list. RBAC and multi-org switching are **not implemented**.
...
- Native Signing — [FG-033](feature-gates/FG-033-native-signing-document-approval-signature-and-executed-artifact.md) **CLOSED / OPERATIONAL FOR UAT**. SIGN-A through SIGN-E **IMPLEMENTED**. Real iPhone UAT **DEFERRED TO BRAYMAN / BEN REAL-WORLD UAT** — **NOT CLAIMED AS PASS**. Overlay only (`app/services/signing.py`, `app/routes/sign.py`, `app/routes/signing.py`). Recon [architecture/contract-esignature-and-signed-change-order.md](architecture/contract-esignature-and-signed-change-order.md). Recommendation **NATIVE V1**. Historical counsel spec **PREPARED** ([legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md)) — **NOT LEGAL APPROVAL / NOT EXTERNALLY REVIEWED**. **No external-review dependency.** Production / real-customer Native Signing **NOT COMPLETE** (MAIL-B Native Signing mail **NOT AUTHORIZED**). Signing remains a separate track from legal-content templates. Contract legal-content lifecycle is [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B CLOSED / OPERATIONAL FOR UAT / SLICE C CLOSED / OPERATIONAL FOR UAT / TECH-A IMPLEMENTED / TECH-B IMPLEMENTED / TECH-C IMPLEMENTED / TECH-D IMPLEMENTED / OVERALL OPEN / PARTIAL**.
- Account Recovery + transactional email — [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**. MAIL-A / AUTH-A / AUTH-B / AUTH-C **IMPLEMENTED**. MAIL-B, AUTH-D **NOT STARTED**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake capture only. No live Postmark HTTP. Physical iPhone Account Recovery UAT **DEFERRED**.
