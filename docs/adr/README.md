...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-034](ADR-034-canonical-material-identity-and-ownership.md) | CalibAi Canonical Material Identity and Ownership | **Accepted** (2026-08-30; architecture only; [FG-014](../feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **APPROVED FOR IMPLEMENTATION / IMPLEMENTATION NOT STARTED**) |
