...
| **NEXT AUTHORIZED ACTION** | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC real-device UAT is **PASS**. Do **not** implement Observation Delete from this pass. |
