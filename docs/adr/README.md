...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-040](ADR-040-organization-brand-profile.md) | Organization Brand Profile, Logo Custody, and Issued-Document Brand Snapshots | **Accepted** (2026-08-30; [FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) **IMPLEMENTED / LIVE MIGRATION PENDING**; live current remains `f8a9b0c1d2e3`) |
