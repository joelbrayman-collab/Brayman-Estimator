...
- `project_operating_state_events` (FG-035 CORE CLOSE Slice A; human CLOSE/REOPEN audit; table live / row count **0**; Option A Close/Reopen service exists in working tree and has **not** been live-executed)
