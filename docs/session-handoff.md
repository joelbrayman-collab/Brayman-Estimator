...
- Latest product-changing governed full suite: **558 passed**. Dedicated FG-021 **20**. Focused (Hub + FG-018 + FG-019 + both FG-020 + FG-021) **148**. Dedicated FG-020 **44** (33 field observation + 11 media compatibility). Dedicated FG-019 **34**. Dedicated FG-018 **37**. FG-020 **gate-at-close** full suite **538** remains historical.
...
- **MONITOR:** [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED** (ADR-021 **Accepted**; recon [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**; preflight [fg-023-monitor-v1-implementation-preflight.md](architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE**; not coded)
...
**[FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) APPROVED.** **IMPLEMENTATION NOT STARTED.** **IMPLEMENTATION NOT YET AUTHORIZED.** MONITOR V1 recon remains **COMPLETE**. [FG-021 CLOSED.] IMPLEMENTED / LIVE-MIGRATED / REAL-IPHONE UAT COMPLETE SUBJECT TO THE EXPLICIT SESSION-EXPIRY DEFERRED EXCEPTION. Roadmap item 10 is **COMPLETE**. Item 11 is **COMPLETE**. Item 12 Field Web is **CLOSED**. Live current = head `d2e3f4a5b6c7`.

## 8. LAST AUTHORIZED DELTA

**Last authorized delta:** **FG-023 MONITOR V1 implementation preflight** (docs + read-only inspect). Readiness **B. READY WITH EXPLICIT NON-BLOCKING NOTES**. Canonical artifact: [architecture/fg-023-monitor-v1-implementation-preflight.md](architecture/fg-023-monitor-v1-implementation-preflight.md). FG-023 remains **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. No product code. No tests. No migration. No ADR. Live current = head `d2e3f4a5b6c7`. Live **39** / **39**. Do **not** implement MONITOR from this preflight.
...
Expected: branch `main`; HEAD = `origin/main`; working tree clean; Alembic **current = heads `d2e3f4a5b6c7`** (one graph head); dedicated FG-021 **20**; focused (Hub + FG-018 + FG-019 + both FG-020 + FG-021) **148**; dedicated FG-020 **44**; FG-019 34; FG-018 37; FG-017 22; FG-016 37; FG-015 19; FG-014 35; FG-013 27; FG-012 19; take-off 18; Plan Intelligence 56; Pricing 33; Labour 25; Historical 11; latest product-changing full suite **558 passed**. Non-development `flask` CLI requires local-only `SECRET_KEY` (gitignored `.env`).
