...
Platform-shared (not org-owned): `jurisdiction_definitions`, `jurisdiction_aliases`, `permit_rules`, `legal_content_jurisdiction_packages`, `legal_content_objects` (FG-024 Slice A; live / empty), `legal_content_sources`, `legal_content_source_snapshots`, `legal_content_candidate_changes`, `legal_content_candidate_impacts`, `legal_content_review_events` (FG-024 Slice B; in repository / not live-migrated).
