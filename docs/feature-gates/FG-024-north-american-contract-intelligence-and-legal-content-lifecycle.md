...
| Schema / Alembic | Live current **`a6b7c8d9e0f1 (head)`**. Repository head **`a6b7c8d9e0f1`**. One graph head. TECH-C **applied live**. TECH-D **no new migration**. |
