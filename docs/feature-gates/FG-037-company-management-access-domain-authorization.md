...
**Subsequent status (2026-09-18 FG-038 PA-A PIN):** [FG-038](FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL / PA-A IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NO OWNER ASSIGNED**. Product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**. This gate is **not reopened**. Domain B grants remain unchanged. Do **not** add People & Access product to this gate.
