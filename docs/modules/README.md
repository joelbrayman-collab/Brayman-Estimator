...
| Projects | [projects.md](projects.md) | Projects entity; change orders under Project Controls package; `/projects/<id>` Project Hub ([FG-011](../feature-gates/FG-011-project-hub-ux.md) **CLOSED / OPERATIONAL FOR UAT**). Permit Intelligence architecture **Accepted** / **NOT IMPLEMENTED**. Change Order document family pin **FUTURE / NOT IMPLEMENTED**. |
