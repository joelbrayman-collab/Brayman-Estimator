...
- Contractor-facing Hub / office / Field copy — [FG-025](../feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1 IMPLEMENTED / NOT CLOSED** (Hub `#hub-monitor` display mapping only; remaining slices not authorized)
