...
**Subsequent status (2026-08-29 — not authorized by CAR-001):** [FG-010](../feature-gates/FG-010-ai-takeoff-quantity-extraction-foundation.md) / M012 is **APPROVED FOR IMPLEMENTATION** / **NOT IMPLEMENTED**. Real external AI provider **not authorized**. PLAN remains partial; PRICE remains FG-008/FG-009 operational for UAT.
