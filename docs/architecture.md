...
- Flask-Login is used for office authentication ([FG-018](feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **CLOSED / OPERATIONAL FOR UAT**; [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**; [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**). [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**: MAIL-A / AUTH-A **IMPLEMENTED** (local/fake mail; `credentials_epoch`; hash-at-rest reset tokens). AUTH-B/C, MAIL-B, AUTH-D **NOT AUTHORIZED**. Forgot Password pages **not** implemented. Live Postmark HTTP **not** implemented. Shared API Foundation V1 is **operational for UAT** ([FG-019](feature-gates/FG-019-shared-api-foundation-v1.md) **CLOSED / OPERATIONAL FOR UAT**) with a **narrow** FG-020 BUILD POST allow-list. RBAC and multi-org switching are **not implemented**.
...
- Account Recovery + transactional email — [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**. MAIL-A / AUTH-A **IMPLEMENTED**. AUTH-B/C, MAIL-B, AUTH-D **NOT AUTHORIZED**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake capture only. No live Postmark HTTP. No Forgot Password pages.
