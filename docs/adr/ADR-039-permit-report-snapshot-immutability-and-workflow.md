...
| Status | **Accepted** (FG-015 versioned preliminary snapshot **CLOSED / OPERATIONAL FOR UAT**; [FG-016](../feature-gates/FG-016-ontario-ottawa-permit-intelligence-poc.md) substantive Permit Report **CLOSED / OPERATIONAL FOR UAT**) |
| Date | 2026-08-30 |
...
| Cursor implementation note | FG-015 versioned preliminary snapshot **CLOSED / OPERATIONAL FOR UAT**; FG-016 substantive report **IMPLEMENTED / LIVE MIGRATION PENDING** (`permit_analyses` immutable versions) | 2026-08-30 |
| Cursor live-migrate/UAT note | FG-016 **CLOSED / OPERATIONAL FOR UAT**; live current=head `f8a9b0c1d2e3`; Pratt HTML/PDF same snapshot (project 9) | 2026-08-30 |
