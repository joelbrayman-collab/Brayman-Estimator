...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-040](ADR-040-organization-brand-profile.md) | Organization Brand Profile, Logo Custody, and Issued-Document Brand Snapshots | **Accepted** (2026-08-30; [FG-017](../feature-gates/FG-017-organization-brand-profile-v1.md) **CLOSED / OPERATIONAL FOR UAT**; live current=head `a9b0c1d2e3f4`) |

### Authentication / actor identity (roadmap item 10 — governance only)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-041](ADR-041-user-membership-and-office-authentication.md) | Durable User, Organization Membership, Office Authentication, Session, and Historical Actor Provenance | **Proposed / FOR JOEL REVIEW** (2026-08-30; [FG-018](../feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **DRAFT / NOT APPROVED**; shared API **deferred**; implementation **NOT STARTED**) |
