...
| [architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md) | Field Web / Today + Capture (roadmap Item 12) | **ARCHITECTURE RECONNAISSANCE COMPLETE / NOT IMPLEMENTED** — implementation **NOT AUTHORIZED**; no Feature Gate |
