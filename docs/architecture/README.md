...
| [approved-document-presentation-reference-baseline.md](approved-document-presentation-reference-baseline.md) | **Governing for presentation reference** — SOURCE CUSTODY **CLOSED**; [FG-022](../feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING** |
