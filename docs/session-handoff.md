...
| Attribute | Value |
|-----------|--------|
| Status | **FG-027 IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT AUTHORIZED.** [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. CalibAi V1 readiness **39%**. **1 / 11** COMPLETE (V1-01). BMR DEMO READY **NO**. BRAYMAN REAL-LIFE UAT READY **NO**. [FG-026 CLOSED / OPERATIONAL FOR UAT.] [FG-025 SLICE 5 IMPLEMENTED / NOT CLOSED.] Remaining FG-025 surfaces **NOT AUTHORIZED**. [FG-023 CLOSED / OPERATIONAL FOR UAT.] [FG-021 CLOSED.] Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. Live current **`f4a5b6c7d8e9`**. Repository graph head **`a5b6c7d8e9f0`**. |
| Updated | 2026-09-08 |
...
- Alembic graph head (repository): **`a5b6c7d8e9f0`**. Live `flask db current`: **`f4a5b6c7d8e9`**. Live current **does not equal** repository head. One graph head. FG-027 migration **file created, not applied live**. FG-026 migration **applied live**.
- Latest product-changing governed full suite: **647 passed** (FG-027 implementation). Dedicated FG-027 **15**. Estimating focused **29**. Pricing focused **52**. Labour/material **60**. FG-026 **20**. Governed bundle **176**. Historical full **632** remains the pre-FG-027 baseline.
...
- **PRICE:** partial — builder + commercial gate; Labour Engine Phase B **CLOSED / OPERATIONAL FOR UAT**; Pricing Engine **CLOSED / OPERATIONAL FOR UAT**; FG-012 internal breakdown + Proposal consistency **CLOSED / OPERATIONAL FOR UAT**; V1-02 / [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) costing approval **IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT AUTHORIZED**
...
**[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT AUTHORIZED.** [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. V1-02 product in repository. Live migrate **not** run. Live current **`f4a5b6c7d8e9`**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-021 CLOSED.]

## 8. LAST AUTHORIZED DELTA

**Last authorized delta:** **2026-09-08 V1-02 / FG-027 product implementation**. Status **IMPLEMENTED / TESTED / COMMITTED / PUSHED / NOT LIVE-MIGRATED / UAT NOT AUTHORIZED**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Migration file `a5b6c7d8e9f0`. Full suite **647 passed**. V1 readiness remains **39%**.
...
- FG-027: **NOT IMPLEMENTED.** Architecture recorded only ([ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md); [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md); [architecture/fg-027-costing-approval-preflight.md](architecture/fg-027-costing-approval-preflight.md)).
...
- Repository graph head `f4a5b6c7d8e9`. Live current `f4a5b6c7d8e9`. Live current **equals** repository head. One graph head. Applied `e3f4a5b6c7d8` → `f4a5b6c7d8e9` (2026-09-08 FG-026). Live `takeoff_estimate_insertions` / `takeoff_estimate_insertion_citations` exist. Live `project_direct_cost_actuals` exists. Five UAT rows on project **id 13** only.
- Latest product-changing: dedicated FG-026 **20**; full suite **632 passed** (SHA `aa4c71800586e0b8e2a63931bcdc8bc44d87a489`). Historical Slice 5 dedicated FG-025 **19**; Field-focused **83**; prompt governed list **190**; full suite **612 passed** remain the pre-FG-026 baseline. Dedicated FG-023 **35**; focused **149**; historical Slice A close focused **126**; pre-Slice-B focused **137**; full suite **593 passed** remain historical close-time FG-023 evidence.
...
- **FG-027:** **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. V1-02. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Approve All = costing approval only. No product code. No migration. Does **not** accept ADR-008.

## 15. CHAT → REPOSITORY DELTA LEDGER RESULT

**2026-09-08 V1-02 / FG-027 ADR + Feature Gate + preflight.** [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Docs only. No product code. No migration. Completeness for this recording: ADR + Feature Gate + preflight + current-authority pins **IN THIS COMMIT**. V1 readiness remains **39%**.
...
- Phase D reviewed quantity → estimate mapping — [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. V1-02 / [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**.
...
- **[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md)** is **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Do **not** implement from this recording. Do **not** accept ADR-008.
