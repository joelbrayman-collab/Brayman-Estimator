...
| Instance Owner / People & Access PA-A | [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) **OPEN / PARTIAL / PA-A IMPLEMENTED IN WORKING TREE / TESTED / MIGRATION FILE CREATED / NOT LIVE-MIGRATED / NOT COMMITTED / NO OWNER ASSIGNED**. Additive **`c3d4e5f6a7b8`**. All organizations remain ownerless. Sys Admin **DEFERRED TO PA-B**. People & Access UI **NOT IMPLEMENTED**. Does **not** rescore V1. |
