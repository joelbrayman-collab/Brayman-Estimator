...
### Authentication / actor identity (roadmap item 10 — office auth approved; not implemented)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-041](ADR-041-user-membership-and-office-authentication.md) | Durable User, Organization Membership, Office Authentication, Session, and Historical Actor Provenance | **Accepted** (2026-08-30; [FG-018](../feature-gates/FG-018-organization-authentication-actor-identity-and-membership-v1.md) **APPROVED / IMPLEMENTATION NOT STARTED**; shared API **deferred**) |
