...
| [architecture/approved-document-presentation-reference-baseline.md](architecture/approved-document-presentation-reference-baseline.md) | Recovered Allen Jacques garage package as approved **presentation / design** baseline | **Governing for presentation reference** — **SOURCE CUSTODY CLOSED** (2026-09-04); [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING**; not Legal Content Gate approval; binaries outside Git |
...
| [feature-gates/FG-022-reusable-approved-document-template-family-v1.md](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) | Reusable Approved Document Template Family V1 — Project-Neutral Extraction | **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING** |
