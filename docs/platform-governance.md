...
| Field Web / Today + Capture recon | [architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md) — **COMPLETE / NOT IMPLEMENTED**; implementation **NOT AUTHORIZED**; no Feature Gate; proposed future id **FG-021** not created |
