...
| [architecture/field-web-today-and-capture.md](architecture/field-web-today-and-capture.md) | Field Web / Today + Capture (roadmap Item 12) | **IMPLEMENTED / LIVE MIGRATION PENDING** — [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) gate **NOT CLOSED** |
...
| [feature-gates/FG-021-field-web-v1-today-and-capture.md](feature-gates/FG-021-field-web-v1-today-and-capture.md) | Field Web V1 — Today + Capture | **IMPLEMENTED / LIVE MIGRATION PENDING** |
