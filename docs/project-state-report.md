...
| Current branch | `main` |
| Current commit / `origin/main` | Verify `git rev-parse HEAD` and `git rev-parse origin/main` after this FG-021 genuine HEIC PASS docs commit. |
...
| Product status | Operational on `main`: FG-021 Field Web V1 **OPEN**. Text / screenshot PNG / Take Photo JPEG / voice Save / network retain-retry / browser-close IndexedDB recovery / HEIC Files/Browse real-device / desktop continuity **PASS**. Mixed capture and Observation Delete remain **OPEN**. Four-output outputs 3–4 / QuickBooks API / Ontario contract **not implemented**. |
...
| Decisions made (this governance pass) | FG-021 genuine HEIC Files/Browse real-device UAT **PASS**. Event **34** / Original **32**, Project **11**, `IMG_5351.HEIC`, actual ISO-BMFF HEIC preserved; JPEG Compatible Rendition derived; Field Today and desktop Hub display the rendition. Library Choose Photo Event **33** remains historical **NOT EXERCISED**. Gate **NOT CLOSED**. No product/test/schema/migration/ADR/FG-022 change. |
| Decisions pending | Remaining FG-021 real-iPhone UAT (mixed capture next). Observation Delete remains **QUEUED / NOT AUTHORIZED**. Ontario counsel answers to [legal/native-signing-process-counsel-review.md](legal/native-signing-process-counsel-review.md). Archive package format. Project Closeout Feature Gate not created. |
| Uncommitted work | None after this FG-021 genuine HEIC PASS docs commit. |
| Next approved milestone | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC real-device UAT is **PASS**. Native Signing **production** remains blocked pending counsel. Do **not** implement Closeout or Observation Delete. |
| Next candidate milestone | Remaining FG-021 real-iPhone UAT (mixed capture). Native Signing — **development may proceed under separate governance**; production blocked pending counsel. Project Closeout — **FUTURE / NOT AUTHORIZED**. Item 13 MONITOR — **FUTURE / NOT AUTHORIZED**. |
...
| Approved next Cursor prompt location or summary | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC real-device UAT is **PASS**. Do **not** implement Closeout or Observation Delete. |
| Commit status | Verify `git rev-parse HEAD` after this FG-021 genuine HEIC PASS docs commit. Live current = head `d2e3f4a5b6c7`. FG-021 **OPEN**. FG-022 **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. Approved presentation source custody **CLOSED**. |
| Governance baseline | FG-021 IMPLEMENTED / LIVE-MIGRATED / IPHONE UAT OPEN; HEIC REAL-DEVICE PASS (Event 34 / Original 32); browser-close IndexedDB recovery PASS (Event 32 / Original 30); mixed / Observation Delete remain OPEN; FG-022 CLOSED / APPROVED REUSABLE MASTER FAMILY V1; Family 05 COMMERCIAL_DRAFT / NOT LEGALLY APPROVED; Legal Content Gate empty; live current = head d2e3f4a5b6c7; full suite 557; dedicated FG-021 19; focused 147; presentation source custody CLOSED; Native Signing development may proceed separately / production blocked pending counsel; ADR-043 Accepted; Closeout FUTURE |
