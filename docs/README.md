...
| [feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) | North American Contract Intelligence & Legal Content Lifecycle | **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL**. One linked gate; Slices B–D product not authorized. [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**. Live library **empty**. |
...
| [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) | Construction contract + warranty template governance; Legal Content Gate (Ontario first; North American library future under FG-024) | **Governing** — templates remain empty; Slice A engine **in repository / not live-migrated**; [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **NOT CLOSED** |
