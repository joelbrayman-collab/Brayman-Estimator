...
| [ADR-021](ADR-021-monitor-commercial-baseline.md) | MONITOR Commercial Baseline and Project Gross Margin | **Accepted** (2026-08-30; Slice A projection **implemented**; Hub UI **not implemented**; V1 recon **COMPLETE**; [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / OPEN / NOT CLOSED**; Slice A **IMPLEMENTED / NOT LIVE-MIGRATED**) |
