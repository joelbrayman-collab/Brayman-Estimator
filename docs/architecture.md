...
| `schedule_bp` | `app/routes/schedule.py` — FG-035 SCH-A Company Schedule / form editor (**IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**) plus SCH-B assignment POST routes (**IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**) |
...
| Schedule | `WorkScheduleItem`, `WorkScheduleHistory`, `WorkScheduleAssignment` | `app/models/schedule.py` — FG-035 SCH-A **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**; SCH-B assignment **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS** |
...
- **Desktop Print / paper workflow** — [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md) **FUTURE / RECORDED / NOT IMPLEMENTATION-AUTHORIZED**. Print is a presentation of the same governed product authority. V1 requirement, not a scoring unit. Does **not** authorize Print product, SCH-C, or SCH-D.
- **Platform-wide warning law** — [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md) **INFORMATIONAL ONLY / NON-BLOCKING / PLATFORM-WIDE**. A warning never, by itself, blocks Save or controls functionality. Validation / integrity failures remain fail-closed. Does **not** authorize SCH-C product or PERF.
...
- Project work structure (TAX/WBS) + SCOPE + TIME + SCH-A + SCH-B — [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. [ADR-053](adr/ADR-053-project-work-structure-and-closed-operational-learning-loop.md) **Accepted**. TAX/WBS **IMPLEMENTED**. SCOPE **IMPLEMENTED**. TIME **IMPLEMENTED**. SCH-A **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH-B **IMPLEMENTED / TESTED / LIVE-MIGRATED / BOUNDED SYNTHETIC UAT PASS**. SCH overall **OPEN / PARTIAL**. SCH-C **PREFLIGHT PASS / NOT IMPLEMENTED**. SCH-D **NOT AUTHORIZED**. Design freeze [architecture/fg-035-sch-implementation-preflight.md](architecture/fg-035-sch-implementation-preflight.md). Later slices **NOT AUTHORIZED**.
- Interactive Help / Voice / professional User Manual — [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **FUTURE / RECORDED / COMPLETE FOR PRODUCT-DIRECTION RECORDING / MANDATORY PRE-UAT V1 / NOT IMPLEMENTATION-AUTHORIZED**. Does **not** interrupt FG-035.
