...
**Not implemented (out of V1):** MONITOR snapshot table; forecast-final GM; NET PROFIT; Field Event conversion; QuickBooks; Field Web MONITOR. LEARN remains Future on the Hub. Preflight: [fg-023-monitor-v1-implementation-preflight.md](../architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE**. Feature Gate: [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. PKG-S16 adds `change_orders.approved_internal_direct_cost` persistence. **PKG-F07 (working tree)** Extra Work Approve capture + MONITOR consume: complete-set Extra internal cost added to `current_authorized_estimated_cost`; otherwise original DC + **Not captured**. Sell/revenue identities preserved. No new cost-variance card.

**Future recorded (not authorized):** Project Element / Time / LEARN authority — one CalibraytAI platform, organization configuration data, PROJECT → PROJECT ELEMENT → ACTIVITY → HOURS. Time Entry is **mobile-first / iPhone-primary**. MONITOR must later separate original / Change Order / current authorized performance. One governed alert/performance engine. Closeout is the LEARN data-quality gate. Record: [project-element-authority-future-record.md](../architecture/project-element-authority-future-record.md). PERF-A labour-hours Hub panel is **IMPLEMENTED / TESTED / BOUNDED SYNTHETIC LIVE UAT PASS** ([fg-035-perf-a-implementation-preflight.md](../architecture/fg-035-perf-a-implementation-preflight.md)). PERF-B Needs Attention is **IMPLEMENTED / TESTED / BOUNDED SYNTHETIC LIVE UAT PASS / COMMITTED / SHA-PINNED / PUSHED** ([fg-035-perf-b-implementation-preflight.md](../architecture/fg-035-perf-b-implementation-preflight.md)). PERF-C Company Attention is **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE UAT PASS / SEALED** ([fg-035-perf-c-product-definition.md](../architecture/fg-035-perf-c-product-definition.md)). Do **not** put labour-hours math inside `assemble_monitor_v1`.
...
- Feature Gate + approved Cursor prompt before remaining out-of-V1 work. [FG-023](../feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **CLOSED / OPERATIONAL FOR UAT**. Slice A and Slice B are **implemented / live-migrated**. Slice C migrate/UAT **PASS**.
