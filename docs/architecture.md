...
- **People & Access** — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** Subsequent [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) PA-A Instance Owner pointer + SET events + operator CLI **IMPLEMENTED IN WORKING TREE / NOT LIVE-MIGRATED / NO OWNER ASSIGNED**. People & Access UI, Sys Admin, and live Owner assignment remain **NOT IMPLEMENTED**. Does **not** reopen FG-037. Does **not** implement Sensitive Financial.
...
- People & Access — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** PA-A Instance Owner foundation is in the working tree. People & Access UI is **not** a Current Settings Members action. Does **not** reopen FG-037.
