...
| BUILD | [build.md](build.md) | **None** — Proposed (ADR-020 **Accepted** boundary; [ADR-042](../adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Proposed / FOR JOEL REVIEW**, not accepted). Not implemented. Item 10 is **COMPLETE**. Item 11 is **ELIGIBLE FOR SEPARATE GOVERNANCE / NOT AUTHORIZED**. FG-020 is **not created**. |
