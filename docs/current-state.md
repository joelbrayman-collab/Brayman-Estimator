...
|-------|--------|
| Branch | `main` |
| HEAD / `origin/main` | Brand Profile governance draft (this docs commit). Parent `e03f9f88ebf65ded120448a1aba8f16347b18056`. FG-016 close `fa591f14b2eb99db75c4e3720fdeb30d14a8f77a`. Implementation `a709829d32d94ab2baf36f142ad0095254ba3d3a`. FG-013–FG-016 **CLOSED / OPERATIONAL FOR UAT**. Alembic live current = head **`f8a9b0c1d2e3`**. |
...
- **Organization Brand Profile** ([architecture/organization-brand-profile.md](architecture/organization-brand-profile.md)) is **FUTURE / NOT IMPLEMENTED**. [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed / for Joel review**. [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT FOR JOEL REVIEW / NOT APPROVED**. Not logo storage. Not product authorization. Does not reorder the roadmap into an approved product milestone.
...
- **Approved, next:** **STOP.** [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) is **DRAFT FOR JOEL REVIEW / NOT APPROVED**. [ADR-040](adr/ADR-040-organization-brand-profile.md) is **Proposed**. Do **not** implement Organization Brand Profile. Do not begin national permit expansion, Phase D, Change Order documents, supplier integration, or external AI / runtime web.
...
- **Organization Brand Profile pin** (FUTURE / NOT IMPLEMENTED) — [architecture/organization-brand-profile.md](architecture/organization-brand-profile.md); [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED**
...
1. **STOP.** [ADR-040](adr/ADR-040-organization-brand-profile.md) is **Proposed**. [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) is **DRAFT / NOT APPROVED**. Do not implement Organization Brand Profile until Joel Accepts the ADR, Approves the gate, and issues a separate implementation prompt. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008.
