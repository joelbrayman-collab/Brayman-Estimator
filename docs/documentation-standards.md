...
This file governs **repository documentation**. Contractor-facing **product UI** language is [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **FUTURE / RECORDED / IMPLEMENTATION PREFLIGHT COMPLETE / SLICE 1 IMPLEMENTED / NOT CLOSED**. Visual brand remains [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md). Do not treat this file as a UI glossary.
