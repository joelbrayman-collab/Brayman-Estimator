...
| Test status | Product tests **NOT RERUN** (documentation-only close). HISTORICAL Slice C live-migrate/UAT session: dedicated FG-032 **37 passed**, 496 warnings, 16.61s. Affected regressions **256 passed**, 1147 warnings, 88.48s. Full **765 passed**, 2669 warnings, 299.75s. Bounded office UAT **97 cases PASS**. Historical occupancy-repair 37/256/765 remain historical. |
...
| Commit status | FG-032 close / V1-05 rescore is this commit (`docs: close FG-032 and rescore V1-05`). Parent **`07490698fe325a6bd433be47070bce429c9f8ad8`**. A+B product SHA **`70e571140e12377aa5bd009b598530576401113b`**. Live current `f1a2b3c4d5e6 (head)`. Repo head `f1a2b3c4d5e6`. |
