...
| **NEXT AUTHORIZED ACTION** | **STOP.** Do **not** close FG-021. Do **not** start mixed capture from this pass. HEIC remains **OPEN / NOT EXERCISED**. Do **not** implement Observation Delete from this pass. |
