...
- Alembic **repository** graph head: **`f9b0c1d2e3f4`** (FG-035 SCH-C; applied live 2026-09-16). Live development/UAT `flask db current`: **`f9b0c1d2e3f4 (head)`**. SCH-B **`f7f8a9b0c1d2`** is superseded as live current. SCH-A **`f6e7f8a9b0c1`** is superseded as live current. FG-035 TIME **`f5d6e7f8a9b0` applied live** 2026-09-15 (superseded as live current). FG-035 SCOPE **`f4c5d6e7f8a9` applied live** 2026-09-15 (superseded as live current). FG-034 MAIL-A/AUTH-A **`f2a3b4c5d6e7` applied live** 2026-09-15 (superseded as live current). FG-033 SIGN-E **`e0f1a2b3c4d5` applied live** 2026-09-15 (superseded as live current). FG-033 SIGN-C **`d9e0f1a2b3c4` applied live** 2026-09-14 (superseded as live current). FG-033 SIGN-B **`c8d9e0f1a2b3` applied live** 2026-09-14 (superseded as live current). FG-033 SIGN-A **`b7c8d9e0f1a2` applied live** 2026-09-14 (superseded as live current). FG-024 TECH-C **`a6b7c8d9e0f1` applied live** 2026-09-14 (superseded as live current). FG-024 TECH-B **`f5a6b7c8d9e0` applied live** 2026-09-14 (superseded as live current). FG-024 TECH-A **`e4f5a6b7c8d9` applied live** 2026-09-14 (superseded as live current). FG-024 Slice C **`d3e4f5a6b7c8` applied live** 2026-09-13 (superseded as live current). FG-024 Slice B **`c2d3e4f5a6b7` applied live** 2026-09-13. FG-024 Slice A **`b1c2d3e4f5a6` applied live** 2026-09-13. FG-032 Slice C occupancy **`f1a2b3c4d5e6` applied live** 2026-09-11 (superseded as live current). Verify `flask db current` per environment before relying on it.
...
- **Project Hub UX (FG-011):** `/projects/<id>` (`app/routes/projects.py` `view_project`, `app/services/project_hub.py`, `app/templates/projects/detail.html`) reads stored facts and links into owning modules. No durable hub entity. CONTRACT `#hub-contract-legal` displays the existing FG-024 selector ALLOW/WARN/BLOCK result (`select_legal_content_package_for_project`); it does not generate contracts.
...
- Interactive Help / Voice / professional User Manual — [architecture/interactive-help-voice-and-user-manual-future-record.md](architecture/interactive-help-voice-and-user-manual-future-record.md) **FUTURE / RECORDED / COMPLETE FOR PRODUCT-DIRECTION RECORDING / MANDATORY PRE-UAT V1 / NOT IMPLEMENTATION-AUTHORIZED**. Does **not** interrupt FG-035.
...
- **People & Access** — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Future Settings → People & Access. Instance Owner; System Administrator; Person vs Platform User; Delete User = remove access, not history. Does **not** reopen FG-037. Does **not** implement PERF-C or Sensitive Financial.
- **CORE CLOSE / Project operating lifecycle** — [architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** Subsequent Slice A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED**. Subsequent Slice B **IMPLEMENTED IN WORKING TREE / TESTED / NO MIGRATION / NOT COMMITTED / NOT PUSHED**. Current-operating consumers switched. CLOSED guards on NEW operational work. Product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. Live Alembic **`b2c3d4e5f6a7 (head)`**. `Project.operating_state` **ACTIVE / CLOSED**. `list_current_operating_projects`. Close/Reopen **NOT IMPLEMENTED**. Punch List **NOT IMPLEMENTED**. Completion Sign-Off **NOT IMPLEMENTED**. Distinct from LEARN Closeout. Do **not** reuse `Project.status`. Do **not** add ARCHIVED as a third operating state. Does **not** implement Close, Punch List, Completion Sign-Off, Native Signing changes, Home Office, LEARN, or QB-T.
...
- People & Access — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Not a Current Settings Members action. Does **not** reopen FG-037.
