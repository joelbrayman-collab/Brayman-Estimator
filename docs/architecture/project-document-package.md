...
| Reusable approved presentation masters | **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING** — [FG-022](../feature-gates/FG-022-reusable-approved-document-template-family-v1.md). Owns project-neutral visual masters, classification, provenance, and approved presentation geometry/style. Does **not** own project/commercial values or Legal Content Gate approval. Gate **NOT CLOSED**. |
...
- [approved-document-presentation-reference-baseline.md](approved-document-presentation-reference-baseline.md) — recovered Allen Jacques package is the **approved presentation / design baseline** (source custody **CLOSED**; [FG-022](../feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **IMPLEMENTED / VERIFIED / JOEL APPROVAL PENDING**; document 04 is INTERNAL ENTRY REFERENCE; document 05 legal content remains COMMERCIAL_DRAFT)
