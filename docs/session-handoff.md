...
**Last authorized delta:** **2026-09-09 ADR-048 / FG-031 scope delivery routing architecture recording (docs only).** Architecture SHA **`1c6c8c492b92f11cc80ad1b6e8689f0e42523bcd`**. [ADR-048](adr/ADR-048-scope-delivery-make-buy-and-procurement-routing-ownership-boundary.md) **Accepted**. [FG-031](feature-gates/FG-031-scope-delivery-make-buy-procurement-routing-v1.md) **RECORDED / ARCHITECTURE PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. Two stored dimensions; 1:1 EstimateLineItem; no HYBRID enum. Supporting V1 gate; **not** a 12th package. V1 remains **55% / 3 of 11**. Product tests **not** rerun. No schema. No migration. Do **not** implement FG-031. Do **not** implement FG-030. Do **not** begin V1-04.
