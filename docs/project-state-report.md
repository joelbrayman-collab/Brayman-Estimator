...
| Database and migration status | Repository graph head `c1d2e3f4a5b6`. Live current `b0c1d2e3f4a5`. FG-020 upgrade **pending**. One graph head. |
| Test status | Dedicated FG-020 **33 passed**; focused **370 passed**; full suite **527 passed**. Dedicated FG-019 **34**; dedicated FG-018 **37**. Pre-FG-020 baseline **494**. Dedicated FG-017 **22**; FG-016 **37**; FG-015 **19**; FG-014 **35**; FG-013 **27**; historical **11**; labour **25**; pricing **33**; FG-012 **19**; take-off **18**; Plan Intelligence combined **56**. |
...
| Decisions made (this governance pass) | Joel authorized FG-020 implementation. Cursor implemented BUILD Field Observation foundation. HEIC/HEIF original custody preserved (custody ≠ rendering). Live `flask db upgrade` **not** run. FG-020 **not** closed. |
| Decisions pending | Separate live-migration / office UAT prompt (`b0c1d2e3f4a5` → `c1d2e3f4a5b6`). Whether to close FG-020 after UAT. Item 12 remains blocked. Multi-membership selection remains fail-closed. Native/token auth remains deferred. |
| Uncommitted work | None after this implementation commit. |
| Next approved milestone | Separate **live-migration / office UAT** prompt. Do **not** mark FG-020 closed yet. Do **not** start Field Web. |
| Next candidate milestone | Item 12 Field Web — **BLOCKED / NOT AUTHORIZED** until FG-020 close. |
...
| Approved next Cursor prompt location or summary | Separate live-migration / office UAT prompt in [session-handoff.md](session-handoff.md) §20. Do **not** live-migrate from this implementation prompt. |
| Commit status | FG-020 implementation: verify `git rev-parse HEAD`. Live current `b0c1d2e3f4a5`. Repository head `c1d2e3f4a5b6`. ADR-042 **Accepted**. FG-020 **IMPLEMENTED / LIVE MIGRATION PENDING**. Item 10 **COMPLETE**. |
| Governance baseline | FG-020 IMPLEMENTED / LIVE MIGRATION PENDING; FG-019 CLOSED / OPERATIONAL FOR UAT; FG-018 CLOSED / OPERATIONAL FOR UAT; item 10 COMPLETE; live current b0c1d2e3f4a5; repository head c1d2e3f4a5b6; full suite 527 passed; dedicated FG-020 33; focused 370; dedicated FG-019 34; dedicated FG-018 37; API UAT port 5012; office UAT port 5011; ADR-041 Accepted; ADR-042 Accepted; ADR-008 Proposed; Phase D not started; MONITOR not implemented; Item 12 BLOCKED; Change Order document family FUTURE only |
