...
- Alembic **repository** graph head: **`c3d4e5f6a7b8`** (FG-038 PA-A; **not applied live**). Live development/UAT `flask db current`: **`b2c3d4e5f6a7`** (CORE CLOSE Slice A; applied live 2026-09-18). FG-038 additive **`c3d4e5f6a7b8`** is the graph head and is **not** live current. Verify `flask db current` per environment before relying on it.
...
- People & Access — [architecture/people-and-access-product-direction.md](architecture/people-and-access-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** Subsequent [FG-038](feature-gates/FG-038-instance-owner-authority-foundation.md) PA-A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NO OWNER ASSIGNED**. Product SHA **`01e7463082b84b2fcd9d61ff7125a5012b7f8043`**. Subsequent [architecture/fg-038-pa-a-live-migration-owner-preflight.md](architecture/fg-038-pa-a-live-migration-owner-preflight.md) **PREFLIGHT COMPLETE / LIVE MIGRATION NOT AUTHORIZED / OWNER ASSIGNMENT NOT AUTHORIZED.** People & Access UI is **not** a Current Settings Members action. Does **not** reopen FG-037.
