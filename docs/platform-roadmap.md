...
| Ontario construction contract + warranty | **Future** (Legal Content Gate; no templates registered). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) family 05 is an **APPROVED REUSABLE PRESENTATION MASTER** / commercial-draft only and does **not** satisfy this gate. | [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) · [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) |
...
| **NEXT AUTHORIZED ACTION** | [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) is **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. Preflight [fg-023-monitor-v1-implementation-preflight.md](architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE** (readiness **B**). Next: SEPARATE IMPLEMENTATION AUTHORIZATION. Do **not** implement MONITOR from preflight. Do **not** create a migration from this preflight. Do **not** implement Observation Delete. Do **not** implement session revocation / idle timeout. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED** (NOT PASS / NOT FAIL / NOT N/A / NOT WAIVED). **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.** |
...
| **ROADMAP DIRECTION** | Item 11 is **COMPLETE**. Item 12 Field Web is **CLOSED** ([FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md); SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). Item 13 MONITOR V1 recon is **COMPLETE**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) reusable presentation masters (**CLOSED / APPROVED REUSABLE MASTER FAMILY V1**; **not** item 12). Project Closeout / archive-and-purge; Native Signing production; Phase D; supplier integration; Change Order document family; Permit branding / national expansion; QuickBooks; Ontario Contract / Warranty; MONITOR; LEARN; real external AI; other repository-recorded future work. Not reordered here. Not authorized by this increment. |
...
- **`main` / `origin/main`** — verify `git rev-parse HEAD` and `git rev-parse origin/main`. Live Alembic **current = head = `d2e3f4a5b6c7`**. One graph head. Last product-changing governed suite: dedicated FG-021 **20**, focused **148**, full **558**. Live Field Capture **39** Events / **39** Originals.
- **FG-008 through FG-021** **CLOSED** as applicable (FG-021 subject to SESSION-EXPIRY RECOVERY **DEFERRED / NOT YET EXERCISED**). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) **CLOSED / APPROVED REUSABLE MASTER FAMILY V1**. [ADR-041](adr/ADR-041-user-membership-and-office-authentication.md) **Accepted**. [ADR-040](adr/ADR-040-organization-brand-profile.md) **Accepted**. [ADR-042](adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted**. [ADR-043](adr/ADR-043-field-web-capture-reliability-local-pending-and-idempotent-replay.md) **Accepted**. Roadmap items 10–12 **COMPLETE / CLOSED**. Item 13 [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**; MONITOR **not implemented**.
- **ADR-021** **Accepted** (MONITOR **not implemented**). Recon: [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**.
...
13. MONITOR basic estimated-vs-actual — **RECON COMPLETE / FEATURE GATE APPROVED / NOT IMPLEMENTED / NOT AUTHORIZED FOR CODE** ([FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED**; [ADR-021](adr/ADR-021-monitor-commercial-baseline.md) **Accepted**; [monitor-v1-implementation-reconnaissance.md](architecture/monitor-v1-implementation-reconnaissance.md) **COMPLETE**)
...
1. **[FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) APPROVED / IMPLEMENTATION NOT STARTED / IMPLEMENTATION NOT YET AUTHORIZED.** Preflight [fg-023-monitor-v1-implementation-preflight.md](architecture/fg-023-monitor-v1-implementation-preflight.md) **COMPLETE**. Next: SEPARATE IMPLEMENTATION AUTHORIZATION. Do **not** implement MONITOR from this preflight. Do **not** create a migration from this preflight. Observation Delete **queued** — do **not** implement yet. Do **not** implement Project Closeout. Do not implement Phase D, supplier/Winchester POC, bulk supplier onboarding, national permit expansion, or Change Order documents. Do not accept ADR-008. Do not accept ADR-010. [FG-021](feature-gates/FG-021-field-web-v1-today-and-capture.md) remains **CLOSED**. **SESSION-EXPIRY RECOVERY: DEFERRED / NOT YET EXERCISED.** **OLDER SUPPORTED IPHONE / SAFARI WAIVED AS NOT PRACTICAL.**
2. **Roadmap direction:** Item 12 Field Web is **CLOSED**. Item 13 Feature Gate is **APPROVED**. Native Signing **development** may proceed under separate governance; **production activation** remains blocked pending counsel. Do **not** implement MONITOR until a separate implementation prompt exists.
