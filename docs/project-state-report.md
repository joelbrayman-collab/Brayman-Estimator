...
| Uncommitted work | **This SHA-pin governance record.** Recovery stash `stash@{0}` **`840dba8320b59ff9464410fec390d755a31a56aa`** remains as recovery evidence and was **not dropped**. Live occupancy unchanged. |
| Next approved milestone | Same authorized prompt continues to live migrate `e5f6a7b8c9d0` after a hard clean checkpoint. Do **not** send a live client invitation. Do **not** Close a live Project. Do **not** drop the recovery stash. |
| Next candidate milestone | **D — COMPLETION SIGN-OFF** (after live migrate / empty baseline). |
| Approved next Cursor prompt location or summary | Same authorized prompt continues to live migrate. C2 product SHA **`ec4ef9956025fd8e281c12c17d84493b121f8337`**. Live Alembic **`d4e5f6a7b8c9`**. Do **not** create live C2 data. Do **not** drop the recovery stash. |
