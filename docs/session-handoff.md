...
| Attribute | Value |
|-----------|--------|
| Status | **FG-024 Slice A PRODUCT IMPLEMENTED IN REPOSITORY / NOT LIVE-MIGRATED / NOT OFFICE-UAT / NOT CLOSED.** Empty legal-content library + ADR-037-backed selection + coded fail-closed. Alembic **`b1c2d3e4f5a6`**. Live current **`f1a2b3c4d5e6`**. [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**. **FG-032 CLOSED / OPERATIONAL FOR UAT.** [ADR-049](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted**. Joel selected V1-05 **Option A**. V1-05 **COMPLETE**. **FG-031 CLOSED / OPERATIONAL FOR UAT.** [ADR-048](adr/ADR-048-scope-delivery-make-buy-and-procurement-routing-ownership-boundary.md) **Accepted**. **FG-028 SLICES 1–3 COMPLETE / CLOSED / OPERATIONAL FOR UAT.** Runtime Field header V2 logo installed. **FG-029 CLOSED / OPERATIONAL FOR UAT.** **IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE-MIGRATED / BOUNDED BMR DEMO OFFICE UAT PASS.** [ADR-046](adr/ADR-046-supplier-neutral-material-requirement-and-supplier-mapping-boundary.md) **Accepted**. ADR-008 remains **Proposed**. **FG-030 RECORDED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED.** [ADR-047](adr/ADR-047-supplier-identity-authentication-and-access-isolation.md) **Accepted** (architecture only). Current product **CalibraytAI** (formerly CalibAi). [ADR-045](adr/ADR-045-calibraytai-product-identity-and-former-name-preservation.md) **Accepted**. **FG-027 CLOSED / OPERATIONAL FOR UAT.** CalibraytAI V1 readiness **60%**. **4 / 11** COMPLETE (V1-01, V1-02, V1-03, V1-05). BMR DEMO READY **NO**. BRAYMAN REAL-LIFE UAT READY **NO**. [FG-026 CLOSED / OPERATIONAL FOR UAT.] [FG-025 SLICE 5 IMPLEMENTED / NOT CLOSED.] Remaining FG-025 surfaces **NOT AUTHORIZED**. [FG-023 CLOSED / OPERATIONAL FOR UAT.] [FG-021 CLOSED.] Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. Live current **`f1a2b3c4d5e6`**. Repository Alembic head **`b1c2d3e4f5a6`**. Website (external): Version 15 published / live QA PASS. |
| Updated | 2026-09-13 |
...
- Alembic graph head (repository): **`b1c2d3e4f5a6`**. Live `flask db current`: **`f1a2b3c4d5e6`**. Live current **does not equal** repository head (FG-024 Slice A **not live-migrated**). FG-032 A+B **`e9f0a1b2c3d4` applied live** 2026-09-11. Slice C events **`f0a1b2c3d4e5`** and occupancy **`f1a2b3c4d5e6` applied live** 2026-09-11. FG-031 Slice A migration **applied live** 2026-09-09. Slice B **`d8e9f0a1b2c3` applied live** 2026-09-10. FG-029 migration **applied live** 2026-09-09. FG-027 migration **applied live**. FG-026 migration **applied live**.
- Latest governed full suite (this FG-024 Slice A product session): **782 passed**, 2704 warnings, **267.61s**. Dedicated FG-024 **17 passed**, 35 warnings, 2.29s. HISTORICAL ADR-050 acceptance full **765 passed** / 301.88s. HISTORICAL Slice C live-migrate/UAT session dedicated FG-032 **37 passed**, 496 warnings, 16.61s. Affected regressions **256 passed**, 1147 warnings, 88.48s. Historical occupancy-repair full **765** / 422.30s, dedicated **37** / 15.98s, and regressions **256** / 134.28s remain historical. Historical Slice C implementation dedicated **36 passed** (15.04s) / regressions **203 passed** / full **764 passed** remain historical. Historical A+B post-migrate dedicated **23 passed** (12.96s) / full **751 passed**. Implementation-time focused regression **209 passed** (89.55s) remains historical.
...
- **CONTRACT:** partial (proposals are the customer-facing estimate; FG-012 reconciles snapshot totals; output 4 Future). [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A PRODUCT IMPLEMENTED IN REPOSITORY / NOT LIVE-MIGRATED / NOT OFFICE-UAT / NOT CLOSED**. Empty library + coded fail-closed. [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**.
...
- **[FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md)** is **FUTURE / RECORDED / SLICE A PRODUCT IMPLEMENTED IN REPOSITORY / NOT LIVE-MIGRATED / NOT OFFICE-UAT / NOT CLOSED**. One linked gate. Slices B–D **not authorized**. Legal Content Gate remains **empty**. Do **not** populate jurisdictions. Do **not** live-migrate. FG-025 is **not** a split of this gate.
...
Do **not** reopen FG-032. Do **not** implement live QuickBooks API. Do **not** implement [FG-030](feature-gates/FG-030-supplier-identity-authentication-and-access-isolation.md). Do **not** re-migrate [FG-029](feature-gates/FG-029-bmr-supplier-workflow-v1.md) (already **LIVE-MIGRATED**). Do **not** begin V1-04 product work. Do **not** implement subcontract RFQ/package. Do not enable an external AI provider. Do not reopen FG-021. Do **not** live-migrate FG-024. Do **not** begin FG-024 Slice B/C/D. Do **not** implement remaining FG-025 surfaces or contract/warranty **template** work. Do **not** start another FG-025 slice. Do **not** implement Observation Delete. Do **not** accept ADR-008. Do **not** reopen FG-028 for redesign. Do **not** derive a Field favicon. Do **not** publish the marketing website from this repository. Do **not** perform HostPapa hosting migration from Cursor.

## 20. NEXT AUTHORIZED ACTION

**Next governed action:** **STOP.** FG-024 Slice A is **in the repository** and **not live-migrated**. Do **not** run live `flask db upgrade`. Do **not** begin Slice B, Slice C, or Slice D. EST-2026-0019 remains Draft / not issued at **$275/m³** (direct **$42,392.00** · sell **$49,872.94** · HST **$6,483.48** · total **$56,356.42**); do **not** Issue/Send/Accept that estimate from this product pass. [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. V1-05 is **COMPLETE**. Do **not** implement live QuickBooks API. Do **not** begin V1-04 product work. CalibraytAI V1 readiness **60%**. **4 / 11** COMPLETE. BMR DEMO READY **NO**. BRAYMAN REAL-LIFE UAT READY **NO**.

**Roadmap direction (not authorization):** Item 12 Field Web is **CLOSED**. Item 13 **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) is **SLICE 1, SLICE 2, SLICE 3, SLICE 4, AND SLICE 5 IMPLEMENTED / NOT CLOSED** (remaining surfaces not authorized). [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Item 15 / [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) is **FUTURE / RECORDED / SLICE A PRODUCT IN REPOSITORY / NOT LIVE-MIGRATED / NOT CLOSED**. Project Closeout remains **FUTURE**. Native Signing is a **parallel** track. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.**
...
Expected: branch `main`; HEAD = `origin/main` = this SHA-pin docs commit (close SHA **`20d23b0103ee729e1d9770feeddfa7f8754e8804`**; ancestor product SHA **`aa4c71800586e0b8e2a63931bcdc8bc44d87a489`**); working tree clean; Alembic **repository head = live current `f4a5b6c7d8e9`**; dedicated FG-026 **20**; full suite **632 passed** (implementation; not rerun this pass). Historical Slice 5 dedicated FG-025 **19**; Field-focused **83**; prompt governed **190**; full suite **612 passed**. Dedicated FG-023 **35**; focused **149**; historical Slice A close focused **126**; pre-Slice-B focused **137**; full suite **593 passed** remain historical. Dedicated FG-021 **20**; prior FG-021 focused bundle **148**; dedicated FG-020 **44**; FG-019 34; FG-018 37 remain historical. Live **39** Events / **39** Originals. Non-development `flask` CLI requires local-only `SECRET_KEY` (gitignored `.env`).
