...
| [field-web-today-and-capture.md](field-web-today-and-capture.md) | **IMPLEMENTED / LIVE MIGRATION PENDING** — Item 12 Field Web / Today + Capture; [FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) gate **NOT CLOSED** |
| [fg-021-field-web-v1-implementation-reconnaissance.md](fg-021-field-web-v1-implementation-reconnaissance.md) | **COMPLETE** — FG-021 file/API/schema freeze; revision `d2e3f4a5b6c7` created; live current remains `c1d2e3f4a5b6` |
