...
| Account Recovery + transactional email | [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) **OPEN / PARTIAL**. MAIL-A **IMPLEMENTED**. AUTH-A **IMPLEMENTED**. AUTH-B/C, MAIL-B, AUTH-D **NOT AUTHORIZED**. [ADR-052](adr/ADR-052-account-recovery-and-transactional-email.md) **Accepted**. Local/fake mail only. No live Postmark HTTP. Does **not** reopen FG-018, FG-021, or FG-033. Does **not** rescore V1. |
