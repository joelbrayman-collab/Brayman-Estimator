...
- Organization Brand Profile / org-owned logo upload / brand snapshot — [organization-brand-profile.md](architecture/organization-brand-profile.md) **FUTURE / NOT IMPLEMENTED**; [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED** (not product authorization)
