...
|-------|--------|
| Branch | `main` |
| HEAD / `origin/main` | Verify `git log -1` after this docs commit. Product: FG-014 **CLOSED / OPERATIONAL FOR UAT**. Alembic **current = head = `d6e7f8a9b0c1`**. Implementation `976cc4a4942ae346b9843a77126f89969bba2b6e`. |
...
- **Permit Intelligence** ([architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)) Pass 2 is **FUTURE / NOT IMPLEMENTED**. Architecture **Accepted** (ADR-037/038/039). [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **APPROVED FOR IMPLEMENTATION** / **NOT STARTED** (location / jurisdiction / preliminary profile only). No rules library. No live lookup / external AI.
...
- **Current coded work:** [FG-014](feature-gates/FG-014-material-catalogue-v1-dimensional-lumber-sheet-goods.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-013](feature-gates/FG-013-contractor-calibration-onboarding-historical-upload-ux.md) **CLOSED / OPERATIONAL FOR UAT**.
- **Approved, not started:** [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) Permit Foundation V1.
...
- **Permit Intelligence architecture** (ADR-037/038/039 **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **APPROVED FOR IMPLEMENTATION** / **NOT STARTED**; Mike Pratt Coach House as future Gate 2 UAT reference) — [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)
...
1. **STOP this governance pass.** [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) is **APPROVED FOR IMPLEMENTATION** / **NOT STARTED**. Do **not** implement in the same chat that only approved the gate. Later implementation prompt only. Do **not** run `flask db upgrade` again until a live-migrate prompt. Do not populate the Permit Rules Library. Do not implement MONITOR, Phase D, supplier integration, bulk supplier onboarding, Winchester POC, Organization Brand Profile, or the Change Order document family. Do not accept ADR-008.
