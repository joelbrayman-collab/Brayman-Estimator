...
| [architecture/organization-brand-profile.md](architecture/organization-brand-profile.md) | Organization Brand Profile, logo, brand snapshot | **Future / NOT IMPLEMENTED** — [ADR-040](adr/ADR-040-organization-brand-profile.md) **Proposed**; [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) **DRAFT / NOT APPROVED**; not product authorization |
...
| [feature-gates/FG-017-organization-brand-profile-v1.md](feature-gates/FG-017-organization-brand-profile-v1.md) | Organization Brand Profile V1 — Identity, Logo Custody, and Proposal Brand Snapshot | **DRAFT FOR JOEL REVIEW / NOT APPROVED** |
| [adr/ADR-040-organization-brand-profile.md](adr/ADR-040-organization-brand-profile.md) | Organization Brand Profile, logo custody, issued-document brand snapshots | **Proposed / for Joel review** — **not Accepted**; **not implemented** |
