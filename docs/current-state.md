...
|-------|--------|
| Branch | `main` |
| HEAD / `origin/main` | FG-017 live-migrate / office UAT close (this commit). Implementation parent `00ca492e28118d75757e9a9c82384978b5decd92`. FG-016 close `fa591f14b2eb99db75c4e3720fdeb30d14a8f77a`. Alembic live current = head **`a9b0c1d2e3f4`**. |
...
- **Approved, next:** **STOP.** Do not begin national permit expansion, Phase D, Change Order documents, supplier integration, or external AI / runtime web. Do not start the next Feature Gate.
- **Blocked / Not Started (product):** Phase D estimate mapping; four-output package outputs 3–4; QuickBooks; contracts; BUILD field capture; MONITOR implementation; LEARN; industry benchmarking; historical evidence repair; real external AI provider; office authentication; supplier/Winchester POC; bulk supplier onboarding; national Permit Rules expansion; Change Order document family.
...
1. **STOP.** [FG-017](feature-gates/FG-017-organization-brand-profile-v1.md) is **CLOSED / OPERATIONAL FOR UAT**. Do not start the next Feature Gate. Do not begin national permit expansion, Phase D, Change Order document work, supplier integration, or external AI / runtime web. Do not accept ADR-008.
