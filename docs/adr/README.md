...
### Product identity (Accepted; FG-028 Slices 1–2 implemented / not closed)

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-045](ADR-045-calibraytai-product-identity-and-former-name-preservation.md) | CalibraytAI Product Identity and Former-Name Preservation | **Accepted** (2026-09-09; [FG-028](../feature-gates/FG-028-calibai-to-calibraytai-product-identity-transition.md) Slices 1–2 implemented; Slice 3 asset received / Joel approved / FINAL / application installation pending; [product-identity.md](../governance/product-identity.md)) |
