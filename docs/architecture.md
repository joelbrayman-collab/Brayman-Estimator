...
- Alembic **repository** graph head: **`e5f6a7b8c9d0`** (FG-035 CORE CLOSE C2 Client Final Walkthrough; **not applied live**). Live development/UAT `flask db current`: **`d4e5f6a7b8c9`**. C1 Punch List remains live. Verify `flask db current` per environment before relying on it.
...
- **CORE CLOSE / Project operating lifecycle** — [architecture/core-close-project-lifecycle-product-direction.md](architecture/core-close-project-lifecycle-product-direction.md) **RECORDED MANDATORY PRODUCT DIRECTION.** Subsequent Slice A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED**. Subsequent Slice B **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NO MIGRATION**. Subsequent Close/Reopen Option A **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NO MIGRATION / NOT LIVE-UATed**. Close/Reopen product SHA **`172f0786aaa9e668f30be28c3cee30ac4fce5b1f`**. Subsequent C1 Contractor Punch List **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / LIVE-MIGRATED / EMPTY LIVE BASELINE VERIFIED**. Product SHA **`81b6d802ccf15c10b01a1f63337ef4d0d5a26d6c`**. Additive **`d4e5f6a7b8c9`**. Subsequent C2 Client Final Walkthrough **IMPLEMENTED / TESTED / COMMITTED / PUSHED / SHA-PINNED / NOT LIVE-MIGRATED / NOT LIVE-UATed**. Product SHA **`ec4ef9956025fd8e281c12c17d84493b121f8337`**. Additive **`e5f6a7b8c9d0`**. Current-operating consumers switched. CLOSED guards on NEW operational work. Slice B product SHA **`9360b706ab66f2588306b201ca0c4c45645fcb9a`**. Slice A product SHA **`f4b7515664c51850f3d87ed79f4a7e1226886fbd`**. Live Alembic **`d4e5f6a7b8c9`**. Repository graph head **`e5f6a7b8c9d0`**. `Project.operating_state` **ACTIVE / CLOSED**. `list_current_operating_projects`. Close and Reopen **NOT LIVE-EXECUTED**. Completion Sign-Off **NOT IMPLEMENTED**. Distinct from LEARN Closeout. Do **not** reuse `Project.status`. Do **not** add ARCHIVED as a third operating state. Does **not** implement Completion Sign-Off, Native Signing changes, Home Office, LEARN, or QB-T.
