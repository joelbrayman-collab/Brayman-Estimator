...
| Weight | **10%** |
| Status | **PARTIAL**. Subsequent **2026-09-15:** [FG-034](feature-gates/FG-034-account-recovery-and-transactional-email.md) MAIL-A / AUTH-A / AUTH-B / AUTH-C / MAIL-B **IMPLEMENTED**. AUTH-D **NOT STARTED**. **Do not rescore** (factor remains **0.35**). |
| Factor | 0.35 |
| Contribution | **3.5** |
