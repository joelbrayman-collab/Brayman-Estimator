...
| Attribute | Value |
|-----------|--------|
| Status | **FG-027 IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE-MIGRATED / OFFICE UAT STOPPED / NOT PASS / NOT CLOSED.** Legacy override-provenance defect **REPAIRED / TESTED / COMMITTED / PUSHED / AWAITING UAT CONTINUATION** (`72949f99da2b56ec06e95e16e29fa194a6730bbd`). [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. CalibAi V1 readiness **39%**. **1 / 11** COMPLETE (V1-01). BMR DEMO READY **NO**. BRAYMAN REAL-LIFE UAT READY **NO**. [FG-026 CLOSED / OPERATIONAL FOR UAT.] [FG-025 SLICE 5 IMPLEMENTED / NOT CLOSED.] Remaining FG-025 surfaces **NOT AUTHORIZED**. [FG-023 CLOSED / OPERATIONAL FOR UAT.] [FG-021 CLOSED.] Observation Delete **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED / NON-BLOCKING**. Live current = heads **`a5b6c7d8e9f0`**. |
| Updated | 2026-09-08 |
...
- FG-027 repair docs SHA **`020bb55cfb87222ed6dfb1b6fd6770f3b0e3b6be`**. FG-027 legacy override-provenance repair SHA **`72949f99da2b56ec06e95e16e29fa194a6730bbd`** (`fix: preserve FG-027 legacy override provenance`). FG-027 live-migrate / UAT-stop SHA **`3bf832b2fea5e1ade8c3e412dc7635a4a15c42b1`**. Pin **`db43d54e57a884de491cffa3bcda9119efde0c7a`**. FG-027 product SHA **`c751d72b32f1ed415375719df2fd69936ace64d7`** (`feat: implement FG-027 costing approval`). Start pin **`28fb5c0445fafabb2924d5d43bce46bf5fca3d0e`**. FG-026 product SHA **`aa4c71800586e0b8e2a63931bcdc8bc44d87a489`** (`feat: implement FG-026 takeoff-to-estimate mapping`). Parent **`73253c46b5fcb54a96345107ac49fe1162063369`** (`docs: establish CalibAi V1 completion register`). Slice 5 product SHA **`5b497905086554214e85f69afd8101d88f89161c`** (`feat: continue FG-025 contractor-facing Field Web language`). Parent **`0ed4d67282551d75b4204e33d367f3f3baba023a`** (`docs: reconcile FG-025 Slice 4 close record`). Slice 4 product SHA remains **`56e16f03446f982d577d2a3f0d3375ef865e1dc9`**. Slice 3 product SHA remains **`071f5f923515c6405298bf96b0af249a20f81358`**.
- Alembic graph head (repository): **`a5b6c7d8e9f0`**. Live `flask db current`: **`a5b6c7d8e9f0`**. Live current **equals** repository head. One graph head. FG-027 migration **applied live**. FG-026 migration **applied live**.
- Latest product-changing governed full suite: **652 passed** (FG-027 legacy override-provenance repair). Dedicated FG-027 **20**. Estimating focused **29**. Pricing focused **52**. FG-026 **20**. Governed A–D bundle **121**. Historical dedicated **15** / full **647** remain the FG-027 implementation baseline. Historical full **632** remains the pre-FG-027 baseline.
...
- **PRICE:** partial — builder + commercial gate; Labour Engine Phase B **CLOSED / OPERATIONAL FOR UAT**; Pricing Engine **CLOSED / OPERATIONAL FOR UAT**; FG-012 internal breakdown + Proposal consistency **CLOSED / OPERATIONAL FOR UAT**; V1-02 / [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) costing approval **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT CLOSED**
...
**[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE-MIGRATED / OFFICE UAT STOPPED / NOT PASS / NOT CLOSED.** Legacy override-provenance defect **REPAIRED / AWAITING UAT CONTINUATION**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Live current = heads **`a5b6c7d8e9f0`**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) remains **CLOSED / OPERATIONAL FOR UAT.** [FG-021 CLOSED.]

## 8. LAST AUTHORIZED DELTA

**Last authorized delta:** **2026-09-08 V1-02 / FG-027 bounded legacy override-provenance repair**. Product SHA **`72949f99da2b56ec06e95e16e29fa194a6730bbd`**. No new migration. No live DB write. Dedicated **20** / full **652**. Gate remains **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT PASS / NOT CLOSED**. V1 readiness remains **39%**.
...
- **FG-027:** **IMPLEMENTED / TESTED / COMMITTED / PUSHED / LIVE-MIGRATED / OFFICE UAT STOPPED / NOT PASS / NOT CLOSED**. Legacy override-provenance defect **REPAIRED / AWAITING UAT CONTINUATION** (`72949f99da2b56ec06e95e16e29fa194a6730bbd`). V1-02. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Approve All = costing approval only. Additive `a5b6c7d8e9f0` **applied live**. Does **not** accept ADR-008.

## 15. CHAT → REPOSITORY DELTA LEDGER RESULT

**2026-09-08 V1-02 / FG-027 bounded legacy override-provenance repair.** Product SHA **`72949f99da2b56ec06e95e16e29fa194a6730bbd`**. NULL CostItem/Assembly `library_unit_cost_reference` now freezes pre-edit working `unit_cost` on Draft cost edit. Dedicated **20** / bundle **121** / full **652**. No new migration. Live line 7 **not** mutated. UAT **not** resumed. Gate **NOT CLOSED**. V1 readiness remains **39%**.
...
- Phase D reviewed quantity → estimate mapping — [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. V1-02 / [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT CLOSED**. Override-provenance **REPAIRED / AWAITING UAT CONTINUATION**.
...
- **[FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md)** is **LIVE-MIGRATED / OFFICE UAT STOPPED / NOT CLOSED**. Legacy override-provenance defect **REPAIRED / AWAITING UAT CONTINUATION**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. Do **not** close FG-027 from this handoff. Do **not** accept ADR-008.
...
- CalibAi V1 readiness 39%; 1 / 11 COMPLETE (V1-01); BMR DEMO READY NO; BRAYMAN REAL-LIFE UAT READY NO
...
Remaining FG-025 surfaces are NOT AUTHORIZED.
FG-026 is CLOSED / OPERATIONAL FOR UAT.
CalibAi V1 readiness is 39%. 1 / 11 COMPLETE (V1-01). BMR DEMO READY NO. BRAYMAN REAL-LIFE UAT READY NO.
The next governed Cursor prompt is NONE until Joel/ChatGPT authorize V1-02.
STOP. Do NOT begin V1-02. Do NOT start another FG-025 slice. Do NOT start FG-024. Do NOT start LEARN.
Do NOT reopen FG-021.
Do NOT convert SESSION-EXPIRY RECOVERY to PASS / N/A / WAIVED.
Do NOT invent iPhone UAT results.
Do NOT implement Project Closeout.
