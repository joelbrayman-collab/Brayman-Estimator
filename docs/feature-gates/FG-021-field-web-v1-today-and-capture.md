...
**Current remaining real-iPhone UAT (2026-09-06 after landscape CSS correction):** landscape-tolerance **real-iPhone retest** (**FIX IMPLEMENTED / NOT YET PASS**); session-expiry recovery (**OPEN / DEFERRED / NOT YET EXERCISED**); older supported iPhone/Safari smoke where practical. Portrait / one-handed / outdoor readability are **PASS**. Observation Delete remains **QUEUED / NOT AUTHORIZED / NOT IMPLEMENTED**. CSRF recovery is **PASS**. Do **not** close FG-021 from this CSS correction alone.
