...
- Contractor-facing Hub / office / Field copy — [FG-025](../feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1, SLICE 2, AND SLICE 3 IMPLEMENTED / NOT CLOSED** (Project Hub display mapping plus office PRICE specialist copy; remaining surfaces not authorized)
