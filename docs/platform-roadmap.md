...
| Ontario construction contract + warranty | **Future** (Legal Content Gate **empty**; [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / SLICE B PREFLIGHT COMPLETE / OVERALL OPEN / PARTIAL**). [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted**. [ADR-051](adr/ADR-051-legal-content-source-and-update-lifecycle.md) **Accepted** (architecture only). [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) family 05 is an **APPROVED REUSABLE PRESENTATION MASTER** / commercial-draft only and does **not** satisfy this gate. Ontario remains the first expected Canadian package. Do **not** populate jurisdictions. | [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) · [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) · [architecture/fg-024-slice-a-legal-content-library-preflight.md](architecture/fg-024-slice-a-legal-content-library-preflight.md) · [testing/fg024-slice-a-live-migrate-bounded-uat-record.md](testing/fg024-slice-a-live-migrate-bounded-uat-record.md) · [FG-022](feature-gates/FG-022-reusable-approved-document-template-family-v1.md) |
...
| Layer | Position |
|-------|----------|
| **CURRENT** | [v1-completion-register.md](v1-completion-register.md) **GOVERNING** — CalibraytAI V1 readiness **60%**; **4 / 11** packages COMPLETE (V1-01, V1-02, V1-03, V1-05); BMR DEMO READY **NO**; BRAYMAN REAL-LIFE UAT READY **NO**. [FG-029](feature-gates/FG-029-bmr-supplier-workflow-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [ADR-046](adr/ADR-046-supplier-neutral-material-requirement-and-supplier-mapping-boundary.md) **Accepted**. [FG-028](feature-gates/FG-028-calibai-to-calibraytai-product-identity-transition.md) **SLICES 1–3 COMPLETE / CLOSED / OPERATIONAL FOR UAT**. [FG-027](feature-gates/FG-027-automated-costing-and-human-cost-approval-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [ADR-044](adr/ADR-044-costing-approval-snapshot-ownership-and-pricing-consumption-boundary.md) **Accepted**. [FG-026](feature-gates/FG-026-plan-price-phase-d-takeoff-to-estimate-mapping-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) **SLICE 1–5 IMPLEMENTED / NOT CLOSED**. [FG-023](feature-gates/FG-023-monitor-v1-estimated-versus-actual.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL**. [FG-031](feature-gates/FG-031-scope-delivery-make-buy-procurement-routing-v1.md) **CLOSED / OPERATIONAL FOR UAT**. [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **CLOSED / OPERATIONAL FOR UAT**. Live current **`b1c2d3e4f5a6 (head)`**. Repository Alembic head **`b1c2d3e4f5a6`**. |
| **NEXT AUTHORIZED ACTION** | **STOP.** FG-024 Slice B architecture is **PREFLIGHT COMPLETE**; [ADR-051](adr/ADR-051-legal-content-source-and-update-lifecycle.md) **Accepted**. Do **not** begin Slice B product. Do **not** polish the opening. Do **not** website-integrate from this repo. FG-024 Slice A is **CLOSED / OPERATIONAL FOR UAT**. Do **not** implement live QuickBooks API. Do **not** implement supplier login. Do **not** begin V1-04 product work. HostPapa migration **QUEUED POST-BETA**. **ROADMAP SEQUENCE ≠ IMPLEMENTATION AUTHORIZATION.** |
...
| **SEPARATELY GOVERNED FUTURE PROGRAMS** | Subcontract RFQ/package (**maturation during UAT / not implemented**; not a remaining FG-031 close condition). [FG-030](feature-gates/FG-030-supplier-identity-authentication-and-access-isolation.md) supplier login (**RECORDED / NOT IMPLEMENTATION-AUTHORIZED**). [FG-025](feature-gates/FG-025-contractor-facing-ux-language-and-terminology-standardization.md) remaining surfaces **NOT AUTHORIZED**. [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) North American Contract Intelligence (**FUTURE / RECORDED / SLICE A CLOSED / OPERATIONAL FOR UAT / OVERALL OPEN / PARTIAL**). Native Signing production; live BMR API; LEARN; real external AI. |
