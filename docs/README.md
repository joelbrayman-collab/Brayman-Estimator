...
| [architecture/fg-024-slice-a-legal-content-library-preflight.md](architecture/fg-024-slice-a-legal-content-library-preflight.md) | FG-024 Slice A empty-library engine, fail-closed, ownership freeze | **PREFLIGHT COMPLETE / ADR-050 ACCEPTED / NOT IMPLEMENTATION-AUTHORIZED.** [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted** (architecture only). |
...
| [feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) | North American Contract Intelligence & Legal Content Lifecycle | **FUTURE / RECORDED / SLICE A PREFLIGHT COMPLETE / ADR-050 ACCEPTED / NOT IMPLEMENTATION-AUTHORIZED / NOT IMPLEMENTED**. One linked gate; Slices A–D product not authorized. [ADR-050](adr/ADR-050-north-american-legal-content-library-ownership.md) **Accepted** (architecture only). |
...
| [governance/legal-content-and-templates.md](governance/legal-content-and-templates.md) | Construction contract + warranty template governance; Legal Content Gate (Ontario first; North American library future under FG-024) | **Governing** — templates remain separate from the signing-process counsel draft; [FG-024](feature-gates/FG-024-north-american-contract-intelligence-and-legal-content-lifecycle.md) **FUTURE / RECORDED / SLICE A PREFLIGHT COMPLETE / NOT IMPLEMENTATION-AUTHORIZED** |
