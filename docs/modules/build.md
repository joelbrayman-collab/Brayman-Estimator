...
**Not implemented:** Project Closeout / archive-and-purge; Observation Delete; mixed capture; remaining FG-021 durability/UX UAT; transcription; audio conversion; MONITOR; auto-Change Order. Field Web `/field` Today + Capture **is implemented** ([FG-021](../feature-gates/FG-021-field-web-v1-today-and-capture.md) **OPEN**). HEIC real-device Files/Browse UAT is **PASS** (Event **34** / Original **32**).
