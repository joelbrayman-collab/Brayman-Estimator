...
| `field_bp` | `app/routes/field.py` — FG-021 Field Web Today + Capture **CLOSED**; FG-035 SCH-D Field schedule GETs **IMPLEMENTED / TESTED / SERVER-SIDE LIVE UAT PASS / PHYSICAL IPHONE UAT PASS / NOT COMMITTED / NOT PUSHED** |
...
- Scheduling, Job Costing, Invoicing. Visual Dynamic Project / Crew Scheduling SCH-A / SCH-B / SCH-C are **Current**. SCH-D Field presentation is **IMPLEMENTED / TESTED / SERVER-SIDE LIVE UAT PASS / PHYSICAL IPHONE UAT PASS / NOT COMMITTED / NOT PUSHED**. Later Performance / MONITOR labour-hours / LEARN slices remain **NOT AUTHORIZED** under [FG-035](feature-gates/FG-035-project-work-structure-time-schedule-performance-learn.md) **OPEN / PARTIAL**. TAX/WBS, SCOPE, and TIME are **Current**. Product-direction record: [architecture/project-element-authority-future-record.md](architecture/project-element-authority-future-record.md).
