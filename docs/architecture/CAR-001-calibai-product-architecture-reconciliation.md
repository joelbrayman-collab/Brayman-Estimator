...
| Dual first-class BUILD surfaces; original audio/photo/text custody; capture-first; desktop review | [ADR-042](../adr/ADR-042-build-field-evidence-and-iphone-first-capture.md) **Accepted** (implementation **not started**; [FG-020](../feature-gates/FG-020-build-field-capture-v1-project-field-observation-foundation.md) **APPROVED / IMPLEMENTATION NOT STARTED**) |
