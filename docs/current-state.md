...
|-------|--------|
| Branch | `main` |
| HEAD / `origin/main` | `e6462a9ee8688b6599ab1a7b0e91232e8d53db3a` (`feat: implement FG-015 Permit Foundation V1`). Product: FG-015 **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING**. Alembic graph head **`e7f8a9b0c1d2`**. Live current **`d6e7f8a9b0c1`**. |
...
- **Permit Foundation V1 (FG-015)** — **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING.** `ProjectLocation` 1:1; platform Canada / Ontario / City of Ottawa + aliases; deterministic resolver; versioned preliminary `PermitProfile`; Hub PLAN **PERMIT & APPROVALS** foundation panel; `/projects/<id>/location/edit`. Graph head `e7f8a9b0c1d2`. Live current remains `d6e7f8a9b0c1`. Dedicated tests **19 passed**. Full suite **364 passed**. No Permit Rules Library. No Pass 2 analysis. Not CLOSED.
...
- **Permit Intelligence** ([architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)) Pass 2 is **FUTURE / NOT IMPLEMENTED**. Architecture **Accepted** (ADR-037/038/039). [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING** (location / jurisdiction / preliminary profile only; not CLOSED). No rules library. No live lookup / external AI.
...
- **Permit Intelligence architecture** (ADR-037/038/039 **Accepted**; [FG-015](feature-gates/FG-015-permit-foundation-v1-project-location-jurisdiction-preliminary-permit-profile.md) **IMPLEMENTED / VERIFIED / COMMITTED / PUSHED** — **LIVE MIGRATION PENDING**; Mike Pratt Coach House as future Gate 2 UAT reference) — [architecture/permit-and-approvals-report.md](architecture/permit-and-approvals-report.md) · [architecture/jurisdiction-resolution.md](architecture/jurisdiction-resolution.md)
