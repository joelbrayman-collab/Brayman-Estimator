...
- D1 Project Hub contextual Help **IMPLEMENTED** (`app/presentation/help_content.py`; native `<details>` on PLAN / PRICE / CONTRACT / BUILD / MONITOR; LEARN Future-only). Informational GET-only. No schema. Help product overall **PARTIAL**.
