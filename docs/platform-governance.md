...
| QuickBooks pipeline (Option A Slices A+B implemented / not live-migrated; no API) | [architecture/quickbooks-integration.md](architecture/quickbooks-integration.md) · [FG-032](feature-gates/FG-032-quickbooks-ready-output-entry-v1.md) **IMPLEMENTED / NOT LIVE-MIGRATED / NOT CLOSED**; [ADR-049](adr/ADR-049-quickbooks-ready-output-ownership-and-snapshot.md) **Accepted** |
